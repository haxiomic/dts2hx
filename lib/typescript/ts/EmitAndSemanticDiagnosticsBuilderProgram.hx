...
**/
@:native('ts.EmitAndSemanticDiagnosticsBuilderProgram')
extern interface EmitAndSemanticDiagnosticsBuilderProgram extends typescript.ts.SemanticDiagnosticsBuilderProgram {
	/**
