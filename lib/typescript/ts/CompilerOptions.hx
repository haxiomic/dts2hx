...
/**
Generated from: test-definitions/typescript/typescript-extended.d.ts:2589:5
**/
...
typedef CompilerOptions = {
	...
	@:optional
	var module: typescript.ts.ModuleKind;
	@:optional
	var moduleResolution: typescript.ts.ModuleResolutionKind;
	@:optional
	var newLine: typescript.ts.NewLineKind;
	@:optional
	var noEmit: Bool;
	@:optional
	...
	var outFile: String;
	@:optional
	var paths: typescript.ts.MapLike<Array<String>>;
	@:optional
	...
	@:optional
	var target: typescript.ts.ScriptTarget;
	@:optional
