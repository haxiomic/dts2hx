...
typedef IStringifyOptions = {
	...
	var encode : Bool;
	@:optional
	var encoder : (str:Dynamic, defaultEncoder:DefaultEncoder, charset:String, type:String) -> String;
	@:optional
	...
	var indices : Bool;
	@:optional
	var sort : (a:Dynamic, b:Dynamic) -> Float;
	@:optional
	var serializeDate : (d:js.lib.Date) -> String;
	@:optional
	var format : String;
	@:optional
