package three;
@:jsRequire("three", "PointLightHelper") extern class PointLightHelper {
	...
	**/
	function add(object:std.Array<Object3D>):PointLightHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):PointLightHelper;
	/**
