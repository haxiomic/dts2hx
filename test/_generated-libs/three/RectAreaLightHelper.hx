package three;
@:jsRequire("three", "RectAreaLightHelper") extern class RectAreaLightHelper {
	...
	**/
	function add(object:std.Array<Object3D>):RectAreaLightHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):RectAreaLightHelper;
	/**
