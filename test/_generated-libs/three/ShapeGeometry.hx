package three;
@:jsRequire("three", "ShapeGeometry") extern class ShapeGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):ShapeGeometry;
