package three;
@:jsRequire("three", "HemisphereLightHelper") extern class HemisphereLightHelper {
	...
	**/
	function add(object:std.Array<Object3D>):HemisphereLightHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):HemisphereLightHelper;
	/**
