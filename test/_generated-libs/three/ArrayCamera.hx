package three;
@:jsRequire("three", "ArrayCamera") extern class ArrayCamera {
	...
	**/
	function add(object:std.Array<Object3D>):ArrayCamera;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):ArrayCamera;
	/**
