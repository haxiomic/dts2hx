...
**/
@:jsRequire("three", "PointLight") extern class PointLight {
	...
	**/
	function add(object:std.Array<Object3D>):PointLight;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):PointLight;
	/**
