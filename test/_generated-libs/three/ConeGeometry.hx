package three;
@:jsRequire("three", "ConeGeometry") extern class ConeGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):ConeGeometry;
