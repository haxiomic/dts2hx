package three;
@:jsRequire("three", "FaceNormalsHelper") extern class FaceNormalsHelper {
	...
	**/
	function add(object:std.Array<Object3D>):FaceNormalsHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):FaceNormalsHelper;
	/**
