package three;
@:jsRequire("three", "TetrahedronGeometry") extern class TetrahedronGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):TetrahedronGeometry;
