...
@:native("DOMMatrixReadOnly") extern class DOMMatrixReadOnly {
	...
	static function fromFloat32Array(array32:ts.lib.IFloat32Array):IDOMMatrixReadOnly;
	static function fromFloat64Array(array64:ts.lib.IFloat64Array):IDOMMatrixReadOnly;
	static function fromMatrix(?other:DOMMatrixInit):IDOMMatrixReadOnly;
}