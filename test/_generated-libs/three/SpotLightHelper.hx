package three;
@:jsRequire("three", "SpotLightHelper") extern class SpotLightHelper {
	...
	**/
	function add(object:std.Array<Object3D>):SpotLightHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):SpotLightHelper;
	/**
