...
**/
@:native("XMLHttpRequest") @tsInterface extern class XMLHttpRequest {
	function new();
	var onreadystatechange : Null<(ev:Event) -> Any>;
	/**
	...
	**/
	function send(?body:haxe.extern.EitherType<String, haxe.extern.EitherType<Document, haxe.extern.EitherType<js.lib.ArrayBuffer, haxe.extern.EitherType<js.lib.ArrayBufferView, haxe.extern.EitherType<Blob, haxe.extern.EitherType<js.lib.FormData, haxe.extern.EitherType<js.lib.URLSearchParams, ReadableStream<js.lib.Uint8Array>>>>>>>>):Void;
	/**
	...
	**/
	...
	var onabort : Null<(ev:ProgressEvent<EventTarget>) -> Any>;
	var onerror : Null<(ev:ProgressEvent<EventTarget>) -> Any>;
	var onload : Null<(ev:ProgressEvent<EventTarget>) -> Any>;
	var onloadend : Null<(ev:ProgressEvent<EventTarget>) -> Any>;
	var onloadstart : Null<(ev:ProgressEvent<EventTarget>) -> Any>;
	var onprogress : Null<(ev:ProgressEvent<EventTarget>) -> Any>;
	var ontimeout : Null<(ev:ProgressEvent<EventTarget>) -> Any>;
	/**
