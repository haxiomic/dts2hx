...
**/
@:native("MediaElementAudioSourceNode") @tsInterface extern class MediaElementAudioSourceNode {
	function new(context:AudioContext, options:MediaElementAudioSourceOptions);
	...
	**/
	...
	static var prototype : MediaElementAudioSourceNode;
}