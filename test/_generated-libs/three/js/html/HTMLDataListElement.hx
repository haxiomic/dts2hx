...
**/
@:native("HTMLDataListElement") extern class HTMLDataListElement {
	function new();
	final options : js.lib.HTMLCollectionOf<IHTMLOptionElement>;
	/**
	...
	**/
	...
	static var prototype : IHTMLDataListElement;
}