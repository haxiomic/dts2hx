...
**/
@:native("HTMLDataListElement") @tsInterface extern class HTMLDataListElement {
	function new();
	final options : js.lib.HTMLCollectionOf<HTMLOptionElement>;
	/**
	...
	**/
	...
	static var prototype : HTMLDataListElement;
}