...
**/
@:native("HTMLObjectElement") @tsInterface extern class HTMLObjectElement {
	function new();
	var align : String;
	var archive : String;
	var border : String;
	...
	**/
	final contentDocument : Null<Document>;
	final contentWindow : Null<Window>;
	/**
	...
	**/
	...
	static var prototype : HTMLObjectElement;
}