...
**/
@:native("WaveShaperNode") @tsInterface extern class WaveShaperNode {
	function new(context:js.lib.BaseAudioContext, ?options:WaveShaperOptions);
	var curve : Null<js.lib.Float32Array>;
	...
	**/
	...
	static var prototype : WaveShaperNode;
}