...
**/
@:native("SVGFETurbulenceElement") @tsInterface extern class SVGFETurbulenceElement {
	function new();
	final baseFrequencyX : SVGAnimatedNumber;
	final baseFrequencyY : SVGAnimatedNumber;
	final numOctaves : SVGAnimatedInteger;
	final seed : SVGAnimatedNumber;
	final stitchTiles : SVGAnimatedEnumeration;
	...
	**/
	...
	static var prototype : SVGFETurbulenceElement;
	@:native("SVG_STITCHTYPE_NOSTITCH")
	static final SVG_STITCHTYPE_NOSTITCH_ : Float;
	@:native("SVG_STITCHTYPE_STITCH")
	static final SVG_STITCHTYPE_STITCH_ : Float;
	@:native("SVG_STITCHTYPE_UNKNOWN")
	static final SVG_STITCHTYPE_UNKNOWN_ : Float;
	@:native("SVG_TURBULENCE_TYPE_FRACTALNOISE")
	static final SVG_TURBULENCE_TYPE_FRACTALNOISE_ : Float;
	@:native("SVG_TURBULENCE_TYPE_TURBULENCE")
	static final SVG_TURBULENCE_TYPE_TURBULENCE_ : Float;
	@:native("SVG_TURBULENCE_TYPE_UNKNOWN")
	static final SVG_TURBULENCE_TYPE_UNKNOWN_ : Float;
}