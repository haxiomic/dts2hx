...
**/
@:native("MediaStreamAudioSourceNode") @tsInterface extern class MediaStreamAudioSourceNode {
	function new(context:AudioContext, options:MediaStreamAudioSourceOptions);
	...
	**/
	...
	static var prototype : MediaStreamAudioSourceNode;
}