...
**/
@:native("SVGClipPathElement") @tsInterface extern class SVGClipPathElement {
	function new();
	final clipPathUnits : SVGAnimatedEnumeration;
	...
	**/
	...
	static var prototype : SVGClipPathElement;
}