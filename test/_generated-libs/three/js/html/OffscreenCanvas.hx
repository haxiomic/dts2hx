package js.html;
@:native("OffscreenCanvas") @tsInterface extern class OffscreenCanvas {
	...
	**/
	function convertToBlob(?options:ImageEncodeOptions):js.lib.Promise<Blob>;
	/**
	...
	**/
	...
	@:overload(function(contextId:String, ?options:Any):Null<haxe.extern.EitherType<WebGLRenderingContext, haxe.extern.EitherType<ImageBitmapRenderingContext, haxe.extern.EitherType<WebGL2RenderingContext, OffscreenCanvasRenderingContext2D>>>> { })
