...
**/
@:native("HTMLCanvasElement") @tsInterface extern class HTMLCanvasElement {
	function new();
	/**
	...
	**/
	...
	@:overload(function(contextId:String, ?options:Any):Null<haxe.extern.EitherType<WebGLRenderingContext, haxe.extern.EitherType<ImageBitmapRenderingContext, haxe.extern.EitherType<WebGL2RenderingContext, CanvasRenderingContext2D>>>> { })
