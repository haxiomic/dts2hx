package js.html;
@:native("SVGAnimateTransformElement") @tsInterface extern class SVGAnimateTransformElement {
	function new();
	/**
	...
	**/
	...
	final targetElement : SVGElement;
	...
	**/
	...
	static var prototype : SVGAnimateTransformElement;
}