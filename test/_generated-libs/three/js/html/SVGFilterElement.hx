...
**/
@:native("SVGFilterElement") @tsInterface extern class SVGFilterElement {
	function new();
	final filterUnits : SVGAnimatedEnumeration;
	final height : SVGAnimatedLength;
	final primitiveUnits : SVGAnimatedEnumeration;
	...
	**/
	...
	static var prototype : SVGFilterElement;
}