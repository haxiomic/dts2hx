...
**/
@:native("SVGFEDistantLightElement") @tsInterface extern class SVGFEDistantLightElement {
	function new();
	final azimuth : SVGAnimatedNumber;
	final elevation : SVGAnimatedNumber;
	/**
	...
	**/
	...
	static var prototype : SVGFEDistantLightElement;
}