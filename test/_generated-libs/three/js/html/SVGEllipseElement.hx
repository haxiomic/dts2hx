...
**/
@:native("SVGEllipseElement") @tsInterface extern class SVGEllipseElement {
	function new();
	final cx : SVGAnimatedLength;
	final cy : SVGAnimatedLength;
	final rx : SVGAnimatedLength;
	final ry : SVGAnimatedLength;
	/**
	...
	**/
	...
	final pathLength : SVGAnimatedNumber;
	...
	**/
	...
	static var prototype : SVGEllipseElement;
}