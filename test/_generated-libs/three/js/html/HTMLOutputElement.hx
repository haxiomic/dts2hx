...
**/
@:native("HTMLOutputElement") @tsInterface extern class HTMLOutputElement {
	function new();
	var defaultValue : String;
	final form : Null<js.lib.HTMLFormElement>;
	final htmlFor : js.lib.DOMTokenList;
	final labels : js.lib.NodeListOf<HTMLLabelElement>;
	var name : String;
	final type : String;
	...
	**/
	...
	static var prototype : HTMLOutputElement;
}