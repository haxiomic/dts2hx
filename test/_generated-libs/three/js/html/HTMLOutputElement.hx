...
@:native("HTMLOutputElement") extern class HTMLOutputElement {
	...
	final form : Null<js.lib.IHTMLFormElement>;
	final htmlFor : js.lib.IDOMTokenList;
	final labels : js.lib.NodeListOf<IHTMLLabelElement>;
	var name : String;
	final type : String;
	...
	**/
	...
	static var prototype : IHTMLOutputElement;
}