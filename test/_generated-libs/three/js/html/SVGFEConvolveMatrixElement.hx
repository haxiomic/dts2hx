...
**/
@:native("SVGFEConvolveMatrixElement") @tsInterface extern class SVGFEConvolveMatrixElement {
	function new();
	final bias : SVGAnimatedNumber;
	final divisor : SVGAnimatedNumber;
	final edgeMode : SVGAnimatedEnumeration;
	final in1 : SVGAnimatedString;
	final kernelMatrix : SVGAnimatedNumberList;
	final kernelUnitLengthX : SVGAnimatedNumber;
	final kernelUnitLengthY : SVGAnimatedNumber;
	final orderX : SVGAnimatedInteger;
	final orderY : SVGAnimatedInteger;
	final preserveAlpha : SVGAnimatedBoolean;
	final targetX : SVGAnimatedInteger;
	final targetY : SVGAnimatedInteger;
	...
	**/
	...
	static var prototype : SVGFEConvolveMatrixElement;
	@:native("SVG_EDGEMODE_DUPLICATE")
	static final SVG_EDGEMODE_DUPLICATE_ : Float;
	@:native("SVG_EDGEMODE_NONE")
	static final SVG_EDGEMODE_NONE_ : Float;
	@:native("SVG_EDGEMODE_UNKNOWN")
	static final SVG_EDGEMODE_UNKNOWN_ : Float;
	@:native("SVG_EDGEMODE_WRAP")
	static final SVG_EDGEMODE_WRAP_ : Float;
}