package js.html;
@:native("DOMSettableTokenList") @tsInterface extern class DOMSettableTokenList {
	function new();
	/**
	...
	**/
	...
	function forEach(callbackfn:(value:String, key:Float, parent:js.lib.DOMTokenList) -> Void, ?thisArg:Any):Void;
	function entries():js.lib.IterableIterator<js.lib.Tuple2<Float, String>>;
