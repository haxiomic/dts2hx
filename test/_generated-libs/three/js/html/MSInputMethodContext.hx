package js.html;
@:native("MSInputMethodContext") @tsInterface extern class MSInputMethodContext {
	function new();
	final compositionEndOffset : Float;
	final compositionStartOffset : Float;
	var oncandidatewindowhide : Null<(ev:Event) -> Any>;
	var oncandidatewindowshow : Null<(ev:Event) -> Any>;
	var oncandidatewindowupdate : Null<(ev:Event) -> Any>;
