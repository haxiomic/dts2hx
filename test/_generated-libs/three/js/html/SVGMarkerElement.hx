package js.html;
@:native("SVGMarkerElement") @tsInterface extern class SVGMarkerElement {
	function new();
	final markerHeight : SVGAnimatedLength;
	final markerUnits : SVGAnimatedEnumeration;
	final markerWidth : SVGAnimatedLength;
	final orientAngle : SVGAnimatedAngle;
	final orientType : SVGAnimatedEnumeration;
	final refX : SVGAnimatedLength;
	final refY : SVGAnimatedLength;
	...
	**/
	...
	static var prototype : SVGMarkerElement;
	@:native("SVG_MARKERUNITS_STROKEWIDTH")
	static final SVG_MARKERUNITS_STROKEWIDTH_ : Float;
	@:native("SVG_MARKERUNITS_UNKNOWN")
	static final SVG_MARKERUNITS_UNKNOWN_ : Float;
	@:native("SVG_MARKERUNITS_USERSPACEONUSE")
	static final SVG_MARKERUNITS_USERSPACEONUSE_ : Float;
	@:native("SVG_MARKER_ORIENT_ANGLE")
	static final SVG_MARKER_ORIENT_ANGLE_ : Float;
	@:native("SVG_MARKER_ORIENT_AUTO")
	static final SVG_MARKER_ORIENT_AUTO_ : Float;
	@:native("SVG_MARKER_ORIENT_UNKNOWN")
	static final SVG_MARKER_ORIENT_UNKNOWN_ : Float;
}