package js.html;
@:native("MediaStreamAudioDestinationNode") @tsInterface extern class MediaStreamAudioDestinationNode {
	function new(context:AudioContext, ?options:AudioNodeOptions);
	...
	**/
	...
	static var prototype : MediaStreamAudioDestinationNode;
}