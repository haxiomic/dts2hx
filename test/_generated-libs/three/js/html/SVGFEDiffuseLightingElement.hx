...
**/
@:native("SVGFEDiffuseLightingElement") @tsInterface extern class SVGFEDiffuseLightingElement {
	function new();
	final diffuseConstant : SVGAnimatedNumber;
	...
	**/
	...
	static var prototype : SVGFEDiffuseLightingElement;
}