...
**/
@:native("SVGGradientElement") @tsInterface extern class SVGGradientElement {
	function new();
	final gradientTransform : SVGAnimatedTransformList;
	final gradientUnits : SVGAnimatedEnumeration;
	final spreadMethod : SVGAnimatedEnumeration;
	...
	**/
	...
	static var prototype : SVGGradientElement;
	@:native("SVG_SPREADMETHOD_PAD")
	static final SVG_SPREADMETHOD_PAD_ : Float;
	@:native("SVG_SPREADMETHOD_REFLECT")
	static final SVG_SPREADMETHOD_REFLECT_ : Float;
	@:native("SVG_SPREADMETHOD_REPEAT")
	static final SVG_SPREADMETHOD_REPEAT_ : Float;
	@:native("SVG_SPREADMETHOD_UNKNOWN")
	static final SVG_SPREADMETHOD_UNKNOWN_ : Float;
}