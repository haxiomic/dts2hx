...
**/
@:native("TextDecoder") @tsInterface extern class TextDecoder {
	...
	**/
	function decode(?input:haxe.extern.EitherType<js.lib.ArrayBuffer, js.lib.ArrayBufferView>, ?options:TextDecodeOptions):String;
	/**
