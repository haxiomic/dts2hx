...
**/
@:native("SVGPatternElement") @tsInterface extern class SVGPatternElement {
	function new();
	final height : SVGAnimatedLength;
	final patternContentUnits : SVGAnimatedEnumeration;
	final patternTransform : SVGAnimatedTransformList;
	final patternUnits : SVGAnimatedEnumeration;
	...
	**/
	...
	static var prototype : SVGPatternElement;
}