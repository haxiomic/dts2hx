...
**/
@:native("SVGFEBlendElement") @tsInterface extern class SVGFEBlendElement {
	function new();
	final in1 : SVGAnimatedString;
	final in2 : SVGAnimatedString;
	final mode : SVGAnimatedEnumeration;
	...
	**/
	...
	final result : SVGAnimatedString;
	final width : SVGAnimatedLength;
	final x : SVGAnimatedLength;
	final y : SVGAnimatedLength;
	static var prototype : SVGFEBlendElement;
	@:native("SVG_FEBLEND_MODE_COLOR")
	static final SVG_FEBLEND_MODE_COLOR_ : Float;
	@:native("SVG_FEBLEND_MODE_COLOR_BURN")
	static final SVG_FEBLEND_MODE_COLOR_BURN_ : Float;
	@:native("SVG_FEBLEND_MODE_COLOR_DODGE")
	static final SVG_FEBLEND_MODE_COLOR_DODGE_ : Float;
	@:native("SVG_FEBLEND_MODE_DARKEN")
	static final SVG_FEBLEND_MODE_DARKEN_ : Float;
	@:native("SVG_FEBLEND_MODE_DIFFERENCE")
	static final SVG_FEBLEND_MODE_DIFFERENCE_ : Float;
	@:native("SVG_FEBLEND_MODE_EXCLUSION")
	static final SVG_FEBLEND_MODE_EXCLUSION_ : Float;
	@:native("SVG_FEBLEND_MODE_HARD_LIGHT")
	static final SVG_FEBLEND_MODE_HARD_LIGHT_ : Float;
	@:native("SVG_FEBLEND_MODE_HUE")
	static final SVG_FEBLEND_MODE_HUE_ : Float;
	@:native("SVG_FEBLEND_MODE_LIGHTEN")
	static final SVG_FEBLEND_MODE_LIGHTEN_ : Float;
	@:native("SVG_FEBLEND_MODE_LUMINOSITY")
	static final SVG_FEBLEND_MODE_LUMINOSITY_ : Float;
	@:native("SVG_FEBLEND_MODE_MULTIPLY")
	static final SVG_FEBLEND_MODE_MULTIPLY_ : Float;
	@:native("SVG_FEBLEND_MODE_NORMAL")
	static final SVG_FEBLEND_MODE_NORMAL_ : Float;
	@:native("SVG_FEBLEND_MODE_OVERLAY")
	static final SVG_FEBLEND_MODE_OVERLAY_ : Float;
	@:native("SVG_FEBLEND_MODE_SATURATION")
	static final SVG_FEBLEND_MODE_SATURATION_ : Float;
	@:native("SVG_FEBLEND_MODE_SCREEN")
	static final SVG_FEBLEND_MODE_SCREEN_ : Float;
	@:native("SVG_FEBLEND_MODE_SOFT_LIGHT")
	static final SVG_FEBLEND_MODE_SOFT_LIGHT_ : Float;
	@:native("SVG_FEBLEND_MODE_UNKNOWN")
	static final SVG_FEBLEND_MODE_UNKNOWN_ : Float;
}