...
**/
@:native("SVGFEMorphologyElement") @tsInterface extern class SVGFEMorphologyElement {
	function new();
	final in1 : SVGAnimatedString;
	@:native("operator")
	final operator_ : SVGAnimatedEnumeration;
	final radiusX : SVGAnimatedNumber;
	final radiusY : SVGAnimatedNumber;
	...
	**/
	...
	static var prototype : SVGFEMorphologyElement;
	@:native("SVG_MORPHOLOGY_OPERATOR_DILATE")
	static final SVG_MORPHOLOGY_OPERATOR_DILATE_ : Float;
	@:native("SVG_MORPHOLOGY_OPERATOR_ERODE")
	static final SVG_MORPHOLOGY_OPERATOR_ERODE_ : Float;
	@:native("SVG_MORPHOLOGY_OPERATOR_UNKNOWN")
	static final SVG_MORPHOLOGY_OPERATOR_UNKNOWN_ : Float;
}