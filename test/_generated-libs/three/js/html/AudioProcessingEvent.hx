...
**/
@:native("AudioProcessingEvent") @tsInterface extern class AudioProcessingEvent {
	function new(type:String, eventInitDict:AudioProcessingEventInit);
	final inputBuffer : AudioBuffer;
	final outputBuffer : AudioBuffer;
	...
	**/
	...
	final NONE : Float;
	static var prototype : AudioProcessingEvent;
}