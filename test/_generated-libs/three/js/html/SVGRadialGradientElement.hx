...
**/
@:native("SVGRadialGradientElement") @tsInterface extern class SVGRadialGradientElement {
	function new();
	final cx : SVGAnimatedLength;
	final cy : SVGAnimatedLength;
	final fx : SVGAnimatedLength;
	final fy : SVGAnimatedLength;
	final r : SVGAnimatedLength;
	/**
	...
	**/
	...
	static var prototype : SVGRadialGradientElement;
}