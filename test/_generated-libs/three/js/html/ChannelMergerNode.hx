...
**/
@:native("ChannelMergerNode") @tsInterface extern class ChannelMergerNode {
	function new(context:js.lib.BaseAudioContext, ?options:ChannelMergerOptions);
	...
	**/
	...
	static var prototype : ChannelMergerNode;
}