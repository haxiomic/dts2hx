...
**/
@:native("FileReader") @tsInterface extern class FileReader {
	function new();
	final error : Null<DOMException>;
	var onabort : Null<(ev:ProgressEvent<FileReader>) -> Any>;
	var onerror : Null<(ev:ProgressEvent<FileReader>) -> Any>;
	var onload : Null<(ev:ProgressEvent<FileReader>) -> Any>;
	var onloadend : Null<(ev:ProgressEvent<FileReader>) -> Any>;
	var onloadstart : Null<(ev:ProgressEvent<FileReader>) -> Any>;
	var onprogress : Null<(ev:ProgressEvent<FileReader>) -> Any>;
	final readyState : Float;
	final result : Null<haxe.extern.EitherType<String, js.lib.ArrayBuffer>>;
	function abort():Void;
