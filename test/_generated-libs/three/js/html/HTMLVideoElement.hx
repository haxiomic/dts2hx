...
**/
@:native("HTMLVideoElement") @tsInterface extern class HTMLVideoElement {
	function new();
	/**
	...
	**/
	...
	var msZoom : Bool;
	var onMSVideoFormatChanged : Null<(ev:Event) -> Any>;
	var onMSVideoFrameStepCompleted : Null<(ev:Event) -> Any>;
	var onMSVideoOptimalLayoutChanged : Null<(ev:Event) -> Any>;
	/**
	...
	**/
	...
	function msInsertVideoEffect(activatableClassId:String, effectRequired:Bool, ?config:Any):Void;
	...
	**/
	final audioTracks : js.lib.AudioTrackList;
	/**
	...
	**/
	...
	var onencrypted : Null<(ev:MediaEncryptedEvent) -> Any>;
	var onmsneedkey : Null<(ev:Event) -> Any>;
	var onwaitingforkey : Null<(ev:Event) -> Any>;
	/**
	...
	**/
	var src : String;
	var srcObject : Null<haxe.extern.EitherType<MediaStream, haxe.extern.EitherType<MediaSource, Blob>>>;
	final textTracks : js.lib.TextTrackList;
	final videoTracks : js.lib.VideoTrackList;
	/**
	...
	**/
	...
	function setMediaKeys(mediaKeys:Null<MediaKeys>):js.lib.Promise<Void>;
