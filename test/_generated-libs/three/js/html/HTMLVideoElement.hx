...
@:native("HTMLVideoElement") extern class HTMLVideoElement {
	...
	**/
	...
	var msZoom : Bool;
	var onMSVideoFormatChanged : Null<(ev:IEvent) -> Any>;
	var onMSVideoFrameStepCompleted : Null<(ev:IEvent) -> Any>;
	var onMSVideoOptimalLayoutChanged : Null<(ev:IEvent) -> Any>;
	/**
	...
	**/
	var width : Float;
	function getVideoPlaybackQuality():IVideoPlaybackQuality;
	...
	**/
	final audioTracks : js.lib.IAudioTrackList;
	/**
	...
	**/
	...
	final textTracks : js.lib.ITextTrackList;
	final videoTracks : js.lib.IVideoTrackList;
	/**
	...
	**/
	function play():js.lib.IPromise<Void>;
	function setMediaKeys(mediaKeys:Null<IMediaKeys>):js.lib.IPromise<Void>;
	...
	**/
	...
	static var prototype : IHTMLVideoElement;
}