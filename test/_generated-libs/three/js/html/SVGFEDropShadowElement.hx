package js.html;
@:native("SVGFEDropShadowElement") @tsInterface extern class SVGFEDropShadowElement {
	function new();
	final dx : SVGAnimatedNumber;
	final dy : SVGAnimatedNumber;
	final in1 : SVGAnimatedString;
	final stdDeviationX : SVGAnimatedNumber;
	final stdDeviationY : SVGAnimatedNumber;
	...
	**/
	...
	static var prototype : SVGFEDropShadowElement;
}