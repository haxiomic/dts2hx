package js.html;
@:native("HTMLSlotElement") @tsInterface extern class HTMLSlotElement {
	function new();
	var name : String;
	function assignedElements(?options:AssignedNodesOptions):std.Array<Element>;
	function assignedNodes(?options:AssignedNodesOptions):std.Array<Node>;
	/**
	...
	**/
	...
	static var prototype : HTMLSlotElement;
}