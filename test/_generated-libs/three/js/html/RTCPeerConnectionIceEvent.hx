...
**/
@:native("RTCPeerConnectionIceEvent") @tsInterface extern class RTCPeerConnectionIceEvent {
	function new(type:String, ?eventInitDict:RTCPeerConnectionIceEventInit);
	final candidate : Null<RTCIceCandidate>;
	...
	**/
	...
	final NONE : Float;
	static var prototype : RTCPeerConnectionIceEvent;
}