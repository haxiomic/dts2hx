...
**/
@:native("DelayNode") @tsInterface extern class DelayNode {
	function new(context:js.lib.BaseAudioContext, ?options:DelayOptions);
	final delayTime : js.lib.AudioParam;
	...
	**/
	...
	static var prototype : DelayNode;
}