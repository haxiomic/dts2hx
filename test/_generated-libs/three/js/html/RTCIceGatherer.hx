package js.html;
@:native("RTCIceGatherer") @tsInterface extern class RTCIceGatherer {
	function new(options:RTCIceGatherOptions);
	final component : String;
	var onerror : Null<(ev:Event) -> Any>;
	var onlocalcandidate : Null<(ev:RTCIceGathererEvent) -> Any>;
	...
	**/
	...
	function msGetStats():js.lib.Promise<js.lib.RTCStatsReport>;
	/**
