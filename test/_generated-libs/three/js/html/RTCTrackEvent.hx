package js.html;
@:native("RTCTrackEvent") @tsInterface extern class RTCTrackEvent {
	function new(type:String, eventInitDict:RTCTrackEventInit);
	final receiver : RTCRtpReceiver;
	final streams : js.lib.ReadonlyArray<MediaStream>;
	final track : MediaStreamTrack;
	final transceiver : js.lib.RTCRtpTransceiver;
	/**
	...
	**/
	...
	final NONE : Float;
	static var prototype : RTCTrackEvent;
}