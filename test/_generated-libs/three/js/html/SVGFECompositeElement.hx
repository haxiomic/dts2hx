...
**/
@:native("SVGFECompositeElement") @tsInterface extern class SVGFECompositeElement {
	function new();
	final in1 : SVGAnimatedString;
	final in2 : SVGAnimatedString;
	final k1 : SVGAnimatedNumber;
	final k2 : SVGAnimatedNumber;
	final k3 : SVGAnimatedNumber;
	final k4 : SVGAnimatedNumber;
	@:native("operator")
	final operator_ : SVGAnimatedEnumeration;
	...
	**/
	...
	static var prototype : SVGFECompositeElement;
	@:native("SVG_FECOMPOSITE_OPERATOR_ARITHMETIC")
	static final SVG_FECOMPOSITE_OPERATOR_ARITHMETIC_ : Float;
	@:native("SVG_FECOMPOSITE_OPERATOR_ATOP")
	static final SVG_FECOMPOSITE_OPERATOR_ATOP_ : Float;
	@:native("SVG_FECOMPOSITE_OPERATOR_IN")
	static final SVG_FECOMPOSITE_OPERATOR_IN_ : Float;
	@:native("SVG_FECOMPOSITE_OPERATOR_OUT")
	static final SVG_FECOMPOSITE_OPERATOR_OUT_ : Float;
	@:native("SVG_FECOMPOSITE_OPERATOR_OVER")
	static final SVG_FECOMPOSITE_OPERATOR_OVER_ : Float;
	@:native("SVG_FECOMPOSITE_OPERATOR_UNKNOWN")
	static final SVG_FECOMPOSITE_OPERATOR_UNKNOWN_ : Float;
	@:native("SVG_FECOMPOSITE_OPERATOR_XOR")
	static final SVG_FECOMPOSITE_OPERATOR_XOR_ : Float;
}