...
**/
@:native("HTMLLinkElement") extern class HTMLLinkElement {
	function new();
	var as : String;
	var charset : String;
	...
	**/
	var rel : String;
	final relList : js.lib.IDOMTokenList;
	var rev : String;
	final sizes : js.lib.IDOMTokenList;
	var target : String;
	/**
	...
	**/
	...
	final sheet : Null<IStyleSheet>;
	static var prototype : IHTMLLinkElement;
}