...
**/
@:native("HTMLLinkElement") @tsInterface extern class HTMLLinkElement {
	function new();
	var as : String;
	var charset : String;
	...
	**/
	var rel : String;
	final relList : js.lib.DOMTokenList;
	var rev : String;
	final sizes : js.lib.DOMTokenList;
	var target : String;
	/**
	...
	**/
	...
	final sheet : Null<StyleSheet>;
	static var prototype : HTMLLinkElement;
}