...
**/
@:native("HTMLTableRowElement") @tsInterface extern class HTMLTableRowElement {
	function new();
	var align : String;
	var bgColor : String;
	/**
	...
	**/
	final cells : js.lib.HTMLCollectionOf<haxe.extern.EitherType<HTMLTableDataCellElement, HTMLTableHeaderCellElement>>;
	var ch : String;
	var chOff : String;
	/**
		Retrieves the position of the object in the rows collection for the table.
	**/
	final rowIndex : Float;
	/**
		Retrieves the position of the object in the collection.
	**/
	final sectionRowIndex : Float;
	var vAlign : String;
	/**
		Removes the specified cell from the table row, as well as from the cells collection.
	**/
	function deleteCell(index:Float):Void;
	/**
		Creates a new cell in the table row, and adds the cell to the cells collection.
	**/
	function insertCell(?index:Float):HTMLTableDataCellElement;
	/**
	...
	**/
	...
	static var prototype : HTMLTableRowElement;
}