...
**/
@:native("HTMLTableRowElement") extern class HTMLTableRowElement {
	function new();
	var align : String;
	var bgColor : String;
	/**
	...
	**/
	final cells : js.lib.HTMLCollectionOf<haxe.extern.EitherType<IHTMLTableDataCellElement, IHTMLTableHeaderCellElement>>;
	var ch : String;
	var chOff : String;
	/**
	...
	**/
	function insertCell(?index:Float):IHTMLTableDataCellElement;
	/**
	...
	**/
	...
	static var prototype : IHTMLTableRowElement;
}