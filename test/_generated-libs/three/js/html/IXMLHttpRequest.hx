...
extern typedef IXMLHttpRequest = {
	...
	**/
	function send(?body:haxe.extern.EitherType<String, haxe.extern.EitherType<IDocument, haxe.extern.EitherType<js.lib.IArrayBuffer, haxe.extern.EitherType<js.lib.ArrayBufferView, haxe.extern.EitherType<IBlob, haxe.extern.EitherType<js.lib.IFormData, haxe.extern.EitherType<js.lib.IURLSearchParams, IReadableStream<js.lib.IUint8Array>>>>>>>>):Void;
	/**
