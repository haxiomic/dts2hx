package js.html;
@:native("AudioWorkletNode") @tsInterface extern class AudioWorkletNode {
	function new(context:js.lib.BaseAudioContext, name:String, ?options:AudioWorkletNodeOptions);
	var onprocessorerror : Null<(ev:Event) -> Any>;
	final parameters : js.lib.AudioParamMap;
