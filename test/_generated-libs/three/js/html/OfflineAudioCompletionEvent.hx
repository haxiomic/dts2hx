...
**/
@:native("OfflineAudioCompletionEvent") @tsInterface extern class OfflineAudioCompletionEvent {
	function new(type:String, eventInitDict:OfflineAudioCompletionEventInit);
	final renderedBuffer : AudioBuffer;
	/**
	...
	**/
	...
	final NONE : Float;
	static var prototype : OfflineAudioCompletionEvent;
}