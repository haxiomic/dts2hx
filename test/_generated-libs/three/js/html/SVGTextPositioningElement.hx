...
**/
@:native("SVGTextPositioningElement") @tsInterface extern class SVGTextPositioningElement {
	function new();
	final dx : SVGAnimatedLengthList;
	final dy : SVGAnimatedLengthList;
	final rotate : SVGAnimatedNumberList;
	final x : SVGAnimatedLengthList;
	final y : SVGAnimatedLengthList;
	/**
	...
	**/
	...
	static var prototype : SVGTextPositioningElement;
}