package js.html;
@:native("SpeechRecognitionEvent") @tsInterface extern class SpeechRecognitionEvent {
	function new();
	final emma : Null<Document>;
	final interpretation : Any;
	final resultIndex : Float;
	final results : js.lib.SpeechRecognitionResultList;
	/**
	...
	**/
	...
	final NONE : Float;
	static var prototype : SpeechRecognitionEvent;
}