...
**/
@:native("SVGComponentTransferFunctionElement") @tsInterface extern class SVGComponentTransferFunctionElement {
	function new();
	final amplitude : SVGAnimatedNumber;
	final exponent : SVGAnimatedNumber;
	final intercept : SVGAnimatedNumber;
	final offset : SVGAnimatedNumber;
	final slope : SVGAnimatedNumber;
	final tableValues : SVGAnimatedNumberList;
	final type : SVGAnimatedEnumeration;
	...
	**/
	...
	static var prototype : SVGComponentTransferFunctionElement;
	@:native("SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE")
	static final SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE_ : Float;
	@:native("SVG_FECOMPONENTTRANSFER_TYPE_GAMMA")
	static final SVG_FECOMPONENTTRANSFER_TYPE_GAMMA_ : Float;
	@:native("SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY")
	static final SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY_ : Float;
	@:native("SVG_FECOMPONENTTRANSFER_TYPE_LINEAR")
	static final SVG_FECOMPONENTTRANSFER_TYPE_LINEAR_ : Float;
	@:native("SVG_FECOMPONENTTRANSFER_TYPE_TABLE")
	static final SVG_FECOMPONENTTRANSFER_TYPE_TABLE_ : Float;
	@:native("SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN")
	static final SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN_ : Float;
}