...
**/
@:native("SVGUseElement") @tsInterface extern class SVGUseElement {
	function new();
	final animatedInstanceRoot : Null<SVGElementInstance>;
	final height : SVGAnimatedLength;
	final instanceRoot : Null<SVGElementInstance>;
	...
	**/
	...
	static var prototype : SVGUseElement;
}