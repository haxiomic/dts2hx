...
**/
@:native("HTMLInputElement") @tsInterface extern class HTMLInputElement {
	function new();
	/**
	...
	**/
	var files : Null<js.lib.FileList>;
	/**
		Retrieves a reference to the form that the object is embedded in.
	**/
	final form : Null<js.lib.HTMLFormElement>;
	/**
	...
	**/
	...
	final labels : Null<js.lib.NodeListOf<HTMLLabelElement>>;
	/**
		Specifies the ID of a pre-defined datalist of options for an input element.
	**/
	final list : Null<HTMLElement>;
	/**
	...
	**/
	var valueAsDate : Null<js.lib.Date>;
	/**
	...
	**/
	...
	static var prototype : HTMLInputElement;
}