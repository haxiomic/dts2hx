...
**/
@:native("SVGFESpecularLightingElement") @tsInterface extern class SVGFESpecularLightingElement {
	function new();
	final in1 : SVGAnimatedString;
	final kernelUnitLengthX : SVGAnimatedNumber;
	final kernelUnitLengthY : SVGAnimatedNumber;
	final specularConstant : SVGAnimatedNumber;
	final specularExponent : SVGAnimatedNumber;
	final surfaceScale : SVGAnimatedNumber;
	/**
	...
	**/
	...
	static var prototype : SVGFESpecularLightingElement;
}