...
**/
@:native("SVGFEDisplacementMapElement") @tsInterface extern class SVGFEDisplacementMapElement {
	function new();
	final in1 : SVGAnimatedString;
	final in2 : SVGAnimatedString;
	final scale : SVGAnimatedNumber;
	final xChannelSelector : SVGAnimatedEnumeration;
	final yChannelSelector : SVGAnimatedEnumeration;
	...
	**/
	...
	static var prototype : SVGFEDisplacementMapElement;
	@:native("SVG_CHANNEL_A")
	static final SVG_CHANNEL_A_ : Float;
	@:native("SVG_CHANNEL_B")
	static final SVG_CHANNEL_B_ : Float;
	@:native("SVG_CHANNEL_G")
	static final SVG_CHANNEL_G_ : Float;
	@:native("SVG_CHANNEL_R")
	static final SVG_CHANNEL_R_ : Float;
	@:native("SVG_CHANNEL_UNKNOWN")
	static final SVG_CHANNEL_UNKNOWN_ : Float;
}