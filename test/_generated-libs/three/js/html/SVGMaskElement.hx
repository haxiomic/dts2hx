...
**/
@:native("SVGMaskElement") @tsInterface extern class SVGMaskElement {
	function new();
	final height : SVGAnimatedLength;
	final maskContentUnits : SVGAnimatedEnumeration;
	final maskUnits : SVGAnimatedEnumeration;
	...
	**/
	...
	static var prototype : SVGMaskElement;
}