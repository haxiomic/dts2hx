...
**/
@:native("HTMLTableElement") @tsInterface extern class HTMLTableElement {
	function new();
	var align : String;
	var bgColor : String;
	var border : String;
	...
	**/
	final rows : js.lib.HTMLCollectionOf<HTMLTableRowElement>;
	var rules : String;
	var summary : String;
	/**
		Retrieves a collection of all tBody objects in the table. Objects in this collection are in source order.
	**/
	final tBodies : js.lib.HTMLCollectionOf<HTMLTableSectionElement>;
	/**
	...
	**/
	function insertRow(?index:Float):HTMLTableRowElement;
	/**
	...
	**/
	...
	static var prototype : HTMLTableElement;
}