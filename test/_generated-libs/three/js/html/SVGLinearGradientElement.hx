...
**/
@:native("SVGLinearGradientElement") @tsInterface extern class SVGLinearGradientElement {
	function new();
	final x1 : SVGAnimatedLength;
	final x2 : SVGAnimatedLength;
	final y1 : SVGAnimatedLength;
	final y2 : SVGAnimatedLength;
	/**
	...
	**/
	...
	static var prototype : SVGLinearGradientElement;
}