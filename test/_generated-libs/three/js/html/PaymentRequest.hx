...
**/
@:native("PaymentRequest") @tsInterface extern class PaymentRequest {
	function new(methodData:std.Array<PaymentMethodData>, details:PaymentDetailsInit, ?options:PaymentOptions);
	final id : String;
	var onshippingaddresschange : Null<(ev:Event) -> Any>;
	var onshippingoptionchange : Null<(ev:Event) -> Any>;
