...
@:native("PaymentRequest") extern class PaymentRequest {
	...
	final id : String;
	var onshippingaddresschange : Null<(ev:IEvent) -> Any>;
	var onshippingoptionchange : Null<(ev:IEvent) -> Any>;
	final shippingAddress : Null<IPaymentAddress>;
	final shippingOption : Null<String>;
	final shippingType : Null<String>;
	function abort():js.lib.IPromise<Void>;
	function canMakePayment():js.lib.IPromise<Bool>;
	function show():js.lib.IPromise<IPaymentResponse>;
	/**
	...
	**/
	...
	static var prototype : IPaymentRequest;
}