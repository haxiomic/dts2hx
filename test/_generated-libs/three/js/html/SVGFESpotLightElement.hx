...
**/
@:native("SVGFESpotLightElement") @tsInterface extern class SVGFESpotLightElement {
	function new();
	final limitingConeAngle : SVGAnimatedNumber;
	final pointsAtX : SVGAnimatedNumber;
	final pointsAtY : SVGAnimatedNumber;
	final pointsAtZ : SVGAnimatedNumber;
	final specularExponent : SVGAnimatedNumber;
	final x : SVGAnimatedNumber;
	final y : SVGAnimatedNumber;
	final z : SVGAnimatedNumber;
	/**
	...
	**/
	...
	static var prototype : SVGFESpotLightElement;
}