...
**/
@:native("PaymentRequestUpdateEvent") @tsInterface extern class PaymentRequestUpdateEvent {
	function new(type:String, ?eventInitDict:PaymentRequestUpdateEventInit);
	function updateWith(detailsPromise:haxe.extern.EitherType<PaymentDetailsUpdate, js.lib.Promise<PaymentDetailsUpdate>>):Void;
	/**
