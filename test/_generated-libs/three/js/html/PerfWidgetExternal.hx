...
@:native("PerfWidgetExternal") extern class PerfWidgetExternal {
	...
	function addEventListener(eventType:String, callback:js.lib.IFunction):Void;
	...
	function removeEventListener(eventType:String, callback:js.lib.IFunction):Void;
	function repositionWindow(x:Float, y:Float):Void;
	function resizeWindow(width:Float, height:Float):Void;
	static var prototype : IPerfWidgetExternal;
}