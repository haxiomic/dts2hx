package js.html;
@:native("MediaStreamTrackAudioSourceNode") @tsInterface extern class MediaStreamTrackAudioSourceNode {
	function new(context:AudioContext, options:MediaStreamTrackAudioSourceOptions);
