...
**/
@:native("SVGFEColorMatrixElement") @tsInterface extern class SVGFEColorMatrixElement {
	function new();
	final in1 : SVGAnimatedString;
	final type : SVGAnimatedEnumeration;
	final values : SVGAnimatedNumberList;
	...
	**/
	...
	static var prototype : SVGFEColorMatrixElement;
	@:native("SVG_FECOLORMATRIX_TYPE_HUEROTATE")
	static final SVG_FECOLORMATRIX_TYPE_HUEROTATE_ : Float;
	@:native("SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA")
	static final SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA_ : Float;
	@:native("SVG_FECOLORMATRIX_TYPE_MATRIX")
	static final SVG_FECOLORMATRIX_TYPE_MATRIX_ : Float;
	@:native("SVG_FECOLORMATRIX_TYPE_SATURATE")
	static final SVG_FECOLORMATRIX_TYPE_SATURATE_ : Float;
	@:native("SVG_FECOLORMATRIX_TYPE_UNKNOWN")
	static final SVG_FECOLORMATRIX_TYPE_UNKNOWN_ : Float;
}