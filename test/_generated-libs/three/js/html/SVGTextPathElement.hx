...
**/
@:native("SVGTextPathElement") @tsInterface extern class SVGTextPathElement {
	function new();
	final method : SVGAnimatedEnumeration;
	final spacing : SVGAnimatedEnumeration;
	final startOffset : SVGAnimatedLength;
	...
	**/
	...
	final lengthAdjust : SVGAnimatedEnumeration;
	final textLength : SVGAnimatedLength;
	function getCharNumAtPosition(point:DOMPoint):Float;
	function getComputedTextLength():Float;
	function getEndPositionOfChar(charnum:Float):DOMPoint;
	function getExtentOfChar(charnum:Float):DOMRect;
	function getNumberOfChars():Float;
	function getRotationOfChar(charnum:Float):Float;
	function getStartPositionOfChar(charnum:Float):DOMPoint;
	...
	**/
	...
	static var prototype : SVGTextPathElement;
	@:native("TEXTPATH_METHODTYPE_ALIGN")
	static final TEXTPATH_METHODTYPE_ALIGN_ : Float;
	@:native("TEXTPATH_METHODTYPE_STRETCH")
	static final TEXTPATH_METHODTYPE_STRETCH_ : Float;
	@:native("TEXTPATH_METHODTYPE_UNKNOWN")
	static final TEXTPATH_METHODTYPE_UNKNOWN_ : Float;
	@:native("TEXTPATH_SPACINGTYPE_AUTO")
	static final TEXTPATH_SPACINGTYPE_AUTO_ : Float;
	@:native("TEXTPATH_SPACINGTYPE_EXACT")
	static final TEXTPATH_SPACINGTYPE_EXACT_ : Float;
	@:native("TEXTPATH_SPACINGTYPE_UNKNOWN")
	static final TEXTPATH_SPACINGTYPE_UNKNOWN_ : Float;
}