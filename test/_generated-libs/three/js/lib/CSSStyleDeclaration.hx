...
@:native("CSSStyleDeclaration") @tsInterface extern class CSSStyleDeclaration {
	...
	var msContentZoomLimitMax : Any;
	var msContentZoomLimitMin : Any;
	...
	var msScrollLimitXMax : Any;
	var msScrollLimitXMin : Any;
	var msScrollLimitYMax : Any;
	var msScrollLimitYMin : Any;
	...
	var webkitColumnCount : Any;
	var webkitColumnGap : Any;
	var webkitColumnRule : Null<String>;
	var webkitColumnRuleColor : Any;
	var webkitColumnRuleStyle : Null<String>;
	var webkitColumnRuleWidth : Any;
	var webkitColumnSpan : Null<String>;
	var webkitColumnWidth : Any;
