package js.lib;
extern interface WebGLRenderingContextBase {
	final canvas : haxe.extern.EitherType<js.html.HTMLCanvasElement, js.html.OffscreenCanvas>;
	final drawingBufferHeight : Float;
	final drawingBufferWidth : Float;
	function activeTexture(texture:Float):Void;
	function attachShader(program:js.html.WebGLProgram, shader:js.html.WebGLShader):Void;
	function bindAttribLocation(program:js.html.WebGLProgram, index:Float, name:String):Void;
	function bindBuffer(target:Float, buffer:Null<js.html.WebGLBuffer>):Void;
	function bindFramebuffer(target:Float, framebuffer:Null<js.html.WebGLFramebuffer>):Void;
	function bindRenderbuffer(target:Float, renderbuffer:Null<js.html.WebGLRenderbuffer>):Void;
	function bindTexture(target:Float, texture:Null<js.html.WebGLTexture>):Void;
	...
	function compileShader(shader:js.html.WebGLShader):Void;
	...
	function createBuffer():Null<js.html.WebGLBuffer>;
	function createFramebuffer():Null<js.html.WebGLFramebuffer>;
	function createProgram():Null<js.html.WebGLProgram>;
	function createRenderbuffer():Null<js.html.WebGLRenderbuffer>;
	function createShader(type:Float):Null<js.html.WebGLShader>;
	function createTexture():Null<js.html.WebGLTexture>;
	function cullFace(mode:Float):Void;
	function deleteBuffer(buffer:Null<js.html.WebGLBuffer>):Void;
	function deleteFramebuffer(framebuffer:Null<js.html.WebGLFramebuffer>):Void;
	function deleteProgram(program:Null<js.html.WebGLProgram>):Void;
	function deleteRenderbuffer(renderbuffer:Null<js.html.WebGLRenderbuffer>):Void;
	function deleteShader(shader:Null<js.html.WebGLShader>):Void;
	function deleteTexture(texture:Null<js.html.WebGLTexture>):Void;
	function depthFunc(func:Float):Void;
	function depthMask(flag:Bool):Void;
	function depthRange(zNear:Float, zFar:Float):Void;
	function detachShader(program:js.html.WebGLProgram, shader:js.html.WebGLShader):Void;
	...
	function flush():Void;
	function framebufferRenderbuffer(target:Float, attachment:Float, renderbuffertarget:Float, renderbuffer:Null<js.html.WebGLRenderbuffer>):Void;
	function framebufferTexture2D(target:Float, attachment:Float, textarget:Float, texture:Null<js.html.WebGLTexture>, level:Float):Void;
	function frontFace(mode:Float):Void;
	function generateMipmap(target:Float):Void;
	function getActiveAttrib(program:js.html.WebGLProgram, index:Float):Null<js.html.WebGLActiveInfo>;
	function getActiveUniform(program:js.html.WebGLProgram, index:Float):Null<js.html.WebGLActiveInfo>;
	function getAttachedShaders(program:js.html.WebGLProgram):Null<std.Array<js.html.WebGLShader>>;
	function getAttribLocation(program:js.html.WebGLProgram, name:String):Float;
	function getBufferParameter(target:Float, pname:Float):Any;
	function getContextAttributes():Null<js.html.WebGLContextAttributes>;
	function getError():Float;
	@:overload(function(extensionName:String):Null<js.html.EXT_texture_filter_anisotropic> { })
	@:overload(function(extensionName:String):Null<js.html.EXT_frag_depth> { })
	@:overload(function(extensionName:String):Null<js.html.EXT_shader_texture_lod> { })
	@:overload(function(extensionName:String):Null<js.html.EXT_sRGB> { })
	@:overload(function(extensionName:String):Null<js.html.OES_vertex_array_object> { })
	@:overload(function(extensionName:String):Null<js.html.WEBGL_color_buffer_float> { })
	@:overload(function(extensionName:String):Null<js.html.WEBGL_compressed_texture_astc> { })
	@:overload(function(extensionName:String):Null<js.html.WEBGL_compressed_texture_s3tc_srgb> { })
	@:overload(function(extensionName:String):Null<js.html.WEBGL_debug_shaders> { })
	@:overload(function(extensionName:String):Null<WEBGL_draw_buffers> { })
	@:overload(function(extensionName:String):Null<js.html.WEBGL_lose_context> { })
	@:overload(function(extensionName:String):Null<js.html.WEBGL_depth_texture> { })
	@:overload(function(extensionName:String):Null<js.html.WEBGL_debug_renderer_info> { })
	@:overload(function(extensionName:String):Null<js.html.WEBGL_compressed_texture_s3tc> { })
	@:overload(function(extensionName:String):Null<js.html.OES_texture_half_float_linear> { })
	@:overload(function(extensionName:String):Null<js.html.OES_texture_half_float> { })
	@:overload(function(extensionName:String):Null<js.html.OES_texture_float_linear> { })
	@:overload(function(extensionName:String):Null<js.html.OES_texture_float> { })
	@:overload(function(extensionName:String):Null<js.html.OES_standard_derivatives> { })
	@:overload(function(extensionName:String):Null<js.html.OES_element_index_uint> { })
	@:overload(function(extensionName:String):Null<js.html.ANGLE_instanced_arrays> { })
	@:overload(function(extensionName:String):Any { })
	function getExtension(extensionName:String):Null<js.html.EXT_blend_minmax>;
	...
	function getProgramInfoLog(program:js.html.WebGLProgram):Null<String>;
	function getProgramParameter(program:js.html.WebGLProgram, pname:Float):Any;
	function getRenderbufferParameter(target:Float, pname:Float):Any;
	function getShaderInfoLog(shader:js.html.WebGLShader):Null<String>;
	function getShaderParameter(shader:js.html.WebGLShader, pname:Float):Any;
	function getShaderPrecisionFormat(shadertype:Float, precisiontype:Float):Null<js.html.WebGLShaderPrecisionFormat>;
	function getShaderSource(shader:js.html.WebGLShader):Null<String>;
	function getSupportedExtensions():Null<std.Array<String>>;
	function getTexParameter(target:Float, pname:Float):Any;
	function getUniform(program:js.html.WebGLProgram, location:js.html.WebGLUniformLocation):Any;
	function getUniformLocation(program:js.html.WebGLProgram, name:String):Null<js.html.WebGLUniformLocation>;
	...
	function isBuffer(buffer:Null<js.html.WebGLBuffer>):Bool;
	function isContextLost():Bool;
	function isEnabled(cap:Float):Bool;
	function isFramebuffer(framebuffer:Null<js.html.WebGLFramebuffer>):Bool;
	function isProgram(program:Null<js.html.WebGLProgram>):Bool;
	function isRenderbuffer(renderbuffer:Null<js.html.WebGLRenderbuffer>):Bool;
	function isShader(shader:Null<js.html.WebGLShader>):Bool;
	function isTexture(texture:Null<js.html.WebGLTexture>):Bool;
	function lineWidth(width:Float):Void;
	function linkProgram(program:js.html.WebGLProgram):Void;
	...
	function shaderSource(shader:js.html.WebGLShader, source:String):Void;
	...
	function uniform1f(location:Null<js.html.WebGLUniformLocation>, x:Float):Void;
	function uniform1i(location:Null<js.html.WebGLUniformLocation>, x:Float):Void;
	function uniform2f(location:Null<js.html.WebGLUniformLocation>, x:Float, y:Float):Void;
	function uniform2i(location:Null<js.html.WebGLUniformLocation>, x:Float, y:Float):Void;
	function uniform3f(location:Null<js.html.WebGLUniformLocation>, x:Float, y:Float, z:Float):Void;
	function uniform3i(location:Null<js.html.WebGLUniformLocation>, x:Float, y:Float, z:Float):Void;
	function uniform4f(location:Null<js.html.WebGLUniformLocation>, x:Float, y:Float, z:Float, w:Float):Void;
	function uniform4i(location:Null<js.html.WebGLUniformLocation>, x:Float, y:Float, z:Float, w:Float):Void;
	function useProgram(program:Null<js.html.WebGLProgram>):Void;
	function validateProgram(program:js.html.WebGLProgram):Void;
	function vertexAttrib1f(index:Float, x:Float):Void;
	@:overload(function(index:Float, values:Iterable<Float>):Void { })
	function vertexAttrib1fv(index:Float, values:haxe.extern.EitherType<Float32Array, std.Array<Float>>):Void;
	function vertexAttrib2f(index:Float, x:Float, y:Float):Void;
	@:overload(function(index:Float, values:Iterable<Float>):Void { })
	function vertexAttrib2fv(index:Float, values:haxe.extern.EitherType<Float32Array, std.Array<Float>>):Void;
	function vertexAttrib3f(index:Float, x:Float, y:Float, z:Float):Void;
	@:overload(function(index:Float, values:Iterable<Float>):Void { })
	function vertexAttrib3fv(index:Float, values:haxe.extern.EitherType<Float32Array, std.Array<Float>>):Void;
	function vertexAttrib4f(index:Float, x:Float, y:Float, z:Float, w:Float):Void;
	@:overload(function(index:Float, values:Iterable<Float>):Void { })
	function vertexAttrib4fv(index:Float, values:haxe.extern.EitherType<Float32Array, std.Array<Float>>):Void;
