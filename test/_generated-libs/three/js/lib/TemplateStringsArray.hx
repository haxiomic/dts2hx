...
extern typedef TemplateStringsArray = {
	...
	**/
	...
	function filter<S:(T)>(callbackfn:(value:String, index:Float, array:ReadonlyArray<String>) -> Bool, ?thisArg:Any):std.Array<S>;
	/**
	...
	**/
	...
	function find<S:(T)>(predicate:(value:String, index:Float, obj:ReadonlyArray<String>) -> Bool, ?thisArg:Any):Null<S>;
	/**
