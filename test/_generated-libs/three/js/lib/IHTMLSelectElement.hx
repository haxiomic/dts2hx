...
extern typedef IHTMLSelectElement = {
	...
	**/
	...
	final labels : NodeListOf<js.html.IHTMLLabelElement>;
	/**
	...
	**/
	var name : String;
	final options : js.html.IHTMLOptionsCollection;
	/**
	...
	**/
	...
	final selectedOptions : HTMLCollectionOf<js.html.IHTMLOptionElement>;
	/**
	...
	**/
	final validity : js.html.IValidityState;
	/**
	...
	**/
	function add(element:haxe.extern.EitherType<js.html.IHTMLOptGroupElement, js.html.IHTMLOptionElement>, ?before:haxe.extern.EitherType<Float, js.html.IHTMLElement>):Void;
	/**
	...
	**/
	function item(index:Float):Null<js.html.IElement>;
	/**
		Retrieves a select object or an object from an options collection.
	**/
	function namedItem(name:String):Null<js.html.IHTMLOptionElement>;
	/**
