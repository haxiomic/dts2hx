...
@:native("Uint8Array") @tsInterface extern class Uint8Array {
	@:overload(function(arrayOrArrayBuffer:haxe.extern.EitherType<ArrayBuffer, ArrayLike<Float>>):Uint8Array { })
	...
	**/
	function every(callbackfn:(value:Float, index:Float, array:Uint8Array) -> Any, ?thisArg:Any):Bool;
	/**
	...
	**/
	function filter(callbackfn:(value:Float, index:Float, array:Uint8Array) -> Any, ?thisArg:Any):Uint8Array;
	/**
		Returns the value of the first element in the array where predicate is true, and undefined
		otherwise.
	**/
	function find(predicate:(value:Float, index:Float, obj:Uint8Array) -> Bool, ?thisArg:Any):Null<Float>;
	/**
		Returns the index of the first element in the array where predicate is true, and -1
		otherwise.
	**/
	function findIndex(predicate:(value:Float, index:Float, obj:Uint8Array) -> Bool, ?thisArg:Any):Float;
	/**
		Performs the specified action for each element in an array.
	**/
	function forEach(callbackfn:(value:Float, index:Float, array:Uint8Array) -> Void, ?thisArg:Any):Void;
	/**
	...
	**/
	function map(callbackfn:(value:Float, index:Float, array:Uint8Array) -> Float, ?thisArg:Any):Uint8Array;
	/**
	...
	**/
	function some(callbackfn:(value:Float, index:Float, array:Uint8Array) -> Any, ?thisArg:Any):Bool;
	/**
		Sorts an array.
	**/
	...
	**/
	static function of(items:std.Array<Float>):Uint8Array;
	/**
