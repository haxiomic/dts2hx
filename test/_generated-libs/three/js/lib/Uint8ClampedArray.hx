...
**/
@:native("Uint8ClampedArray") @tsInterface extern class Uint8ClampedArray {
	@:overload(function(arrayOrArrayBuffer:haxe.extern.EitherType<ArrayBuffer, ArrayLike<Float>>):Uint8ClampedArray { })
	@:overload(function(buffer:ArrayBuffer, byteOffset:Float, ?length:Float):Uint8ClampedArray { })
