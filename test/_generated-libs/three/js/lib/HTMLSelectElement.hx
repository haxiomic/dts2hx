...
**/
@:native("HTMLSelectElement") @tsInterface extern class HTMLSelectElement {
	function new();
	...
	**/
	final form : Null<HTMLFormElement>;
	final labels : NodeListOf<js.html.HTMLLabelElement>;
	/**
	...
	**/
	var name : String;
	final options : js.html.HTMLOptionsCollection;
	/**
	...
	**/
	...
	final selectedOptions : HTMLCollectionOf<js.html.HTMLOptionElement>;
	/**
	...
	**/
	function add(element:haxe.extern.EitherType<js.html.HTMLOptGroupElement, js.html.HTMLOptionElement>, ?before:haxe.extern.EitherType<Float, js.html.HTMLElement>):Void;
	/**
	...
	**/
	...
	/**
		Retrieves a select object or an object from an options collection.
	**/
	function namedItem(name:String):Null<js.html.HTMLOptionElement>;
	/**
	...
	**/
	...
	static var prototype : HTMLSelectElement;
}