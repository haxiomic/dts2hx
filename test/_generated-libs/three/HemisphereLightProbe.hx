package three;
@:jsRequire("three", "HemisphereLightProbe") extern class HemisphereLightProbe {
	...
	**/
	function add(object:std.Array<Object3D>):HemisphereLightProbe;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):HemisphereLightProbe;
	/**
