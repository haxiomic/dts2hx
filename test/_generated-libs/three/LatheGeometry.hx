package three;
@:jsRequire("three", "LatheGeometry") extern class LatheGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):LatheGeometry;
