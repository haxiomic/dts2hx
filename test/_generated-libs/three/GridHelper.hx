package three;
@:jsRequire("three", "GridHelper") extern class GridHelper {
	...
	**/
	function add(object:std.Array<Object3D>):GridHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):GridHelper;
	/**
