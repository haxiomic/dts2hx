package three;
@:jsRequire("three", "ArrowHelper") extern class ArrowHelper {
	...
	**/
	function add(object:std.Array<Object3D>):ArrowHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):ArrowHelper;
	/**
