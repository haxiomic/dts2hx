package three;
@:jsRequire("three", "RectAreaLight") extern class RectAreaLight {
	...
	**/
	function add(object:std.Array<Object3D>):RectAreaLight;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):RectAreaLight;
	/**
