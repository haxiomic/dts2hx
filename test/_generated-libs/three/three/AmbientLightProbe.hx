package three;
@:jsRequire("three", "AmbientLightProbe") extern class AmbientLightProbe {
	...
	**/
	function add(object:std.Array<Object3D>):AmbientLightProbe;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):AmbientLightProbe;
	/**
