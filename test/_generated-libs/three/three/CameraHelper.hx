package three;
@:jsRequire("three", "CameraHelper") extern class CameraHelper {
	...
	**/
	function add(object:std.Array<Object3D>):CameraHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):CameraHelper;
	/**
