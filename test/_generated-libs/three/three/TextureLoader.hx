...
@:jsRequire("three", "TextureLoader") extern class TextureLoader {
	...
	**/
	function load(url:String, ?onLoad:(texture:Texture) -> Void, ?onProgress:(event:js.lib.ProgressEvent_<js.html.EventTarget>) -> Void, ?onError:(event:js.html.ErrorEvent) -> Void):Texture;
