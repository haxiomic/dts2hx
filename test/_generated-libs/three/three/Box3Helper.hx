package three;
@:jsRequire("three", "Box3Helper") extern class Box3Helper {
	...
	**/
	function add(object:std.Array<Object3D>):Box3Helper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):Box3Helper;
	/**
