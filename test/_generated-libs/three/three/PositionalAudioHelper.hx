package three;
@:jsRequire("three", "PositionalAudioHelper") extern class PositionalAudioHelper {
	...
	**/
	function add(object:std.Array<Object3D>):PositionalAudioHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):PositionalAudioHelper;
	/**
