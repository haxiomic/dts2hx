package three;
@:jsRequire("three", "AxesHelper") extern class AxesHelper {
	...
	**/
	function add(object:std.Array<Object3D>):AxesHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):AxesHelper;
	/**
