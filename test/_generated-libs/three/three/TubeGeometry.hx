package three;
@:jsRequire("three", "TubeGeometry") extern class TubeGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):TubeGeometry;
