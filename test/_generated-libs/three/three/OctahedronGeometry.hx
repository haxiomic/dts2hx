package three;
@:jsRequire("three", "OctahedronGeometry") extern class OctahedronGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):OctahedronGeometry;
