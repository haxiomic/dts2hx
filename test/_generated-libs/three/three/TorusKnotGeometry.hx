package three;
@:jsRequire("three", "TorusKnotGeometry") extern class TorusKnotGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):TorusKnotGeometry;
