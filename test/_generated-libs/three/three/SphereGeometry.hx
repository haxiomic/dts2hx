...
**/
@:jsRequire("three", "SphereGeometry") extern class SphereGeometry {
	/**
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):SphereGeometry;
