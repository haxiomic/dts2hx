package three;
@:jsRequire("three", "TorusGeometry") extern class TorusGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):TorusGeometry;
