package three;
@:jsRequire("three", "TextGeometry") extern class TextGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):TextGeometry;
