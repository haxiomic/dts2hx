package three;
@:jsRequire("three", "ExtrudeGeometry") extern class ExtrudeGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):ExtrudeGeometry;
