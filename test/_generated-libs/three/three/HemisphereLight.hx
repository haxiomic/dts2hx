package three;
@:jsRequire("three", "HemisphereLight") extern class HemisphereLight {
	...
	**/
	function add(object:std.Array<Object3D>):HemisphereLight;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):HemisphereLight;
	/**
