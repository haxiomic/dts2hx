package three;
@:jsRequire("three", "VertexNormalsHelper") extern class VertexNormalsHelper {
	...
	**/
	function add(object:std.Array<Object3D>):VertexNormalsHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):VertexNormalsHelper;
	/**
