package three;
@:jsRequire("three", "CanvasTexture") extern class CanvasTexture {
	function new(canvas:haxe.extern.EitherType<js.html.IHTMLCanvasElement, haxe.extern.EitherType<js.html.IHTMLVideoElement, js.html.IHTMLImageElement>>, ?mapping:Mapping, ?wrapS:Wrapping, ?wrapT:Wrapping, ?magFilter:TextureFilter, ?minFilter:TextureFilter, ?format:PixelFormat, ?type:TextureDataType, ?anisotropy:Float);
	var id : Float;
	var uuid : String;
	var name : String;
