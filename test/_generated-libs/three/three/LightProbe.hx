package three;
@:jsRequire("three", "LightProbe") extern class LightProbe {
	...
	**/
	function add(object:std.Array<Object3D>):LightProbe;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):LightProbe;
	/**
