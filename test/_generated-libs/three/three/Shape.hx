...
**/
@:jsRequire("three", "Shape") extern class Shape {
	...
	function fromPoints(vectors:std.Array<Vector2>):Void;
	function setFromPoints(vectors:std.Array<Vector2>):Void;
	...
	var autoClose : Bool;
	function add(curve:Curve<Vector2>):Void;
	...
	**/
	...
	function createGeometry(points:std.Array<Vector2>):Geometry;
	/**
