...
@:jsRequire("three", "ImageLoader") extern class ImageLoader {
	...
	**/
	function load(url:String, ?onLoad:(image:js.html.ImageElement) -> Void, ?onProgress:(event:js.lib.ProgressEvent_<js.html.EventTarget>) -> Void, ?onError:(event:js.html.ErrorEvent) -> Void):js.html.ImageElement;
