package three;
extern typedef MeshPhongMaterialParameters = MaterialParameters & { /**
		geometry color in hexadecimal. Default is 0xffffff.
	**/
	@:optional
	var color : haxe.extern.EitherType<String, haxe.extern.EitherType<Float, Color>>; @:optional
	var specular : haxe.extern.EitherType<String, haxe.extern.EitherType<Float, Color>>; @:optional
	var shininess : Float; @:optional
