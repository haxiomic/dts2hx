package three;
@:jsRequire("three", "DirectionalLightHelper") extern class DirectionalLightHelper {
	...
	**/
	function add(object:std.Array<Object3D>):DirectionalLightHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):DirectionalLightHelper;
	/**
