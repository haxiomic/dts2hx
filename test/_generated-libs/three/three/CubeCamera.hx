package three;
@:jsRequire("three", "CubeCamera") extern class CubeCamera {
	...
	**/
	function add(object:std.Array<Object3D>):CubeCamera;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):CubeCamera;
	/**
