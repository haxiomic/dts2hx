...
@:jsRequire("three", "CubeTextureLoader") extern class CubeTextureLoader {
	...
	@:optional
	var path : String;
	function load(urls:Array<String>, ?onLoad:(texture:CubeTexture) -> Void, ?onProgress:(event:js.lib.ProgressEvent_<js.html.EventTarget>) -> Void, ?onError:(event:js.html.ErrorEvent) -> Void):CubeTexture;
