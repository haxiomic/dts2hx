package three;
@:jsRequire("three", "PlaneHelper") extern class PlaneHelper {
	...
	**/
	function add(object:std.Array<Object3D>):PlaneHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):PlaneHelper;
	/**
