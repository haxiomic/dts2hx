package three;
@:jsRequire("three", "SkinnedMesh") extern class SkinnedMesh {
	...
	**/
	function add(object:std.Array<Object3D>):SkinnedMesh;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):SkinnedMesh;
	/**
