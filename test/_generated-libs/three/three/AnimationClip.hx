...
@:jsRequire("three", "AnimationClip") extern class AnimationClip {
	...
	static function parse(json:Any):AnimationClip;
	static function parseAnimation(animation:Any, bones:std.Array<Bone>, nodeName:String):AnimationClip;
	static function toJSON():Any;
}