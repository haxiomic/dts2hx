package three;
@:jsRequire("three", "LineSegments") extern class LineSegments {
	...
	**/
	function add(object:std.Array<Object3D>):LineSegments;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):LineSegments;
	/**
