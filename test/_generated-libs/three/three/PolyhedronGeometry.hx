package three;
@:jsRequire("three", "PolyhedronGeometry") extern class PolyhedronGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):PolyhedronGeometry;
