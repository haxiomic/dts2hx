package three;
@:jsRequire("three", "SkeletonHelper") extern class SkeletonHelper {
	...
	**/
	function add(object:std.Array<Object3D>):SkeletonHelper;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):SkeletonHelper;
	/**
