package three;
@:jsRequire("three", "StereoCamera") extern class StereoCamera {
	function new();
	var type : String;
	var aspect : Float;
	var eyeSep : Float;
	...
	**/
	function add(object:std.Array<Object3D>):StereoCamera;
	/**
		Removes object as child of this object.
	**/
	function remove(object:std.Array<Object3D>):StereoCamera;
	/**
