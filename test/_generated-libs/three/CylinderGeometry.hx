package three;
@:jsRequire("three", "CylinderGeometry") extern class CylinderGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):CylinderGeometry;
