package three;
@:jsRequire("three", "DodecahedronGeometry") extern class DodecahedronGeometry {
	...
	**/
	...
	function setFromPoints(points:haxe.extern.EitherType<std.Array<Vector3>, std.Array<Vector2>>):DodecahedronGeometry;
