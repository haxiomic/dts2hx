...
typedef BubbleControllerDatasetOptions = {
	/**
	...
	**/
	...
	/**
		Point radius
	**/
	var radius : ScriptableAndArray<Float, ScriptableContext<String>>;
	/**
		Extra radius added to point radius for hit detection.
	**/
	var hitRadius : ScriptableAndArray<Float, ScriptableContext<String>>;
	/**
		Point style
	**/
	...
	**/
	var rotation : ScriptableAndArray<Float, ScriptableContext<String>>;
	...
	**/
	var hoverRadius : ScriptableAndArray<Float, ScriptableContext<String>>;
