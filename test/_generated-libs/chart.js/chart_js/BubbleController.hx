...
@:jsRequire("chart.js", "BubbleController") @:forward @:forwardStatics extern abstract BubbleController(DatasetController<String, Element<{ }, { }>, Element<{ }, { }>, ts.AnyOf5<Float, CartesianParsedData, BarParsedData, BubbleParsedData, RadialParsedData>>) from DatasetController<String, Element<{ }, { }>, Element<{ }, { }>, ts.AnyOf5<Float, CartesianParsedData, BarParsedData, BubbleParsedData, RadialParsedData>> to DatasetController<String, Element<{ }, { }>, Element<{ }, { }>, ts.AnyOf5<Float, CartesianParsedData, BarParsedData, BubbleParsedData, RadialParsedData>> {
	...
	static var prototype : BubbleController;
}