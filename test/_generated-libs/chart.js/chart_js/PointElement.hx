...
@:jsRequire("chart.js", "PointElement") extern class PointElement<T:(PointProps), O:(PointOptions)> {
	function new(cfg:haxe.DynamicAccess<Any>);
	final skip : Bool;
	final parsed : CartesianParsedData;
	final x : Float;
	final y : Float;
	final active : Bool;
	final options : O;
	...
	static var prototype : PointElement<PointProps, PointOptions>;
}