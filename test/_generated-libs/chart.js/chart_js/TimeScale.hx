...
@:jsRequire("chart.js", "TimeScale") extern class TimeScale<O:(TimeScaleOptions)> {
	function new<O:(TimeScaleOptions)>(cfg:haxe.DynamicAccess<Any>);
	function getDataTimestamps():Array<Float>;
	function getLabelTimestamps():Array<String>;
	function normalize(values:Array<Float>):Array<Float>;
	final id : String;
	final type : String;
	...
	**/
	...
	static var prototype : TimeScale<TimeScaleOptions>;
}