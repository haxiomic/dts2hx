...
@:jsRequire("chart.js", "Scale") extern class Scale<O:(CoreScaleOptions)> {
	function new(cfg:{ var id : String; var type : String; var ctx : js.html.CanvasRenderingContext2D; var chart : Chart<String, Array<Null<ts.AnyOf3<Float, ScatterDataPoint, BubbleDataPoint>>>, Any>; });
	final id : String;
	final type : String;
	...
	**/
	...
	static var prototype : Scale<Dynamic>;
}