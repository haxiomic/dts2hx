...
typedef LineControllerDatasetOptions = {
	/**
	...
	**/
	var pointBackgroundColor : ScriptableAndArray<Color, ScriptableContext<String>>;
	/**
		The border color for points.
	**/
	var pointBorderColor : ScriptableAndArray<Color, ScriptableContext<String>>;
	/**
		The width of the point border in pixels.
	**/
	var pointBorderWidth : ScriptableAndArray<Float, ScriptableContext<String>>;
	/**
		The pixel size of the non-displayed point that reacts to mouse events.
	**/
	var pointHitRadius : ScriptableAndArray<Float, ScriptableContext<String>>;
	/**
		The radius of the point shape. If set to 0, the point is not rendered.
	**/
	var pointRadius : ScriptableAndArray<Float, ScriptableContext<String>>;
	/**
		The rotation of the point in degrees.
	**/
	var pointRotation : ScriptableAndArray<Float, ScriptableContext<String>>;
	/**
		Style of the point.
	**/
	var pointStyle : ScriptableAndArray<PointStyle, ScriptableContext<String>>;
	/**
		Point background color when hovered.
	**/
	var pointHoverBackgroundColor : ScriptableAndArray<Color, ScriptableContext<String>>;
	/**
		Point border color when hovered.
	**/
	var pointHoverBorderColor : ScriptableAndArray<Color, ScriptableContext<String>>;
	/**
		Border width of point when hovered.
	**/
	var pointHoverBorderWidth : ScriptableAndArray<Float, ScriptableContext<String>>;
	/**
		The radius of the point when hovered.
	**/
	var pointHoverRadius : ScriptableAndArray<Float, ScriptableContext<String>>;
	/**
