...
@:native("VideoFrame") extern class VideoFrame {
	@:overload(function(data:AllowSharedBufferSource, init:VideoFrameBufferInit):VideoFrame { })
	function new(image:CanvasImageSource, ?init:VideoFrameInit);
	/**
	...
	**/
	...
	static var prototype : VideoFrame;
}