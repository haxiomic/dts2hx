...
@:native("Int16Array") extern class Int16Array {
	@:overload(function(arrayOrArrayBuffer:haxe.extern.EitherType<IArrayBuffer, haxe.extern.EitherType<ISharedArrayBuffer, ArrayLike<Float>>>):IInt16Array { })
	@:overload(function(buffer:haxe.extern.EitherType<IArrayBuffer, ISharedArrayBuffer>, byteOffset:Float, ?length:Float):IInt16Array { })
	@:overload(function(elements:Iterable<Float>):IInt16Array { })
	@:overload(function():IInt16Array { })
