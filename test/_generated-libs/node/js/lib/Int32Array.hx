...
@:native("Int32Array") extern class Int32Array {
	@:overload(function(arrayOrArrayBuffer:haxe.extern.EitherType<IArrayBuffer, haxe.extern.EitherType<ISharedArrayBuffer, ArrayLike<Float>>>):IInt32Array { })
	@:overload(function(buffer:haxe.extern.EitherType<IArrayBuffer, ISharedArrayBuffer>, byteOffset:Float, ?length:Float):IInt32Array { })
	@:overload(function(elements:Iterable<Float>):IInt32Array { })
	@:overload(function():IInt32Array { })
	...
	**/
	static function of(items:std.Array<Float>):IInt32Array;
	/**
