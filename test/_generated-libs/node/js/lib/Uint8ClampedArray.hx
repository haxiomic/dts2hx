...
@:native("Uint8ClampedArray") extern class Uint8ClampedArray {
	@:overload(function(arrayOrArrayBuffer:haxe.extern.EitherType<IArrayBuffer, haxe.extern.EitherType<ISharedArrayBuffer, ArrayLike<Float>>>):IUint8ClampedArray { })
	@:overload(function(buffer:haxe.extern.EitherType<IArrayBuffer, ISharedArrayBuffer>, byteOffset:Float, ?length:Float):IUint8ClampedArray { })
	@:overload(function(elements:Iterable<Float>):IUint8ClampedArray { })
	@:overload(function():IUint8ClampedArray { })
	...
	**/
	...
	static final prototype : IUint8ClampedArray;
	/**
		The size in bytes of each element in the array.
	**/
	...
	**/
	static function of(items:std.Array<Float>):IUint8ClampedArray;
	/**
		...
		Creates an array from an array-like or iterable object.
	**/
	@:overload(function<T>(arrayLike:ArrayLike<T>, mapfn:(v:T, k:Float) -> Float, ?thisArg:Any):IUint8ClampedArray { })
	@:overload(function(arrayLike:Iterable<Float>, ?mapfn:(v:Float, k:Float) -> Float, ?thisArg:Any):IUint8ClampedArray { })
	static function from(arrayLike:ArrayLike<Float>):IUint8ClampedArray;
}