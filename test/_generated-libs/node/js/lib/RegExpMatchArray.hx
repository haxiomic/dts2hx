...
extern typedef RegExpMatchArray = {
	...
	**/
	...
	function filter<S:(T)>(callbackfn:(value:String, index:Float, array:std.Array<String>) -> Bool, ?thisArg:Any):std.Array<S>;
	/**
	...
	**/
	...
	function find<S:(T)>(predicate:(value:String, index:Float, obj:std.Array<String>) -> Bool, ?thisArg:Any):Null<S>;
	/**
