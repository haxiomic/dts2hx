...
@:forward
abstract SymbolConstructor(SymbolConstructor_) from SymbolConstructor_ to SymbolConstructor_ {
	/**
	...
	**/
	...
	@:selfCall
	inline function call(?description:ts.AnyOf2<String, Float>):js.lib.Symbol return (cast this : SymbolConstructor_).call(description);
}
