...
@:forward
abstract StylePropertyMapReadOnlyIterator<T>(StylePropertyMapReadOnlyIteratorTypedef<T>) from StylePropertyMapReadOnlyIteratorTypedef<T> to StylePropertyMapReadOnlyIteratorTypedef<T> {
	@:optional
