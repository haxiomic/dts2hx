...
**/
@:native("CookieChangeEvent") extern class CookieChangeEvent {
	function new(type:String, ?eventInitDict:CookieChangeEventInit);
	/**
	...
	**/
	final changed : haxe.ds.ReadOnlyArray<CookieListItem>;
	/**
	...
	**/
	final deleted : haxe.ds.ReadOnlyArray<CookieListItem>;
	/**
	...
	**/
	...
	static var prototype : CookieChangeEvent;
}