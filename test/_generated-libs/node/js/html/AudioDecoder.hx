...
**/
@:native("AudioDecoder") extern class AudioDecoder {
	function new(init:AudioDecoderInit);
	/**
	...
	**/
	...
	static var prototype : AudioDecoder;
	/**
	...
	**/
	static function isConfigSupported(config:AudioDecoderConfig):js.lib.Promise<AudioDecoderSupport>;
}