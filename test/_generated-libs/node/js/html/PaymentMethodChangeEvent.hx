...
**/
@:native("PaymentMethodChangeEvent") extern class PaymentMethodChangeEvent {
	function new(type:String, ?eventInitDict:PaymentMethodChangeEventInit);
	/**
	...
	**/
	function updateWith(detailsPromise:ts.AnyOf2<PaymentDetailsUpdate, js.lib.PromiseLike<PaymentDetailsUpdate>>):Void;
	/**
	...
	**/
	...
	static var prototype : PaymentMethodChangeEvent;
}