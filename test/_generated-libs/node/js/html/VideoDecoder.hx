...
**/
@:native("VideoDecoder") extern class VideoDecoder {
	function new(init:VideoDecoderInit);
	/**
	...
	**/
	...
	static var prototype : VideoDecoder;
	/**
	...
	**/
	static function isConfigSupported(config:VideoDecoderConfig):js.lib.Promise<VideoDecoderSupport>;
}