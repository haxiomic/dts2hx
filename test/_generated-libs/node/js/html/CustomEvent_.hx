...
**/
@:native("CustomEvent") extern class CustomEvent_<T> {
	function new<T>(type:String, ?eventInitDict:CustomEventInit_<T>);
	/**
	...
	**/
	function initCustomEvent(type:String, ?bubbles:Bool, ?cancelable:Bool, ?detail:T):Void;
	/**
	...
	**/
	...
	static var prototype : CustomEvent_<Dynamic>;
}