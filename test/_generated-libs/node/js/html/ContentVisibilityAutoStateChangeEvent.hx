...
**/
@:native("ContentVisibilityAutoStateChangeEvent") extern class ContentVisibilityAutoStateChangeEvent {
	function new(type:String, ?eventInitDict:ContentVisibilityAutoStateChangeEventInit);
	/**
	...
	**/
	...
	static var prototype : ContentVisibilityAutoStateChangeEvent;
}