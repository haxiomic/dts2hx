...
**/
@:native("PictureInPictureEvent") extern class PictureInPictureEvent {
	function new(type:String, eventInitDict:PictureInPictureEventInit);
	/**
	...
	**/
	...
	static var prototype : PictureInPictureEvent;
}