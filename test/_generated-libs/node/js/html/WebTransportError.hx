...
**/
@:native("WebTransportError") extern class WebTransportError {
	function new(?message:String, ?options:WebTransportErrorOptions);
	/**
	...
	**/
	...
	@:optional
	var stack : String;
	static var prototype : WebTransportError;
}