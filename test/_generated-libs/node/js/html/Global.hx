...
@:native("") extern class Global {
	...
	static function setTimeout(handler:haxe.extern.EitherType<String, js.lib.IFunction>, ?timeout:Float, arguments:std.Array<Any>):Float;
	@:overload(function(timeoutId:global.nodejs.Timeout):Void { })
	static function clearTimeout(?handle:Float):Void;
	@:overload(function(callback:(args:std.Array<Any>) -> Void, ms:Float, args:std.Array<Any>):global.nodejs.Timeout { })
	static function setInterval(handler:haxe.extern.EitherType<String, js.lib.IFunction>, ?timeout:Float, arguments:std.Array<Any>):Float;
	...
	static function queueMicrotask(callback:js.lib.IFunction):Void;
	static var console : js.html.IConsole;
}