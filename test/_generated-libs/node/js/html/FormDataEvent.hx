...
**/
@:native("FormDataEvent") extern class FormDataEvent {
	function new(type:String, eventInitDict:FormDataEventInit);
	/**
	...
	**/
	final formData : js.html.FormData;
	/**
	...
	**/
	...
	static var prototype : FormDataEvent;
}