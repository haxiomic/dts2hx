...
**/
@:native("CSSMatrixComponent") extern class CSSMatrixComponent {
	function new(matrix:js.html.DOMMatrixReadOnly, ?options:CSSMatrixComponentOptions);
	/**
	...
	**/
	...
	static var prototype : CSSMatrixComponent;
}