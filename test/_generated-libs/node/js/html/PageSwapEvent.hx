...
**/
@:native("PageSwapEvent") extern class PageSwapEvent {
	function new(type:String, ?eventInitDict:PageSwapEventInit);
	/**
	...
	**/
	final activation : Null<NavigationActivation>;
	/**
	...
	**/
	...
	static var prototype : PageSwapEvent;
}