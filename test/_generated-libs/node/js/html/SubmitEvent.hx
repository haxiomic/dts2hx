...
**/
@:native("SubmitEvent") extern class SubmitEvent {
	function new(type:String, ?eventInitDict:SubmitEventInit);
	/**
	...
	**/
	final submitter : Null<js.html.Element>;
	/**
	...
	**/
	...
	static var prototype : SubmitEvent;
}