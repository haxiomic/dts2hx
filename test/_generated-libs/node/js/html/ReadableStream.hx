...
@:native("ReadableStream") extern class ReadableStream<R> {
	@:overload(function<R>(underlyingSource:UnderlyingDefaultSource<R>, ?strategy:QueuingStrategy<R>):ReadableStream<R> { })
	@:overload(function<R>(?underlyingSource:UnderlyingSource<R>, ?strategy:QueuingStrategy<R>):ReadableStream<R> { })
	function new(underlyingSource:UnderlyingByteSource, ?strategy:{ @:optional var highWaterMark : Float; });
	/**
