...
@:native("CSSMathClamp") extern class CSSMathClamp {
	function new(lower:CSSNumberish, value:CSSNumberish, upper:CSSNumberish);
	final lower : CSSNumericValue;
	final upper : CSSNumericValue;
	final value : CSSNumericValue;
	/**
	...
	**/
	...
	static var prototype : CSSMathClamp;
}