...
**/
@:native("VideoEncoder") extern class VideoEncoder {
	function new(init:VideoEncoderInit);
	/**
	...
	**/
	...
	static var prototype : VideoEncoder;
	/**
	...
	**/
	static function isConfigSupported(config:VideoEncoderConfig):js.lib.Promise<VideoEncoderSupport>;
}