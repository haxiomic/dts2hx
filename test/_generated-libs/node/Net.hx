...
@:jsRequire("net") @valueModuleOnly extern class Net {
	...
	static function connect(options:ts.AnyOf2<node.net.TcpNetConnectOpts, node.net.IpcNetConnectOpts>, ?connectionListener:() -> Void):node.net.Socket;
	@:overload(function(port:Float, ?host:String, ?connectionListener:() -> Void):node.net.Socket { })
	@:overload(function(path:String, ?connectionListener:() -> Void):node.net.Socket { })
	static function createConnection(options:ts.AnyOf2<node.net.TcpNetConnectOpts, node.net.IpcNetConnectOpts>, ?connectionListener:() -> Void):node.net.Socket;
