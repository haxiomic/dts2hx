...
typedef Process = {
	...
	**/
	...
	/**
		...
		appear in the array returned by the
		{@link
		argv
		}
		property, and do not
	...
	**/
	...
	/**
		...
		```
	**/
	function dlopen(module:Dynamic, filename:String, ?flags:Float):Void;
	/**
	...
	**/
	function exit(?code:ts.AnyOf2<String, Float>):ts.Never;
	/**
	...
	**/
	var exitCode : Null<ts.AnyOf2<String, Float>>;
	/**
	...
	**/
	@:overload(function(id:String):Null<Dynamic> { })
	function getBuiltinModule<ID:(String)>(id:ID):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function loadEnvFile(?path:node.fs.PathLike):Void;
	/**
	...
	**/
	var permission : ProcessPermission;
	/**
	...
	**/
	...
	final features : ProcessFeatures;
	/**
	...
	**/
	@:optional
	var channel : node.child_process.Control;
	/**
	...
	**/
	@:optional
	@:overload(function(message:Dynamic, sendHandle:node.child_process.SendHandle, ?callback:(error:Null<js.lib.Error>) -> Void):Bool { })
	@:overload(function(message:Dynamic, callback:(error:Null<js.lib.Error>) -> Void):Bool { })
	function send(message:Dynamic, ?sendHandle:node.child_process.SendHandle, ?options:node.child_process.MessageOptions, ?callback:(error:Null<js.lib.Error>) -> Void):Bool;
	/**
	...
	**/
	...
	/**
		...
		* Flags _must_ be allowable within `NODE_OPTIONS`.
		...
		), `process.allowedNodeEnvironmentFlags` will
	...
	**/
	...
	@:overload(function(event:String, listener:(value:Dynamic, source:Float) -> Void):Process { })
	...
	**/
	...
	@:overload(function(event:String, message:Any, sendHandle:node.child_process.SendHandle):Process { })
	@:overload(function(event:String, value:Dynamic, source:Float):Process { })
	...
	**/
	...
	@:overload(function(event:String):Array<(value:Dynamic, source:Float) -> Void> { })
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeListener<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Process;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Process;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):Process;
	/**
