...
typedef ReadStream = {
	...
	**/
	function setEncoding(?encoding:BufferEncoding):ReadStream;
	/**
	...
	**/
	...
	@:overload(function(str:ts.AnyOf2<String, js.lib.Uint8Array_<js.lib.ArrayBufferLike>>, ?encoding:BufferEncoding, ?callback:() -> Void):ReadStream { })
	...
	**/
	...
	@:overload(function(event:String, listener:(ip:String, port:Float, family:Float) -> Void):ReadStream { })
	@:overload(function(event:String, listener:(data:global.NonSharedBuffer) -> Void):ReadStream { })
	@:overload(function(event:String, listener:() -> Void):ReadStream { })
	@:overload(function(event:String, listener:() -> Void):ReadStream { })
	...
	**/
	...
	@:overload(function(event:String, ip:String, port:Float, family:Float):Bool { })
	@:overload(function(event:String, data:global.NonSharedBuffer):Bool { })
	@:overload(function(event:String):Bool { })
	@:overload(function(event:String):Bool { })
	...
	**/
	...
	function compose<T:(ReadableStream)>(stream:ts.AnyOf4<ReadStream, T, Iterable<T>, js.lib.AsyncIterable<T, Dynamic, Dynamic>>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
	...
	**/
	function setDefaultEncoding(encoding:BufferEncoding):ReadStream;
	/**
