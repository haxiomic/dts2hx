...
@:jsRequire("child_process") @valueModuleOnly extern class Child_process {
	...
	@:overload(function(command:String, options:{ var encoding : String; } & node.child_process.ExecOptions, ?callback:(error:Null<node.child_process.ExecException>, stdout:ts.AnyOf2<String, global.IBuffer>, stderr:ts.AnyOf2<String, global.IBuffer>) -> Void):node.child_process.ChildProcess { })
	...
	@:overload(function(command:String, options:Null<{ @:optional var encoding : String; } & node.child_process.ExecOptions>, ?callback:(error:Null<node.child_process.ExecException>, stdout:ts.AnyOf2<String, global.IBuffer>, stderr:ts.AnyOf2<String, global.IBuffer>) -> Void):node.child_process.ChildProcess { })
	...
	@:overload(function(file:String, options:node.child_process.ExecFileOptionsWithOtherEncoding, callback:(error:Null<ts.lib.IError>, stdout:ts.AnyOf2<String, global.IBuffer>, stderr:ts.AnyOf2<String, global.IBuffer>) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<ts.lib.ReadonlyArray<String>>, options:node.child_process.ExecFileOptionsWithOtherEncoding, callback:(error:Null<ts.lib.IError>, stdout:ts.AnyOf2<String, global.IBuffer>, stderr:ts.AnyOf2<String, global.IBuffer>) -> Void):node.child_process.ChildProcess { })
	...
	@:overload(function(file:String, options:Null<{ @:optional var encoding : String; } & node.child_process.ExecFileOptions>, callback:Null<(error:Null<ts.lib.IError>, stdout:ts.AnyOf2<String, global.IBuffer>, stderr:ts.AnyOf2<String, global.IBuffer>) -> Void>):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<ts.lib.ReadonlyArray<String>>, options:Null<{ @:optional var encoding : String; } & node.child_process.ExecFileOptions>, callback:Null<(error:Null<ts.lib.IError>, stdout:ts.AnyOf2<String, global.IBuffer>, stderr:ts.AnyOf2<String, global.IBuffer>) -> Void>):node.child_process.ChildProcess { })
