...
@:jsRequire("dns", "Resolver") extern class Resolver {
	...
	var resolve : {
		...
		@:overload(function(hostname:String, rrtype:String, callback:(err:global.nodejs.ErrnoException, addresses:std.Array<String>) -> Void):Void { })
		@:overload(function(hostname:String, rrtype:String, callback:(err:global.nodejs.ErrnoException, addresses:std.Array<ts.AnyOf10<AnyARecord, AnyAaaaRecord, AnyCnameRecord, AnyMxRecord, AnyNaptrRecord, AnyNsRecord, AnyPtrRecord, AnySoaRecord, AnySrvRecord, AnyTxtRecord>>) -> Void):Void { })
		@:overload(function(hostname:String, rrtype:String, callback:(err:global.nodejs.ErrnoException, addresses:std.Array<String>) -> Void):Void { })
		...
		@:overload(function(hostname:String, rrtype:String, callback:(err:global.nodejs.ErrnoException, addresses:ts.AnyOf7<std.Array<String>, SoaRecord, std.Array<ts.AnyOf10<AnyARecord, AnyAaaaRecord, AnyCnameRecord, AnyMxRecord, AnyNaptrRecord, AnyNsRecord, AnyPtrRecord, AnySoaRecord, AnySrvRecord, AnyTxtRecord>>, std.Array<MxRecord>, std.Array<NaptrRecord>, std.Array<SrvRecord>, std.Array<std.Array<String>>>) -> Void):Void { })
		@:selfCall
	...
	var resolveAny : (hostname:String, callback:(err:global.nodejs.ErrnoException, addresses:std.Array<ts.AnyOf10<AnyARecord, AnyAaaaRecord, AnyCnameRecord, AnyMxRecord, AnyNaptrRecord, AnyNsRecord, AnyPtrRecord, AnySoaRecord, AnySrvRecord, AnyTxtRecord>>) -> Void) -> Void;
