...
typedef Http2Stream = {
	...
	**/
	...
	@:overload(function(event:String, listener:(chunk:ts.AnyOf2<String, node.buffer.NonSharedBuffer>) -> Void):Http2Stream { })
	@:overload(function(event:String, listener:() -> Void):Http2Stream { })
	@:overload(function(event:String, listener:() -> Void):Http2Stream { })
	...
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):Http2Stream { })
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):Http2Stream { })
	...
	**/
	...
	function compose<T:(global.nodejs.ReadableStream)>(stream:ts.AnyOf4<Http2Stream, T, Iterable<T>, js.lib.AsyncIterable<T, Dynamic, Dynamic>>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Http2Stream;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):Http2Stream;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):Http2Stream;
	/**
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):Http2Stream;
	/**
	...
	**/
	...
	@:overload(function(chunk:Dynamic, encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):Http2Stream { })
