...
typedef Http2Session = {
	...
	**/
	...
	@:overload(function(event:String, listener:ts.AnyOf2<(errorCode:Float, lastStreamID:Float) -> Void, (errorCode:Float, lastStreamID:Float, opaqueData:node.buffer.NonSharedBuffer) -> Void>):Http2Session { })
	...
	**/
	...
	@:overload(function(event:String, errorCode:Float, lastStreamID:Float, ?opaqueData:node.buffer.NonSharedBuffer):Bool { })
	...
	**/
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeListener<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Http2Session;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Http2Session;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):Http2Session;
	/**
