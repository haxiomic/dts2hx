...
typedef ServerHttp2Stream = {
	...
	**/
	...
	@:overload(function(event:String, listener:(chunk:ts.AnyOf2<String, node.buffer.NonSharedBuffer>) -> Void):ServerHttp2Stream { })
	@:overload(function(event:String, listener:() -> Void):ServerHttp2Stream { })
	@:overload(function(event:String, listener:() -> Void):ServerHttp2Stream { })
	...
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):ServerHttp2Stream { })
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):ServerHttp2Stream { })
	...
	**/
	...
	function compose<T:(global.nodejs.ReadableStream)>(stream:ts.AnyOf4<ServerHttp2Stream, T, Iterable<T>, js.lib.AsyncIterable<T, Dynamic, Dynamic>>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):ServerHttp2Stream;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):ServerHttp2Stream;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):ServerHttp2Stream;
	/**
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):ServerHttp2Stream;
	/**
	...
	**/
	...
	@:overload(function(chunk:Dynamic, encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):ServerHttp2Stream { })
