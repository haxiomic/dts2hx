...
@:jsRequire("http2", "Http2ServerResponse") extern class Http2ServerResponse extends node.stream.Stream {
	...
	@:overload(function(chunk:ts.AnyOf2<String, global.Buffer>, ?encoding:String, ?callback:(err:ts.lib.Error) -> Void):Bool { })
	function write(chunk:ts.AnyOf2<String, global.Buffer>, ?callback:(err:ts.lib.Error) -> Void):Bool;
