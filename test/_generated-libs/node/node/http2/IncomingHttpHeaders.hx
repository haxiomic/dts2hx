...
abstract IncomingHttpHeaders(IncomingHttpHeadersTypedef) from IncomingHttpHeadersTypedef to IncomingHttpHeadersTypedef {
	...
	inline function set_ColonPath(v:String):String { js.Syntax.code("{0}[{1}] = {2}", this, ':path', v); return v; }
	@:optional
	public var ColonMethod(get, set):String;
	inline function get_ColonMethod():String return js.Syntax.field(cast this, ':method');
	inline function set_ColonMethod(v:String):String { js.Syntax.code("{0}[{1}] = {2}", this, ':method', v); return v; }
	@:optional
	public var ColonAuthority(get, set):String;
	inline function get_ColonAuthority():String return js.Syntax.field(cast this, ':authority');
	inline function set_ColonAuthority(v:String):String { js.Syntax.code("{0}[{1}] = {2}", this, ':authority', v); return v; }
	@:optional
