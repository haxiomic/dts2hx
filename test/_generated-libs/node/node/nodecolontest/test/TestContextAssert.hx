...
typedef TestContextAssert = {
	...
	**/
	dynamic function deepEqual(actual:Any, expected:Any, ?message:ts.AnyOf2<String, js.lib.Error>):Void;
	/**
	...
	**/
	...
	/**
		...
		**Legacy assertion mode**
		...
		error message is assigned. If the `message` parameter is an instance of an `Error` then it will be thrown instead of the `AssertionError`.
	**/
	dynamic function equal(actual:Any, expected:Any, ?message:ts.AnyOf2<String, js.lib.Error>):Void;
	/**
