...
typedef TestsStream = {
	/**
		...
		7. resume
	**/
	@:overload(function(event:String, listener:(data:node.nodecolontest.test.eventdata.TestComplete) -> Void):TestsStream { })
	@:overload(function(event:String, listener:(data:node.nodecolontest.test.eventdata.TestDequeue) -> Void):TestsStream { })
	@:overload(function(event:String, listener:(data:node.nodecolontest.test.eventdata.TestDiagnostic) -> Void):TestsStream { })
	@:overload(function(event:String, listener:(data:node.nodecolontest.test.eventdata.TestEnqueue) -> Void):TestsStream { })
	@:overload(function(event:String, listener:(data:node.nodecolontest.test.eventdata.TestFail) -> Void):TestsStream { })
	@:overload(function(event:String, listener:(data:node.nodecolontest.test.eventdata.TestPass) -> Void):TestsStream { })
	@:overload(function(event:String, listener:(data:node.nodecolontest.test.eventdata.TestPlan) -> Void):TestsStream { })
	@:overload(function(event:String, listener:(data:node.nodecolontest.test.eventdata.TestStart) -> Void):TestsStream { })
	@:overload(function(event:String, listener:(data:node.nodecolontest.test.eventdata.TestStderr) -> Void):TestsStream { })
	@:overload(function(event:String, listener:(data:node.nodecolontest.test.eventdata.TestStdout) -> Void):TestsStream { })
	@:overload(function(event:String, listener:() -> Void):TestsStream { })
	@:overload(function(event:String, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):TestsStream { })
	function addListener(event:String, listener:(data:node.nodecolontest.test.eventdata.TestCoverage) -> Void):TestsStream;
	/**
		...
		```
	**/
	@:overload(function(event:String, data:node.nodecolontest.test.eventdata.TestComplete):Bool { })
	@:overload(function(event:String, data:node.nodecolontest.test.eventdata.TestDequeue):Bool { })
	@:overload(function(event:String, data:node.nodecolontest.test.eventdata.TestDiagnostic):Bool { })
	@:overload(function(event:String, data:node.nodecolontest.test.eventdata.TestEnqueue):Bool { })
	@:overload(function(event:String, data:node.nodecolontest.test.eventdata.TestFail):Bool { })
	@:overload(function(event:String, data:node.nodecolontest.test.eventdata.TestPass):Bool { })
	@:overload(function(event:String, data:node.nodecolontest.test.eventdata.TestPlan):Bool { })
	@:overload(function(event:String, data:node.nodecolontest.test.eventdata.TestStart):Bool { })
	@:overload(function(event:String, data:node.nodecolontest.test.eventdata.TestStderr):Bool { })
	@:overload(function(event:String, data:node.nodecolontest.test.eventdata.TestStdout):Bool { })
	@:overload(function(event:String):Bool { })
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>, args:haxe.extern.Rest<Dynamic>):Bool { })
	function emit(event:String, data:node.nodecolontest.test.eventdata.TestCoverage):Bool;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):TestsStream { })
	@:overload(function(event:String, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):TestsStream { })
	function on(event:String, listener:(data:node.nodecolontest.test.eventdata.TestCoverage) -> Void):TestsStream;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):TestsStream { })
	@:overload(function(event:String, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):TestsStream { })
	function once(event:String, listener:(data:node.nodecolontest.test.eventdata.TestCoverage) -> Void):TestsStream;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):TestsStream { })
	@:overload(function(event:String, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):TestsStream { })
	function prependListener(event:String, listener:(data:node.nodecolontest.test.eventdata.TestCoverage) -> Void):TestsStream;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):TestsStream { })
	@:overload(function(event:String, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):TestsStream { })
	function prependOnceListener(event:String, listener:(data:node.nodecolontest.test.eventdata.TestCoverage) -> Void):TestsStream;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):TestsStream;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function unpipe(?destination:global.nodejs.WritableStream):TestsStream;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):TestsStream;
	...
	**/
	function destroy(?error:js.lib.Error):TestsStream;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	@:overload(function(event:String, listener:(chunk:Dynamic) -> Void):TestsStream { })
	@:overload(function(event:String, listener:() -> Void):TestsStream { })
	@:overload(function(event:String, listener:(err:js.lib.Error) -> Void):TestsStream { })
	@:overload(function(event:String, listener:() -> Void):TestsStream { })
	@:overload(function(event:String, listener:() -> Void):TestsStream { })
	@:overload(function(event:String, listener:() -> Void):TestsStream { })
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):TestsStream { })
	function removeListener(event:String, listener:() -> Void):TestsStream;
	function pipe<T:(global.nodejs.WritableStream)>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T:(global.nodejs.ReadableStream)>(stream:ts.AnyOf4<TestsStream, T, Iterable<T>, js.lib.AsyncIterable<T, Dynamic, Dynamic>>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):TestsStream;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):TestsStream;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function setMaxListeners(n:Float):TestsStream;
	/**
