...
typedef StartupSnapshot = {
	...
	**/
	function addSerializeCallback(callback:StartupSnapshotCallbackFn, ?data:Dynamic):Void;
	/**
	...
	**/
	function addDeserializeCallback(callback:StartupSnapshotCallbackFn, ?data:Dynamic):Void;
	/**
	...
	**/
	function setDeserializeMainFunction(callback:StartupSnapshotCallbackFn, ?data:Dynamic):Void;
	/**
