...
typedef RequestOptions = {
	...
	var auth : String;
	@:optional
	dynamic function createConnection(options:node.http.ClientRequestArgs, oncreate:(err:Null<js.lib.Error>, socket:node.stream.stream.Duplex) -> Void):Null<node.stream.stream.Duplex>;
	@:optional
	var defaultPort : ts.AnyOf2<String, Float>;
	@:optional
	var family : Float;
	@:optional
	var headers : ts.AnyOf2<haxe.ds.ReadOnlyArray<String>, node.http.OutgoingHttpHeaders>;
	@:optional
	var host : String;
	@:optional
	var hostname : String;
