...
@:jsRequire("https", "Agent") extern class Agent extends node.http.Agent {
	...
	**/
	function createConnection(options:RequestOptions, ?callback:(err:Null<js.lib.Error>, stream:node.stream.stream.Duplex) -> Void):Null<node.stream.stream.Duplex>;
	/**
	...
	**/
	function getName(?options:RequestOptions):String;
	/**
