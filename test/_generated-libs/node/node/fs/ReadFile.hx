...
@:jsRequire("fs", "readFile") @valueModuleOnly extern class ReadFile {
	...
	**/
	...
	@:selfCall
	static function call(path:ts.AnyOf4<String, Float, global.Buffer, node.url.URL>, options:Null<{ @:optional var encoding : ts.Never; @:optional var flag : String; }>, callback:(err:global.nodejs.ErrnoException, data:global.Buffer) -> Void):Void;
}