...
@:jsRequire("fs", "readFile") extern class ReadFile {
	...
	**/
	...
	var flag : String; }>):js.lib.Promise<String> { })
	...
	var flag : String; }>):js.lib.Promise<haxe.extern.EitherType<String, global.Buffer>> { })
	...
	var flag : String; }):js.lib.Promise<global.Buffer>;
}