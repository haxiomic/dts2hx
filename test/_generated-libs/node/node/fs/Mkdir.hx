...
@:jsRequire("fs", "mkdir") @valueModuleOnly extern class Mkdir {
	/**
		...
		See the POSIX [`mkdir(2)`](http://man7.org/linux/man-pages/man2/mkdir.2.html) documentation for more details.
	**/
	@:overload(function(path:PathLike, options:Null<ts.AnyOf3<String, Float, { /** Indicates whether parent folders should be created.If a folder was created, the path to the first created folder will be returned. **/ @:optional var recursive : Bool; /** A file mode. If a string is passed, it is parsed as an octal integer. If not specified **/ @:optional var mode : Mode; }>>, callback:NoParamCallback):Void { })
	...
	@:selfCall
	static function call(path:PathLike, options:{ /** Indicates whether parent folders should be created.If a folder was created, the path to the first created folder will be returned. **/ var recursive : Bool; /** A file mode. If a string is passed, it is parsed as an octal integer. If not specified **/ @:optional var mode : Mode; }, callback:ts.AnyOf2<(err:Null<global.nodejs.ErrnoException>) -> Void, (err:Null<global.nodejs.ErrnoException>, path:String) -> Void>):Void;
}