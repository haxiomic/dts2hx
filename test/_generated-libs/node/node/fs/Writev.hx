...
@:jsRequire("fs", "writev") @valueModuleOnly extern class Writev {
	...
	**/
	...
	@:selfCall
	static function call<TBuffers:(haxe.ds.ReadOnlyArray<global.nodejs.ArrayBufferView<js.lib.ArrayBufferLike>>)>(fd:Float, buffers:TBuffers, cb:(err:Null<global.nodejs.ErrnoException>, bytesWritten:Float, buffers:TBuffers) -> Void):Void;
}