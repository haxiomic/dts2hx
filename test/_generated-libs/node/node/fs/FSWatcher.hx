...
typedef FSWatcher = {
	...
	**/
	...
	/**
		events.EventEmitter
		  ...
		  3. error
	**/
	@:overload(function(event:String, listener:(eventType:String, filename:ts.AnyOf2<String, node.buffer.NonSharedBuffer>) -> Void):FSWatcher { })
	...
	**/
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeListener<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):FSWatcher;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):FSWatcher;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):FSWatcher;
	/**
