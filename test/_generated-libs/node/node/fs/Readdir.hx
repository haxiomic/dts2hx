...
@:jsRequire("fs", "readdir") @valueModuleOnly extern class Readdir {
	...
	**/
	...
	var withFileTypes : Bool; }>):js.lib.Promise<std.Array<global.Buffer>> { })
	...
	var withFileTypes : Bool; }>):js.lib.Promise<haxe.extern.EitherType<std.Array<String>, std.Array<global.Buffer>>> { })
	...
	var withFileTypes : Bool; }>):js.lib.Promise<std.Array<String>>;
}