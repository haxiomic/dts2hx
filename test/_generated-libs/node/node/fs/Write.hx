...
@:jsRequire("fs", "write") @valueModuleOnly extern class Write {
	...
	**/
	...
	@:selfCall
	static function call<TBuffer:(node.crypto.Binary)>(fd:Float, buffer:TBuffer, offset:Null<Float>, length:Null<Float>, position:Null<Float>, callback:(err:global.nodejs.ErrnoException, written:Float, buffer:TBuffer) -> Void):Void;
}