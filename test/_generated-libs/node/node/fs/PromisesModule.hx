...
@:jsRequire("fs", "promises") @valueModuleOnly extern class PromisesModule {
	...
	**/
	@:overload(function(path:PathLike, opts:{ var bigint : Bool; }):js.lib.Promise<BigIntStats> { })
	...
	@:overload(function(path:PathLike, opts:{ var bigint : Bool; }):js.lib.Promise<BigIntStatsFs> { })
	...
	**/
	...
	static function watch(filename:PathLike, options:ts.AnyOf2<String, { var encoding : String; @:optional var persistent : Bool; @:optional var recursive : Bool; /** When provided the corresponding `AbortController` can be used to cancel an asynchronous action. **/ @:optional var signal : js.html.AbortSignal; }>):js.lib.AsyncIterable<node.fs.promises.FileChangeInfo<node.buffer.NonSharedBuffer>, Dynamic, Dynamic>;
	/**
