...
typedef IGzip = {
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):Gzip { })
	@:overload(function(event:String, listener:() -> Void):Gzip { })
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):Gzip { })
	@:overload(function(event:String, listener:() -> Void):Gzip { })
	@:overload(function(event:String, listener:() -> Void):Gzip { })
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):Gzip { })
	...
	**/
	...
	function compose<T:(global.nodejs.ReadableStream)>(stream:ts.AnyOf4<Gzip, T, Iterable<T>, js.lib.AsyncIterable<T, Dynamic, Dynamic>>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Gzip;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):Gzip;
	/**
