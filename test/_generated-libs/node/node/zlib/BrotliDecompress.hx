...
@:jsRequire("zlib", "BrotliDecompress") extern class BrotliDecompress extends node.stream.stream.Transform {
	function new(?options:BrotliOptions);
	/**
		Event emitter
	...
	**/
	...
	static var prototype : BrotliDecompress;
}