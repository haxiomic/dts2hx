...
typedef IGunzip = {
	...
	**/
	...
	function compose<T:(global.nodejs.ReadableStream)>(stream:ts.AnyOf4<Gunzip, T, Iterable<T>, js.lib.AsyncIterable<T, Dynamic, Dynamic>>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
