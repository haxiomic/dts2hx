	...
	@:overload(function<Http1Request:({
		...
		**/
		...
		/**
			...
			```
		**/
		@:overload(function(emitter:js.html.EventTarget, eventName:String, ?options:NodeHttp2):js.lib.Promise<Array<Dynamic>> { })
		function once(emitter:global.nodejs.EventEmitter<NodeHttp2>, eventName:ts.AnyOf2<String, js.lib.Symbol>, ?options:NodeHttp2):js.lib.Promise<Array<Dynamic>>;
		/**
			```js
			...
			```
		**/
		@:overload(function(emitter:js.html.EventTarget, eventName:String, ?options:NodeHttp2):global.nodejs.AsyncIterator<Array<Dynamic>, Dynamic, Dynamic> { })
		function on(emitter:global.nodejs.EventEmitter<NodeHttp2>, eventName:ts.AnyOf2<String, js.lib.Symbol>, ?options:NodeHttp2):global.nodejs.AsyncIterator<Array<Dynamic>, Dynamic, Dynamic>;
		/**
			...
			```
		**/
		function listenerCount(emitter:global.nodejs.EventEmitter<NodeHttp2>, eventName:ts.AnyOf2<String, js.lib.Symbol>):Float;
		/**
			...
			```
		**/
		function getEventListeners(emitter:ts.AnyOf2<js.html.EventTarget, global.nodejs.EventEmitter<NodeHttp2>>, name:ts.AnyOf2<String, js.lib.Symbol>):Array<haxe.Constraints.Function>;
		/**
			...
			```
		**/
		function getMaxListeners(emitter:ts.AnyOf2<js.html.EventTarget, global.nodejs.EventEmitter<NodeHttp2>>):Float;
		/**
			```js
			...
			```
		**/
		function setMaxListeners(?n:Float, eventTargets:haxe.extern.Rest<ts.AnyOf2<js.html.EventTarget, global.nodejs.EventEmitter<NodeHttp2>>>):Void;
		/**
