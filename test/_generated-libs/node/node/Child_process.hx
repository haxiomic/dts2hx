...
@:jsRequire("child_process") @valueModuleOnly extern class Child_process {
	...
	@:overload(function(file:String, args:Null<js.lib.ReadonlyArray<String>>, options:Null<{ @:optional var encoding : String; } & node.child_process.ExecFileOptions>):node.child_process.ChildProcess { })
	@:overload(function(file:String, callback:(error:Null<js.lib.IError>, stdout:String, stderr:String) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<js.lib.ReadonlyArray<String>>, callback:(error:Null<js.lib.IError>, stdout:String, stderr:String) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, options:node.child_process.ExecFileOptionsWithBufferEncoding, callback:(error:Null<js.lib.IError>, stdout:global.IBuffer, stderr:global.IBuffer) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<js.lib.ReadonlyArray<String>>, options:node.child_process.ExecFileOptionsWithBufferEncoding, callback:(error:Null<js.lib.IError>, stdout:global.IBuffer, stderr:global.IBuffer) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, options:node.child_process.ExecFileOptionsWithStringEncoding, callback:(error:Null<js.lib.IError>, stdout:String, stderr:String) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<js.lib.ReadonlyArray<String>>, options:node.child_process.ExecFileOptionsWithStringEncoding, callback:(error:Null<js.lib.IError>, stdout:String, stderr:String) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, options:node.child_process.ExecFileOptionsWithOtherEncoding, callback:(error:Null<js.lib.IError>, stdout:haxe.extern.EitherType<String, global.IBuffer>, stderr:haxe.extern.EitherType<String, global.IBuffer>) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<js.lib.ReadonlyArray<String>>, options:node.child_process.ExecFileOptionsWithOtherEncoding, callback:(error:Null<js.lib.IError>, stdout:haxe.extern.EitherType<String, global.IBuffer>, stderr:haxe.extern.EitherType<String, global.IBuffer>) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, options:node.child_process.ExecFileOptions, callback:(error:Null<js.lib.IError>, stdout:String, stderr:String) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<js.lib.ReadonlyArray<String>>, options:node.child_process.ExecFileOptions, callback:(error:Null<js.lib.IError>, stdout:String, stderr:String) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, options:Null<{ @:optional var encoding : String; } & node.child_process.ExecFileOptions>, callback:Null<(error:Null<js.lib.IError>, stdout:haxe.extern.EitherType<String, global.IBuffer>, stderr:haxe.extern.EitherType<String, global.IBuffer>) -> Void>):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<js.lib.ReadonlyArray<String>>, options:Null<{ @:optional var encoding : String; } & node.child_process.ExecFileOptions>, callback:Null<(error:Null<js.lib.IError>, stdout:haxe.extern.EitherType<String, global.IBuffer>, stderr:haxe.extern.EitherType<String, global.IBuffer>) -> Void>):node.child_process.ChildProcess { })
	...
	@:overload(function(command:String, ?args:js.lib.ReadonlyArray<String>, ?options:node.child_process.SpawnSyncOptionsWithBufferEncoding):node.child_process.SpawnSyncReturns<global.IBuffer> { })
	@:overload(function(command:String, ?args:js.lib.ReadonlyArray<String>, ?options:node.child_process.SpawnSyncOptions):node.child_process.SpawnSyncReturns<global.IBuffer> { })
	...
	@:overload(function(command:String, ?args:js.lib.ReadonlyArray<String>, ?options:node.child_process.ExecFileSyncOptionsWithBufferEncoding):global.IBuffer { })
	@:overload(function(command:String, ?args:js.lib.ReadonlyArray<String>, ?options:node.child_process.ExecFileSyncOptions):global.IBuffer { })
