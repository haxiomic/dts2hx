...
@:jsRequire("child_process") @valueModuleOnly extern class Child_process {
	...
	@:overload(function(command:String, options:{ var encoding : String; } & node.child_process.ExecOptions, ?callback:(error:Null<node.child_process.ExecException>, stdout:haxe.extern.EitherType<String, global.Buffer>, stderr:haxe.extern.EitherType<String, global.Buffer>) -> Void):node.child_process.ChildProcess { })
	...
	@:overload(function(command:String, options:Null<{ @:optional
	var encoding : String; } & node.child_process.ExecOptions>, ?callback:(error:Null<node.child_process.ExecException>, stdout:haxe.extern.EitherType<String, global.Buffer>, stderr:haxe.extern.EitherType<String, global.Buffer>) -> Void):node.child_process.ChildProcess { })
	...
	@:overload(function(file:String, options:Null<{ @:optional
	var encoding : String; } & node.child_process.ExecFileOptions>):node.child_process.ChildProcess { })
	@:overload(function(file:String, ?args:js.lib.ReadonlyArray<String>):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<js.lib.ReadonlyArray<String>>, options:Null<{ @:optional
	var encoding : String; } & node.child_process.ExecFileOptions>):node.child_process.ChildProcess { })
	...
	@:overload(function(file:String, options:Null<{ @:optional
	var encoding : String; } & node.child_process.ExecFileOptions>, callback:Null<(error:Null<js.lib.Error>, stdout:haxe.extern.EitherType<String, global.Buffer>, stderr:haxe.extern.EitherType<String, global.Buffer>) -> Void>):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<js.lib.ReadonlyArray<String>>, options:Null<{ @:optional
	var encoding : String; } & node.child_process.ExecFileOptions>, callback:Null<(error:Null<js.lib.Error>, stdout:haxe.extern.EitherType<String, global.Buffer>, stderr:haxe.extern.EitherType<String, global.Buffer>) -> Void>):node.child_process.ChildProcess { })
