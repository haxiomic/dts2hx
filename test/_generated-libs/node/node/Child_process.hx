...
@:jsRequire("child_process") @valueModuleOnly extern class Child_process {
	...
	@:overload(function(file:String, callback:(error:Null<ts.lib.Error>, stdout:String, stderr:String) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<ts.lib.ReadonlyArray<String>>, callback:(error:Null<ts.lib.Error>, stdout:String, stderr:String) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, options:node.child_process.ExecFileOptionsWithBufferEncoding, callback:(error:Null<ts.lib.Error>, stdout:global.Buffer, stderr:global.Buffer) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<ts.lib.ReadonlyArray<String>>, options:node.child_process.ExecFileOptionsWithBufferEncoding, callback:(error:Null<ts.lib.Error>, stdout:global.Buffer, stderr:global.Buffer) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, options:node.child_process.ExecFileOptionsWithStringEncoding, callback:(error:Null<ts.lib.Error>, stdout:String, stderr:String) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<ts.lib.ReadonlyArray<String>>, options:node.child_process.ExecFileOptionsWithStringEncoding, callback:(error:Null<ts.lib.Error>, stdout:String, stderr:String) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, options:node.child_process.ExecFileOptionsWithOtherEncoding, callback:(error:Null<ts.lib.Error>, stdout:ts.AnyOf2<String, global.Buffer>, stderr:ts.AnyOf2<String, global.Buffer>) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<ts.lib.ReadonlyArray<String>>, options:node.child_process.ExecFileOptionsWithOtherEncoding, callback:(error:Null<ts.lib.Error>, stdout:ts.AnyOf2<String, global.Buffer>, stderr:ts.AnyOf2<String, global.Buffer>) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, options:node.child_process.ExecFileOptions, callback:(error:Null<ts.lib.Error>, stdout:String, stderr:String) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<ts.lib.ReadonlyArray<String>>, options:node.child_process.ExecFileOptions, callback:(error:Null<ts.lib.Error>, stdout:String, stderr:String) -> Void):node.child_process.ChildProcess { })
	@:overload(function(file:String, options:Null<{ @:optional var encoding : String; } & node.child_process.ExecFileOptions>, callback:Null<(error:Null<ts.lib.Error>, stdout:ts.AnyOf2<String, global.Buffer>, stderr:ts.AnyOf2<String, global.Buffer>) -> Void>):node.child_process.ChildProcess { })
	@:overload(function(file:String, args:Null<ts.lib.ReadonlyArray<String>>, options:Null<{ @:optional var encoding : String; } & node.child_process.ExecFileOptions>, callback:Null<(error:Null<ts.lib.Error>, stdout:ts.AnyOf2<String, global.Buffer>, stderr:ts.AnyOf2<String, global.Buffer>) -> Void>):node.child_process.ChildProcess { })
	...
	@:overload(function(command:String, ?args:ts.lib.ReadonlyArray<String>, ?options:node.child_process.SpawnSyncOptionsWithBufferEncoding):node.child_process.SpawnSyncReturns<global.Buffer> { })
	@:overload(function(command:String, ?args:ts.lib.ReadonlyArray<String>, ?options:node.child_process.SpawnSyncOptions):node.child_process.SpawnSyncReturns<global.Buffer> { })
	...
	@:overload(function(command:String, ?args:ts.lib.ReadonlyArray<String>, ?options:node.child_process.ExecFileSyncOptionsWithBufferEncoding):global.Buffer { })
	@:overload(function(command:String, ?args:ts.lib.ReadonlyArray<String>, ?options:node.child_process.ExecFileSyncOptions):global.Buffer { })
