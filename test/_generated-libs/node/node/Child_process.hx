...
@:jsRequire("child_process") @valueModuleOnly extern class Child_process {
	...
	@:overload(function(file:String, args:Null<js.lib.ReadonlyArray<String>>, options:node.child_process.ExecFileOptionsWithOtherEncoding, callback:(error:Null<js.lib.Error>, stdout:ts.AnyOf2<String, global.Buffer>, stderr:ts.AnyOf2<String, global.Buffer>) -> Void):node.child_process.ChildProcess { })
	...
	@:overload(function(file:String, args:Null<js.lib.ReadonlyArray<String>>, options:Null<{ @:optional var encoding : String; } & node.child_process.ExecFileOptions>, callback:Null<(error:Null<js.lib.Error>, stdout:ts.AnyOf2<String, global.Buffer>, stderr:ts.AnyOf2<String, global.Buffer>) -> Void>):node.child_process.ChildProcess { })
