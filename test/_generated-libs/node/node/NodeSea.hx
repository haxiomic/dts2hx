...
/**
	...
	```
**/
@:jsRequire("node:sea") @valueModuleOnly extern class NodeSea {
	...
	**/
	...
	static function getAsset(key:String):js.lib.ArrayBuffer;
	/**
		Similar to `sea.getAsset()`, but returns the result in a [`Blob`](https://developer.mozilla.org/en-US/docs/Web/API/Blob).
		An error is thrown when no matching asset can be found.
	**/
	static function getAssetAsBlob(key:String, ?options:{ var type : String; }):js.html.Blob;
	/**
		This method can be used to retrieve the assets configured to be bundled into the
		single-executable application at build time.
		An error is thrown when no matching asset can be found.
	...
	**/
	static function getRawAsset(key:String):ts.AnyOf2<String, js.lib.ArrayBuffer>;
}