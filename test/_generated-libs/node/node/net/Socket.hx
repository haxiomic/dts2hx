...
@:jsRequire("net", "Socket") extern class Socket extends node.stream.Duplex {
	...
	@:overload(function(str:ts.AnyOf3<String, js.lib.Uint8Array, global.Buffer>, ?encoding:String, ?cb:ts.AnyOf2<() -> Void, (err:js.lib.Error) -> Void>):Bool { })
	...
	@:overload(function(buffer:ts.AnyOf3<String, js.lib.Uint8Array, global.Buffer>, ?cb:() -> Void):Void { })
	@:overload(function(str:ts.AnyOf3<String, js.lib.Uint8Array, global.Buffer>, ?encoding:String, ?cb:() -> Void):Void { })
