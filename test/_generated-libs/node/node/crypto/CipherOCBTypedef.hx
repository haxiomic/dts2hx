...
typedef CipherOCBTypedef = {
	function setAAD(buffer:global.nodejs.ArrayBufferView<js.lib.ArrayBufferLike>, ?options:{ var plaintextLength : Float; }):CipherOCB;
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):CipherOCB { })
	@:overload(function(event:String, listener:() -> Void):CipherOCB { })
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):CipherOCB { })
	@:overload(function(event:String, listener:() -> Void):CipherOCB { })
	@:overload(function(event:String, listener:() -> Void):CipherOCB { })
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):CipherOCB { })
	...
	**/
	...
	function compose<T:(global.nodejs.ReadableStream)>(stream:ts.AnyOf4<CipherOCB, T, Iterable<T>, js.lib.AsyncIterable<T, Dynamic, Dynamic>>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):CipherOCB;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):CipherOCB;
	/**
