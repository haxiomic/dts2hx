...
typedef DecipherOCBTypedef = {
	function setAuthTag(buffer:global.nodejs.ArrayBufferView<js.lib.ArrayBufferLike>):DecipherOCB;
	function setAAD(buffer:global.nodejs.ArrayBufferView<js.lib.ArrayBufferLike>, ?options:{ var plaintextLength : Float; }):DecipherOCB;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):DecipherOCB { })
	@:overload(function(event:String, listener:() -> Void):DecipherOCB { })
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):DecipherOCB { })
	@:overload(function(event:String, listener:() -> Void):DecipherOCB { })
	@:overload(function(event:String, listener:() -> Void):DecipherOCB { })
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):DecipherOCB { })
	...
	**/
	...
	function compose<T:(global.nodejs.ReadableStream)>(stream:ts.AnyOf4<DecipherOCB, T, Iterable<T>, js.lib.AsyncIterable<T, Dynamic, Dynamic>>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):DecipherOCB;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):DecipherOCB;
	/**
