...
typedef CipherChaCha20Poly1305Typedef = {
	function setAAD(buffer:global.nodejs.ArrayBufferView<js.lib.ArrayBufferLike>, options:{ var plaintextLength : Float; }):CipherChaCha20Poly1305;
	function getAuthTag():node.buffer.NonSharedBuffer;
	/**
	...
	**/
	function setAutoPadding(?autoPadding:Bool):CipherChaCha20Poly1305;
	...
	**/
	...
	/**
		...
		11. unpipe
	**/
	@:overload(function(event:String, listener:(chunk:Dynamic) -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:String, listener:() -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:String, listener:() -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:String, listener:(err:js.lib.Error) -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:String, listener:() -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:String, listener:() -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:String, listener:() -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:String, listener:() -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):CipherChaCha20Poly1305 { })
	function addListener(event:String, listener:() -> Void):CipherChaCha20Poly1305;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):CipherChaCha20Poly1305 { })
	function on(event:String, listener:() -> Void):CipherChaCha20Poly1305;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):CipherChaCha20Poly1305 { })
	function once(event:String, listener:() -> Void):CipherChaCha20Poly1305;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):CipherChaCha20Poly1305 { })
	function prependListener(event:String, listener:() -> Void):CipherChaCha20Poly1305;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):CipherChaCha20Poly1305 { })
	function prependOnceListener(event:String, listener:() -> Void):CipherChaCha20Poly1305;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(event:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):CipherChaCha20Poly1305 { })
	function removeListener(event:String, listener:() -> Void):CipherChaCha20Poly1305;
	function pipe<T:(global.nodejs.WritableStream)>(destination:T, ?options:{ @:optional var end : Bool; }):T;
	function compose<T:(global.nodejs.ReadableStream)>(stream:ts.AnyOf4<CipherChaCha20Poly1305, T, Iterable<T>, js.lib.AsyncIterable<T, Dynamic, Dynamic>>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):CipherChaCha20Poly1305;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):CipherChaCha20Poly1305;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function setMaxListeners(n:Float):CipherChaCha20Poly1305;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):CipherChaCha20Poly1305;
	/**
	...
	**/
	function pause():CipherChaCha20Poly1305;
	/**
	...
	**/
	function resume():CipherChaCha20Poly1305;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function unpipe(?destination:global.nodejs.WritableStream):CipherChaCha20Poly1305;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):CipherChaCha20Poly1305;
	...
	**/
	function destroy(?error:js.lib.Error):CipherChaCha20Poly1305;
	/**
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):CipherChaCha20Poly1305;
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):CipherChaCha20Poly1305 { })
	@:overload(function(chunk:Dynamic, encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):CipherChaCha20Poly1305 { })
	function end(?cb:() -> Void):CipherChaCha20Poly1305;
	/**
