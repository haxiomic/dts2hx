...
typedef CipherCCMTypedef = {
	function setAAD(buffer:global.nodejs.ArrayBufferView<js.lib.ArrayBufferLike>, options:{ var plaintextLength : Float; }):CipherCCM;
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):CipherCCM { })
	@:overload(function(event:String, listener:() -> Void):CipherCCM { })
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):CipherCCM { })
	@:overload(function(event:String, listener:() -> Void):CipherCCM { })
	@:overload(function(event:String, listener:() -> Void):CipherCCM { })
	@:overload(function(event:String, listener:(src:node.stream.stream.Readable) -> Void):CipherCCM { })
	...
	**/
	...
	function compose<T:(global.nodejs.ReadableStream)>(stream:ts.AnyOf4<CipherCCM, T, Iterable<T>, js.lib.AsyncIterable<T, Dynamic, Dynamic>>, ?options:{ var signal : js.html.AbortSignal; }):T;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):CipherCCM;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):CipherCCM;
	/**
