...
@:jsRequire("vm", "Script") extern class Script {
	...
	**/
	...
	/**
		...
		```
	**/
	function runInNewContext(?contextObject:ts.AnyOf2<Float, Context>, ?options:RunningScriptInNewContextOptions):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function createCachedData():node.buffer.NonSharedBuffer;
	@:optional
