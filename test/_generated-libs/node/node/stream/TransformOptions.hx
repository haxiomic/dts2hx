package node.stream;
extern typedef TransformOptions = DuplexOptions & { @:optional
	...
	function destroy(error:Null<js.lib.Error>, callback:(error:Null<js.lib.Error>) -> Void):Void; @:optional
	function transform(chunk:Any, encoding:String, callback:(?error:js.lib.Error, ?data:Any) -> Void):Void; @:optional
