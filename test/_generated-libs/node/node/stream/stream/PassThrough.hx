...
**/
@:jsRequire("stream", "Stream.PassThrough") extern class PassThrough extends Transform {
	/**
		Event emitter
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):PassThrough { })
	@:overload(function(event:String, listener:() -> Void):PassThrough { })
	@:overload(function(event:String, listener:(src:Readable) -> Void):PassThrough { })
	@:overload(function(event:String, listener:() -> Void):PassThrough { })
	@:overload(function(event:String, listener:() -> Void):PassThrough { })
	@:overload(function(event:String, listener:(src:Readable) -> Void):PassThrough { })
	...
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):PassThrough;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):PassThrough;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):PassThrough;
	/**
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):PassThrough;
	/**
	...
	**/
	...
	@:overload(function(chunk:Dynamic, encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):PassThrough { })
