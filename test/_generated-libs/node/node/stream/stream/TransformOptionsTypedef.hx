...
typedef TransformOptionsTypedef<T:(Transform)> = {
	@:optional
	dynamic function transform(chunk:Dynamic, encoding:global.nodejs.BufferEncoding, callback:TransformCallback):Void;
	@:optional
	dynamic function flush(callback:TransformCallback):Void;
	@:optional
