...
/**
	...
	* `crypto streams`
**/
@:jsRequire("stream", "Stream.Transform") extern class Transform extends Duplex {
	function new(?opts:TransformOptions<Transform>);
	function _transform(chunk:Dynamic, encoding:global.nodejs.BufferEncoding, callback:TransformCallback):Void;
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):Transform { })
	@:overload(function(event:String, listener:() -> Void):Transform { })
	@:overload(function(event:String, listener:(src:Readable) -> Void):Transform { })
	@:overload(function(event:String, listener:() -> Void):Transform { })
	@:overload(function(event:String, listener:() -> Void):Transform { })
	@:overload(function(event:String, listener:(src:Readable) -> Void):Transform { })
	...
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Transform;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):Transform;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.nodejs.BufferEncoding):Transform;
	/**
	...
	**/
	function setDefaultEncoding(encoding:global.nodejs.BufferEncoding):Transform;
	/**
	...
	**/
	...
	@:overload(function(chunk:Dynamic, encoding:global.nodejs.BufferEncoding, ?cb:() -> Void):Transform { })
