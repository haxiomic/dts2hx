package node.stream;
@:jsRequire("stream", "PassThrough") extern class PassThrough {
	...
	/**
		...
		5. error
	**/
	@:overload(function(event:String, listener:(chunk:Any) -> Void):PassThrough { })
	@:overload(function(event:String, listener:() -> Void):PassThrough { })
	@:overload(function(event:String, listener:() -> Void):PassThrough { })
	@:overload(function(event:String, listener:(err:js.lib.IError) -> Void):PassThrough { })
	@:overload(function(event:haxe.extern.EitherType<String, js.lib.Symbol>, listener:(args:std.Array<Any>) -> Void):PassThrough { })
	...
	function off(event:haxe.extern.EitherType<String, js.lib.Symbol>, listener:(args:std.Array<Any>) -> Void):PassThrough;
	function removeAllListeners(?event:haxe.extern.EitherType<String, js.lib.Symbol>):PassThrough;
