...
@:jsRequire("url", "URLSearchParams") extern class URLSearchParams {
	function new(?init:ts.AnyOf5<String, Array<ts.Tuple2<String, String>>, URLSearchParams, Iterable<ts.Tuple2<String, String>>, haxe.DynamicAccess<Null<ts.AnyOf2<String, Array<String>>>>>);
