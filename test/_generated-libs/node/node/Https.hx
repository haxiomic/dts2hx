...
@:jsRequire("https") @valueModuleOnly extern class Https {
	...
	**/
	@:optional
	var minVersion : String; @:optional
	...
	var SNICallback : (servername:String, cb:(err:Null<js.lib.Error>, ctx:node.tls.SecureContext) -> Void) -> Void; @:optional
	var sessionTimeout : Float; @:optional
	var ticketKeys : global.Buffer; @:optional
	...
	function pipeline<T:(global.nodejs.WritableStream)>(stream1:global.nodejs.ReadableStream, stream2:T, ?callback:(err:global.nodejs.ErrnoException) -> Void):T; function listenerCount(emitter:node.events.EventEmitter, event:haxe.extern.EitherType<String, js.lib.Symbol>):Float; var defaultMaxListeners : Float; }; @:optional
	...
	@:overload(function(streams:std.Array<haxe.extern.EitherType<global.nodejs.WritableStream, haxe.extern.EitherType<global.nodejs.ReadableStream, global.nodejs.ReadWriteStream>>>, ?callback:(err:global.nodejs.ErrnoException) -> Void):global.nodejs.WritableStream { })
	@:overload(function(stream1:global.nodejs.ReadableStream, stream2:haxe.extern.EitherType<global.nodejs.WritableStream, global.nodejs.ReadWriteStream>, streams:std.Array<haxe.extern.EitherType<global.nodejs.WritableStream, haxe.extern.EitherType<global.nodejs.ReadWriteStream, (err:global.nodejs.ErrnoException) -> Void>>>):global.nodejs.WritableStream { })
	function pipeline<T:(global.nodejs.WritableStream)>(stream1:global.nodejs.ReadableStream, stream2:T, ?callback:(err:global.nodejs.ErrnoException) -> Void):T; function listenerCount(emitter:node.events.EventEmitter, event:haxe.extern.EitherType<String, js.lib.Symbol>):Float; var defaultMaxListeners : Float; }; }, ?requestListener:(req:node.http.IncomingMessage, res:node.http.ServerResponse) -> Void):node.https.Server;
	@:overload(function(url:haxe.extern.EitherType<String, node.url.URL>, options:node.http.RequestOptions & node.tls.SecureContextOptions & { @:optional
	var rejectUnauthorized : Bool; @:optional
	var servername : String; }, ?callback:(res:node.http.IncomingMessage) -> Void):node.http.ClientRequest { })
	static function request(options:haxe.extern.EitherType<String, haxe.extern.EitherType<node.url.URL, node.http.RequestOptions & node.tls.SecureContextOptions & { @:optional
	var rejectUnauthorized : Bool; @:optional
	var servername : String; }>>, ?callback:(res:node.http.IncomingMessage) -> Void):node.http.ClientRequest;
	@:overload(function(url:haxe.extern.EitherType<String, node.url.URL>, options:node.http.RequestOptions & node.tls.SecureContextOptions & { @:optional
	var rejectUnauthorized : Bool; @:optional
	var servername : String; }, ?callback:(res:node.http.IncomingMessage) -> Void):node.http.ClientRequest { })
	static function get(options:haxe.extern.EitherType<String, haxe.extern.EitherType<node.url.URL, node.http.RequestOptions & node.tls.SecureContextOptions & { @:optional
	var rejectUnauthorized : Bool; @:optional
	var servername : String; }>>, ?callback:(res:node.http.IncomingMessage) -> Void):node.http.ClientRequest;
