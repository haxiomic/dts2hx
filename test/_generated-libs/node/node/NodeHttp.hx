	...
	@:overload(function<Request:({
		...
		**/
		...
		/**
			...
			```
		**/
		@:overload(function(emitter:js.html.EventTarget, eventName:String, ?options:NodeHttp):js.lib.Promise<Array<Dynamic>> { })
		function once(emitter:global.nodejs.EventEmitter<NodeHttp>, eventName:ts.AnyOf2<String, js.lib.Symbol>, ?options:NodeHttp):js.lib.Promise<Array<Dynamic>>;
		/**
			```js
			...
			```
		**/
		@:overload(function(emitter:js.html.EventTarget, eventName:String, ?options:NodeHttp):global.nodejs.AsyncIterator<Array<Dynamic>, Dynamic, Dynamic> { })
		function on(emitter:global.nodejs.EventEmitter<NodeHttp>, eventName:ts.AnyOf2<String, js.lib.Symbol>, ?options:NodeHttp):global.nodejs.AsyncIterator<Array<Dynamic>, Dynamic, Dynamic>;
		/**
			...
			```
		**/
		function listenerCount(emitter:global.nodejs.EventEmitter<NodeHttp>, eventName:ts.AnyOf2<String, js.lib.Symbol>):Float;
		/**
			...
			```
		**/
		function getEventListeners(emitter:ts.AnyOf2<js.html.EventTarget, global.nodejs.EventEmitter<NodeHttp>>, name:ts.AnyOf2<String, js.lib.Symbol>):Array<haxe.Constraints.Function>;
		/**
			...
			```
		**/
		function getMaxListeners(emitter:ts.AnyOf2<js.html.EventTarget, global.nodejs.EventEmitter<NodeHttp>>):Float;
		/**
			```js
			...
			```
		**/
		function setMaxListeners(?n:Float, eventTargets:haxe.extern.Rest<ts.AnyOf2<js.html.EventTarget, global.nodejs.EventEmitter<NodeHttp>>>):Void;
		/**
