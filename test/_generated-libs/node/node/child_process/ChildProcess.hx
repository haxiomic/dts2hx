...
**/
@:jsRequire("child_process", "ChildProcess") extern class ChildProcess extends node.Events<ChildProcess> {
	/**
	...
	**/
	var stdin : Null<node.stream.stream.Writable>;
	/**
	...
	**/
	var stdout : Null<node.stream.stream.Readable>;
	/**
	...
	**/
	var stderr : Null<node.stream.stream.Readable>;
	/**
	...
	**/
	final stdio : ts.Tuple5<Null<node.stream.stream.Writable>, Null<node.stream.stream.Readable>, Null<node.stream.stream.Readable>, Null<ts.AnyOf2<node.stream.stream.Readable, node.stream.stream.Writable>>, Null<ts.AnyOf2<node.stream.stream.Readable, node.stream.stream.Writable>>>;
	/**
	...
	**/
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeListener<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):ChildProcess;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):ChildProcess;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):ChildProcess;
	/**
