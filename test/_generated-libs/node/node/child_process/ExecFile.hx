...
@:jsRequire("child_process", "execFile") @valueModuleOnly extern class ExecFile {
	...
	var encoding : String; } & ExecFileOptions>):js.lib.Promise<{ var stdout : haxe.extern.EitherType<String, global.Buffer>; var stderr : haxe.extern.EitherType<String, global.Buffer>; }> { })
	@:overload(function(file:String, args:Null<std.Array<String>>, options:Null<{ @:optional
	var encoding : String; } & ExecFileOptions>):js.lib.Promise<{ var stdout : haxe.extern.EitherType<String, global.Buffer>; var stderr : haxe.extern.EitherType<String, global.Buffer>; }> { })
