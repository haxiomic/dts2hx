...
typedef ChildProcessWithoutNullStreams = {
	...
	**/
	var stdin : node.stream.stream.Writable;
	/**
	...
	**/
	var stdout : node.stream.stream.Readable;
	/**
	...
	**/
	var stderr : node.stream.stream.Readable;
	/**
	...
	**/
	final stdio : ts.Tuple5<node.stream.stream.Writable, node.stream.stream.Readable, node.stream.stream.Readable, Null<ts.AnyOf2<node.stream.stream.Readable, node.stream.stream.Writable>>, Null<ts.AnyOf2<node.stream.stream.Readable, node.stream.stream.Writable>>>;
	/**
	...
	**/
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeListener<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):ChildProcessWithoutNullStreams;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):ChildProcessWithoutNullStreams;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):ChildProcessWithoutNullStreams;
	/**
