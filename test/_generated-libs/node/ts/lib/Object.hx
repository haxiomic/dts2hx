...
@:native("Object") extern class Object {
	...
	**/
	...
	static function values<T>(o:haxe.extern.EitherType<{ }, ArrayLike<T>>):std.Array<T>;
	/**
		Returns an array of key/values of the enumerable properties of an object
		
		Returns an array of key/values of the enumerable properties of an object
	**/
	@:overload(function(o:{ }):std.Array<ts.lib.Tuple2<String, Any>> { })
	static function entries<T>(o:haxe.extern.EitherType<{ }, ArrayLike<T>>):std.Array<ts.lib.Tuple2<String, T>>;
	/**
