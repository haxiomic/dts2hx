...
@:native("Uint16Array") extern class Uint16Array {
	@:overload(function(arrayOrArrayBuffer:haxe.extern.EitherType<IArrayBuffer, haxe.extern.EitherType<ISharedArrayBuffer, ArrayLike<Float>>>):IUint16Array { })
	@:overload(function(buffer:haxe.extern.EitherType<IArrayBuffer, ISharedArrayBuffer>, byteOffset:Float, ?length:Float):IUint16Array { })
	@:overload(function(elements:Iterable<Float>):IUint16Array { })
	@:overload(function():IUint16Array { })
