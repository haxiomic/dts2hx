...
@:native("DataView") extern class DataView {
	function new(buffer:haxe.extern.EitherType<IArrayBuffer, ISharedArrayBuffer>, ?byteOffset:Float, ?byteLength:Float);
	...
	**/
	...
	/**
		...
		no alignment constraint; multi-byte values may be fetched from any offset.
	**/
	function getBigInt64(byteOffset:Float, ?littleEndian:Bool):Any;
	/**
		Gets the BigUint64 value at the specified byte offset from the start of the view. There is
		no alignment constraint; multi-byte values may be fetched from any offset.
	**/
	function getBigUint64(byteOffset:Float, ?littleEndian:Bool):Any;
	/**
		Stores a BigInt64 value at the specified byte offset from the start of the view.
	**/
	function setBigInt64(byteOffset:Float, value:Any, ?littleEndian:Bool):Void;
	/**
		Stores a BigUint64 value at the specified byte offset from the start of the view.
	**/
	function setBigUint64(byteOffset:Float, value:Any, ?littleEndian:Bool):Void;
}