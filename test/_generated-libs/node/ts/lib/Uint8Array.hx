...
@:native("Uint8Array") extern class Uint8Array {
	@:overload(function(arrayOrArrayBuffer:haxe.extern.EitherType<IArrayBuffer, haxe.extern.EitherType<ISharedArrayBuffer, ArrayLike<Float>>>):IUint8Array { })
	@:overload(function(buffer:haxe.extern.EitherType<IArrayBuffer, ISharedArrayBuffer>, byteOffset:Float, ?length:Float):IUint8Array { })
	@:overload(function(elements:Iterable<Float>):IUint8Array { })
	@:overload(function():IUint8Array { })
	...
	**/
	static function of(items:std.Array<Float>):IUint8Array;
	/**
