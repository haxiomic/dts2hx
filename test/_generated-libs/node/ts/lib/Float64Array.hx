...
@:native("Float64Array") extern class Float64Array {
	@:overload(function(arrayOrArrayBuffer:haxe.extern.EitherType<IArrayBuffer, haxe.extern.EitherType<ISharedArrayBuffer, ArrayLike<Float>>>):IFloat64Array { })
	@:overload(function(buffer:haxe.extern.EitherType<IArrayBuffer, ISharedArrayBuffer>, byteOffset:Float, ?length:Float):IFloat64Array { })
	@:overload(function(elements:Iterable<Float>):IFloat64Array { })
	@:overload(function():IFloat64Array { })
