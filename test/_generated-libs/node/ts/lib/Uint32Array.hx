...
@:native("Uint32Array") extern class Uint32Array {
	@:overload(function(arrayOrArrayBuffer:haxe.extern.EitherType<IArrayBuffer, haxe.extern.EitherType<ISharedArrayBuffer, ArrayLike<Float>>>):IUint32Array { })
	@:overload(function(buffer:haxe.extern.EitherType<IArrayBuffer, ISharedArrayBuffer>, byteOffset:Float, ?length:Float):IUint32Array { })
	@:overload(function(elements:Iterable<Float>):IUint32Array { })
	@:overload(function():IUint32Array { })
	...
	**/
	static function of(items:std.Array<Float>):IUint32Array;
	/**
