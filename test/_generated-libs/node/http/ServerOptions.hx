...
extern typedef ServerOptions = {
	...
	var IncomingMessage : {
		...
		@:overload(function(streams:std.Array<ts.AnyOf3<global.nodejs.WritableStream, global.nodejs.ReadableStream, global.nodejs.ReadWriteStream>>, ?callback:(err:global.nodejs.ErrnoException) -> Void):global.nodejs.WritableStream { })
