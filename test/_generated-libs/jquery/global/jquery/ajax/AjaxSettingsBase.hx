...
typedef AjaxSettingsBase<TContext> = {
	...
	**/
	@:optional
	var complete : ts.AnyOf2<CompleteCallback<TContext>, Array<CompleteCallback<TContext>>>;
	/**
	...
	**/
	@:optional
	var error : ts.AnyOf2<ErrorCallback<TContext>, Array<ErrorCallback<TContext>>>;
	/**
	...
	**/
	@:optional
	var success : ts.AnyOf2<SuccessCallback<TContext>, Array<SuccessCallback<TContext>>>;
	/**
