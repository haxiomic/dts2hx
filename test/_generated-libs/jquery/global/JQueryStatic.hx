...
typedef JQueryStatic = {
	...
	dynamic function Callbacks<T:(haxe.Constraints.Function)>(?flags:String):global.jquery.Callbacks<T>;
	/**
	...
	**/
	@:overload(function<T, K:(Dynamic)>(obj:T, callback:(propertyName:K, valueOfProperty:Dynamic) -> Dynamic):T { })
	...
	**/
	@:overload(function<T, K:(Dynamic), TReturn>(obj:T, callback:(propertyOfObject:Dynamic, key:K) -> Null<ts.AnyOf2<Array<TReturn>, TReturn>>):Array<TReturn> { })
	...
	**/
	@:overload(function<TReturn, A, B, C, D, E, F>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F):() -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E>(fun_Tion:(a:A, b:B, c:C, d:D, e:E) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E):() -> TReturn { })
	@:overload(function<TReturn, A, B, C, D>(fun_Tion:(a:A, b:B, c:C, d:D) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D):() -> TReturn { })
	@:overload(function<TReturn, A, B, C>(fun_Tion:(a:A, b:B, c:C) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C):() -> TReturn { })
	@:overload(function<TReturn, A, B>(fun_Tion:(a:A, b:B) -> TReturn, context:Null<ts.Never>, a:A, b:B):() -> TReturn { })
	@:overload(function<TReturn, A>(fun_Tion:(a:A) -> TReturn, context:Null<ts.Never>, a:A):() -> TReturn { })
	@:overload(function<TReturn>(fun_Tion:() -> TReturn, context:Null<ts.Never>):() -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T>(fun_Tion:(a:A, b:B, c:C, d:D, t:T) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T>(fun_Tion:(a:A, b:B, c:C, t:T) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, B, T>(fun_Tion:(a:A, b:B, t:T) -> TReturn, context:Null<ts.Never>, a:A, b:B):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, T>(fun_Tion:(a:A, t:T) -> TReturn, context:Null<ts.Never>, a:A):(t:T) -> TReturn { })
	@:overload(function<TReturn, T>(fun_Tion:(t:T) -> TReturn, context:Null<ts.Never>):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T, U>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T, u:U) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T, U>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T, u:U) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T, U>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T, u:U) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T, U>(fun_Tion:(a:A, b:B, c:C, d:D, t:T, u:U) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T, U>(fun_Tion:(a:A, b:B, c:C, t:T, u:U) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, B, T, U>(fun_Tion:(a:A, b:B, t:T, u:U) -> TReturn, context:Null<ts.Never>, a:A, b:B):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, T, U>(fun_Tion:(a:A, t:T, u:U) -> TReturn, context:Null<ts.Never>, a:A):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, T, U>(fun_Tion:(t:T, u:U) -> TReturn, context:Null<ts.Never>):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T, U, V>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T, u:U, v:V) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T, U, V>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T, u:U, v:V) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T, U, V>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T, u:U, v:V) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T, U, V>(fun_Tion:(a:A, b:B, c:C, d:D, t:T, u:U, v:V) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T, U, V>(fun_Tion:(a:A, b:B, c:C, t:T, u:U, v:V) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, B, T, U, V>(fun_Tion:(a:A, b:B, t:T, u:U, v:V) -> TReturn, context:Null<ts.Never>, a:A, b:B):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, T, U, V>(fun_Tion:(a:A, t:T, u:U, v:V) -> TReturn, context:Null<ts.Never>, a:A):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, T, U, V>(fun_Tion:(t:T, u:U, v:V) -> TReturn, context:Null<ts.Never>):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T, U, V, W>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T, u:U, v:V, w:W) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T, U, V, W>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T, u:U, v:V, w:W) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T, U, V, W>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T, u:U, v:V, w:W) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T, U, V, W>(fun_Tion:(a:A, b:B, c:C, d:D, t:T, u:U, v:V, w:W) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T, U, V, W>(fun_Tion:(a:A, b:B, c:C, t:T, u:U, v:V, w:W) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, B, T, U, V, W>(fun_Tion:(a:A, b:B, t:T, u:U, v:V, w:W) -> TReturn, context:Null<ts.Never>, a:A, b:B):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, T, U, V, W>(fun_Tion:(a:A, t:T, u:U, v:V, w:W) -> TReturn, context:Null<ts.Never>, a:A):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, T, U, V, W>(fun_Tion:(t:T, u:U, v:V, w:W) -> TReturn, context:Null<ts.Never>):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T, U, V, W, X>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T, U, V, W, X>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T, U, V, W, X>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T, U, V, W, X>(fun_Tion:(a:A, b:B, c:C, d:D, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T, U, V, W, X>(fun_Tion:(a:A, b:B, c:C, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, B, T, U, V, W, X>(fun_Tion:(a:A, b:B, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<ts.Never>, a:A, b:B):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, T, U, V, W, X>(fun_Tion:(a:A, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<ts.Never>, a:A):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, T, U, V, W, X>(fun_Tion:(t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<ts.Never>):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T, U, V, W, X, Y>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T, U, V, W, X, Y>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T, U, V, W, X, Y>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T, U, V, W, X, Y>(fun_Tion:(a:A, b:B, c:C, d:D, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T, U, V, W, X, Y>(fun_Tion:(a:A, b:B, c:C, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, B, T, U, V, W, X, Y>(fun_Tion:(a:A, b:B, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<ts.Never>, a:A, b:B):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, T, U, V, W, X, Y>(fun_Tion:(a:A, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<ts.Never>, a:A):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, T, U, V, W, X, Y>(fun_Tion:(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<ts.Never>):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, b:B, c:C, d:D, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, b:B, c:C, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, A, B, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, b:B, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<ts.Never>, a:A, b:B):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, A, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<ts.Never>, a:A):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, T, U, V, W, X, Y, Z>(fun_Tion:(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<ts.Never>):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn>(fun_Tion:(args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<ts.Never>, additionalArguments:haxe.extern.Rest<Dynamic>):(args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	...
	function proxy<TReturn, A, B, C, D, E, F, G>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G) -> TReturn, context:Null<ts.Never>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):() -> TReturn;
	/**
		Manipulate the queue of functions to be executed on the matched element.
	**/
	function queue<T:(js.html.DOMElement)>(element:T, ?queueName:String, ?newQueue:global.jquery.TypeOrArray<global.jquery.QueueFunction<T>>):global.jquery.Queue<T>;
	/**
	...
	**/
	function unique<T:(js.html.DOMElement)>(array:Array<T>):Array<T>;
	/**
		Sorts an array of DOM elements, in place, with the duplicates removed. Note that this only works on arrays of DOM elements, not strings or numbers.
	**/
	function uniqueSort<T:(js.html.DOMElement)>(array:Array<T>):Array<T>;
	/**
		Provides a way to execute callback functions based on zero or more Thenable objects, usually Deferred objects that represent asynchronous events.
	**/
	@:overload(function<TR1, UR1, TJ1, UJ1>(deferredT:ts.AnyOf3<global.jquery.Promise<TR1, TJ1, Dynamic>, global.jquery.Thenable<TR1>, TR1>, deferredU:ts.AnyOf3<global.jquery.Promise<UR1, UJ1, Dynamic>, global.jquery.Thenable<UR1>, UR1>):global.jquery.Promise2<TR1, TJ1, ts.Never, UR1, UJ1, ts.Never> { })
	@:overload(function<TR1, TJ1, TR2, TJ2, TR3, TJ3>(deferredT:ts.AnyOf2<global.jquery.Promise3<TR1, TJ1, Dynamic, TR2, TJ2, Dynamic, TR3, TJ3, Dynamic>, global.jquery.Promise2<TR1, TJ1, Dynamic, TR2, TJ2, Dynamic>>):global.jquery.Promise3<TR1, TJ1, ts.Never, TR2, TJ2, ts.Never, TR3, TJ3, ts.Never> { })
	@:overload(function<TR1, TJ1>(deferred:ts.AnyOf3<global.jquery.Promise<TR1, TJ1, Dynamic>, global.jquery.Thenable<TR1>, TR1>):global.jquery.Promise<TR1, TJ1, ts.Never> { })
	@:overload(function<TR1, TJ1>(deferreds:haxe.extern.Rest<ts.AnyOf3<global.jquery.Promise<TR1, TJ1, Dynamic>, global.jquery.Thenable<TR1>, TR1>>):global.jquery.Promise<TR1, TJ1, ts.Never> { })
	@:overload(function(deferreds:haxe.extern.Rest<Dynamic>):global.jquery.Promise<Dynamic, Dynamic, ts.Never> { })
