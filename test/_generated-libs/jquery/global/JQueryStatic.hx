...
typedef JQueryStatic = {
	...
	**/
	@:overload(function<T, K:(ts.AnyOf3<String, Float, js.lib.Symbol>)>(obj:T, callback:(propertyName:K, valueOfProperty:Dynamic) -> Dynamic):T { })
	...
	**/
	...
	@:overload(function<T>(deep:Bool, target:T):{
		...
		**/
		@:overload(function<T, K:(ts.AnyOf3<String, Float, js.lib.Symbol>), TReturn>(obj:T, callback:(propertyOfObject:Dynamic, key:K) -> Null<ts.AnyOf2<Array<TReturn>, TReturn>>):Array<TReturn> { })
