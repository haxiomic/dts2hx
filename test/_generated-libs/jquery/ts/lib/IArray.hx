...
typedef IArray<T> = {
	...
	**/
	...
	/**
		...
		Combines two or more arrays.
	**/
	@:overload(function(items:haxe.extern.Rest<ts.AnyOf2<T, ts.lib.ConcatArray<T>>>):Array<T> { })
	function concat(items:haxe.extern.Rest<ts.lib.ConcatArray<T>>):Array<T>;
	/**
	...
	**/
	function entries():ts.lib.IterableIterator<ts.Tuple2<Float, T>>;
	/**
	...
	**/
	function values():ts.lib.IterableIterator<T>;
};