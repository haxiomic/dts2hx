...
extern typedef ITextTrackList = {
	...
	**/
	...
	function addEventListener<K>(type:K, listener:(ev:ts.html.ITrackEvent) -> Any, ?options:haxe.extern.EitherType<Bool, ts.html.AddEventListenerOptions>):Void;
	/**
	...
	**/
	...
	function removeEventListener<K>(type:K, listener:(ev:ts.html.ITrackEvent) -> Any, ?options:haxe.extern.EitherType<Bool, ts.html.EventListenerOptions>):Void;
	/**
