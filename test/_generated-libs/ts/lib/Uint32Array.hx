...
@:native("Uint32Array") extern class Uint32Array {
	...
	**/
	function every(callbackfn:(value:Float, index:Float, array:IUint32Array) -> Any, ?thisArg:Dynamic):Bool;
	/**
	...
	**/
	function filter(callbackfn:(value:Float, index:Float, array:IUint32Array) -> Dynamic, ?thisArg:Dynamic):IUint32Array;
	/**
		Returns the value of the first element in the array where predicate is true, and undefined
		otherwise.
	**/
	function find(predicate:(value:Float, index:Float, obj:IUint32Array) -> Bool, ?thisArg:Dynamic):Null<Float>;
	/**
		Returns the index of the first element in the array where predicate is true, and -1
		otherwise.
	**/
	function findIndex(predicate:(value:Float, index:Float, obj:IUint32Array) -> Bool, ?thisArg:Dynamic):Float;
	/**
		Performs the specified action for each element in an array.
	**/
	function forEach(callbackfn:(value:Float, index:Float, array:IUint32Array) -> Void, ?thisArg:Dynamic):Void;
	/**
	...
	**/
	function map(callbackfn:(value:Float, index:Float, array:IUint32Array) -> Float, ?thisArg:Dynamic):IUint32Array;
	/**
	...
	**/
	function some(callbackfn:(value:Float, index:Float, array:IUint32Array) -> Any, ?thisArg:Dynamic):Bool;
	/**
		Sorts an array.
	**/
	...
	**/
	...
	static final prototype : IUint32Array;
	/**
		The size in bytes of each element in the array.
	**/
	...
	**/
	static function of(items:haxe.extern.Rest<Float>):IUint32Array;
	/**
	...
	**/
	...
	static function from(arrayLike:ArrayLike<Float>):IUint32Array;
}