...
@:native("BaseAudioContext") extern class BaseAudioContext {
	...
	var onstatechange : Null<(ev:ts.html.IEvent) -> Any>;
	...
	**/
	...
	function addEventListener<K>(type:K, listener:(ev:ts.html.IEvent) -> Any, ?options:haxe.extern.EitherType<Bool, ts.html.AddEventListenerOptions>):Void;
	/**
	...
	**/
	...
	function removeEventListener<K>(type:K, listener:(ev:ts.html.IEvent) -> Any, ?options:haxe.extern.EitherType<Bool, ts.html.EventListenerOptions>):Void;
