...
typedef PromiseConstructor = {
	...
	**/
	...
	function all<TAll>(values:Iterable<ts.AnyOf2<TAll, PromiseLike<TAll>>>):Promise<Array<TAll>>;
	/**
	...
	**/
	...
	function race<T>(values:Iterable<ts.AnyOf2<T, PromiseLike<T>>>):Promise<T>;
	/**
		A reference to the prototype.
	**/
	final prototype : Promise<Dynamic>;
	/**
		Creates a new rejected promise for the provided reason.
	**/
	function reject<T>(?reason:Dynamic):Promise<T>;
	/**
	...
	**/
	...
	function resolve<T>(value:ts.AnyOf2<T, PromiseLike<T>>):Promise<T>;
};