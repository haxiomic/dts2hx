...
extern typedef IVideoTrackList = {
	...
	**/
	...
	function addEventListener<K>(type:K, listener:(ev:haxe.extern.EitherType<ts.html.IEvent, ts.html.ITrackEvent>) -> Any, ?options:haxe.extern.EitherType<Bool, ts.html.AddEventListenerOptions>):Void;
	/**
	...
	**/
	...
	function removeEventListener<K>(type:K, listener:(ev:haxe.extern.EitherType<ts.html.IEvent, ts.html.ITrackEvent>) -> Any, ?options:haxe.extern.EitherType<Bool, ts.html.EventListenerOptions>):Void;
	/**
