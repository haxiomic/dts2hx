...
@:native("Int16Array") extern class Int16Array {
	@:overload(function(arrayOrArrayBuffer:ts.AnyOf2<IArrayBuffer, ArrayLike<Float>>):IInt16Array { })
	...
	**/
	function every(callbackfn:(value:Float, index:Float, array:IInt16Array) -> Any, ?thisArg:Dynamic):Bool;
	/**
	...
	**/
	function filter(callbackfn:(value:Float, index:Float, array:IInt16Array) -> Dynamic, ?thisArg:Dynamic):IInt16Array;
	/**
		Returns the value of the first element in the array where predicate is true, and undefined
		otherwise.
	**/
	function find(predicate:(value:Float, index:Float, obj:IInt16Array) -> Bool, ?thisArg:Dynamic):Null<Float>;
	/**
		Returns the index of the first element in the array where predicate is true, and -1
		otherwise.
	**/
	function findIndex(predicate:(value:Float, index:Float, obj:IInt16Array) -> Bool, ?thisArg:Dynamic):Float;
	/**
		Performs the specified action for each element in an array.
	**/
	function forEach(callbackfn:(value:Float, index:Float, array:IInt16Array) -> Void, ?thisArg:Dynamic):Void;
	/**
	...
	**/
	function map(callbackfn:(value:Float, index:Float, array:IInt16Array) -> Float, ?thisArg:Dynamic):IInt16Array;
	/**
	...
	**/
	function some(callbackfn:(value:Float, index:Float, array:IInt16Array) -> Any, ?thisArg:Dynamic):Bool;
	/**
		Sorts an array.
	**/
	...
	**/
	static function of(items:haxe.extern.Rest<Float>):IInt16Array;
	/**
