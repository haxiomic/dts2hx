...
@:native("Uint8Array") extern class Uint8Array {
	@:overload(function(arrayOrArrayBuffer:ts.AnyOf2<IArrayBuffer, ArrayLike<Float>>):IUint8Array { })
	@:overload(function(buffer:IArrayBuffer, byteOffset:Float, ?length:Float):IUint8Array { })
	@:overload(function(elements:Iterable<Float>):IUint8Array { })
	...
	**/
	function every(callbackfn:(value:Float, index:Float, array:IUint8Array) -> Any, ?thisArg:Dynamic):Bool;
	/**
	...
	**/
	function filter(callbackfn:(value:Float, index:Float, array:IUint8Array) -> Dynamic, ?thisArg:Dynamic):IUint8Array;
	/**
		Returns the value of the first element in the array where predicate is true, and undefined
		otherwise.
	**/
	function find(predicate:(value:Float, index:Float, obj:IUint8Array) -> Bool, ?thisArg:Dynamic):Null<Float>;
	/**
		Returns the index of the first element in the array where predicate is true, and -1
		otherwise.
	**/
	function findIndex(predicate:(value:Float, index:Float, obj:IUint8Array) -> Bool, ?thisArg:Dynamic):Float;
	/**
		Performs the specified action for each element in an array.
	**/
	function forEach(callbackfn:(value:Float, index:Float, array:IUint8Array) -> Void, ?thisArg:Dynamic):Void;
	/**
	...
	**/
	function map(callbackfn:(value:Float, index:Float, array:IUint8Array) -> Float, ?thisArg:Dynamic):IUint8Array;
	/**
	...
	**/
	function some(callbackfn:(value:Float, index:Float, array:IUint8Array) -> Any, ?thisArg:Dynamic):Bool;
	/**
		Sorts an array.
	**/
	...
	**/
	...
	static final prototype : IUint8Array;
	/**
		The size in bytes of each element in the array.
	**/
	...
	**/
	static function of(items:haxe.extern.Rest<Float>):IUint8Array;
	/**
		...
		Creates an array from an array-like or iterable object.
	**/
	@:overload(function<T>(arrayLike:ArrayLike<T>, mapfn:(v:T, k:Float) -> Float, ?thisArg:Dynamic):IUint8Array { })
	@:overload(function(arrayLike:Iterable<Float>, ?mapfn:(v:Float, k:Float) -> Float, ?thisArg:Dynamic):IUint8Array { })
	static function from(arrayLike:ArrayLike<Float>):IUint8Array;
}