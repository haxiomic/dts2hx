...
@:native("OfflineAudioContext") extern class OfflineAudioContext {
	...
	**/
	...
	function addEventListener<K>(type:K, listener:(ev:haxe.extern.EitherType<IEvent, IOfflineAudioCompletionEvent>) -> Any, ?options:haxe.extern.EitherType<Bool, AddEventListenerOptions>):Void;
	/**
