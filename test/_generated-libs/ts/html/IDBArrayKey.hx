...
typedef IDBArrayKey = {
	...
	**/
	function pop():Null<ts.AnyOf6<String, Float, ts.lib.ArrayBuffer, ts.lib.Date_, ts.lib.ArrayBufferView, IDBArrayKey>>;
	/**
	...
	**/
	...
	/**
		...
		Combines two or more arrays.
	**/
	@:overload(function(items:haxe.extern.Rest<ts.AnyOf7<String, Float, ts.lib.ArrayBuffer, ts.lib.Date_, ts.lib.ArrayBufferView, IDBArrayKey, ts.lib.ConcatArray<IDBValidKey>>>):Array<IDBValidKey> { })
	...
	**/
	function shift():Null<ts.AnyOf6<String, Float, ts.lib.ArrayBuffer, ts.lib.Date_, ts.lib.ArrayBufferView, IDBArrayKey>>;
	/**
	...
	**/
	...
	/**
		...
		otherwise.
	**/
	@:overload(function(predicate:(value:IDBValidKey, index:Float, obj:Array<IDBValidKey>) -> Any, ?thisArg:Dynamic):Null<ts.AnyOf6<String, Float, ts.lib.ArrayBuffer, ts.lib.Date_, ts.lib.ArrayBufferView, IDBArrayKey>> { })
