...
@:native("DynamicsCompressorNode") extern class DynamicsCompressorNode {
	function new(context:BaseAudioContext, ?options:DynamicsCompressorOptions);
	final attack : AudioParam;
	final knee : AudioParam;
	final ratio : AudioParam;
	final reduction : Float;
	final release : AudioParam;
	final threshold : AudioParam;
