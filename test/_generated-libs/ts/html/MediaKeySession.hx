...
**/
@:native("MediaKeySession") extern class MediaKeySession {
	function new();
	...
	function generateRequest(initDataType:String, initData:haxe.extern.EitherType<ts.lib.IArrayBuffer, ts.lib.ArrayBufferView>):ts.lib.IPromise<Void>;
	function load(sessionId:String):ts.lib.IPromise<Bool>;
	function remove():ts.lib.IPromise<Void>;
	function update(response:haxe.extern.EitherType<ts.lib.IArrayBuffer, ts.lib.ArrayBufferView>):ts.lib.IPromise<Void>;
	/**
	...
	**/
	...
	static var prototype : IMediaKeySession;
}