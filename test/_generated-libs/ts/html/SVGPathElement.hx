...
**/
@:native("SVGPathElement") extern class SVGPathElement {
	function new();
	...
	function createSVGPathSegClosePath():ISVGPathSegClosePath;
	function createSVGPathSegCurvetoCubicAbs(x:Float, y:Float, x1:Float, y1:Float, x2:Float, y2:Float):ISVGPathSegCurvetoCubicAbs;
	function createSVGPathSegCurvetoCubicRel(x:Float, y:Float, x1:Float, y1:Float, x2:Float, y2:Float):ISVGPathSegCurvetoCubicRel;
	function createSVGPathSegCurvetoCubicSmoothAbs(x:Float, y:Float, x2:Float, y2:Float):ISVGPathSegCurvetoCubicSmoothAbs;
	function createSVGPathSegCurvetoCubicSmoothRel(x:Float, y:Float, x2:Float, y2:Float):ISVGPathSegCurvetoCubicSmoothRel;
	function createSVGPathSegCurvetoQuadraticAbs(x:Float, y:Float, x1:Float, y1:Float):ISVGPathSegCurvetoQuadraticAbs;
	function createSVGPathSegCurvetoQuadraticRel(x:Float, y:Float, x1:Float, y1:Float):ISVGPathSegCurvetoQuadraticRel;
	function createSVGPathSegCurvetoQuadraticSmoothAbs(x:Float, y:Float):ISVGPathSegCurvetoQuadraticSmoothAbs;
	function createSVGPathSegCurvetoQuadraticSmoothRel(x:Float, y:Float):ISVGPathSegCurvetoQuadraticSmoothRel;
	function createSVGPathSegLinetoAbs(x:Float, y:Float):ISVGPathSegLinetoAbs;
	function createSVGPathSegLinetoHorizontalAbs(x:Float):ISVGPathSegLinetoHorizontalAbs;
	function createSVGPathSegLinetoHorizontalRel(x:Float):ISVGPathSegLinetoHorizontalRel;
	function createSVGPathSegLinetoRel(x:Float, y:Float):ISVGPathSegLinetoRel;
	function createSVGPathSegLinetoVerticalAbs(y:Float):ISVGPathSegLinetoVerticalAbs;
	function createSVGPathSegLinetoVerticalRel(y:Float):ISVGPathSegLinetoVerticalRel;
	function createSVGPathSegMovetoAbs(x:Float, y:Float):ISVGPathSegMovetoAbs;
	function createSVGPathSegMovetoRel(x:Float, y:Float):ISVGPathSegMovetoRel;
	...
	**/
	...
	static var prototype : ISVGPathElement;
}