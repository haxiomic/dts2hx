...
@:native("SpeechRecognition") extern class SpeechRecognition {
	...
	**/
	...
	function addEventListener<K>(type:K, listener:(ev:haxe.extern.EitherType<IEvent, haxe.extern.EitherType<ISpeechRecognitionError, ISpeechRecognitionEvent>>) -> Any, ?options:haxe.extern.EitherType<Bool, AddEventListenerOptions>):Void;
	/**
	...
	**/
	...
	function removeEventListener<K>(type:K, listener:(ev:haxe.extern.EitherType<IEvent, haxe.extern.EitherType<ISpeechRecognitionError, ISpeechRecognitionEvent>>) -> Any, ?options:haxe.extern.EitherType<Bool, EventListenerOptions>):Void;
