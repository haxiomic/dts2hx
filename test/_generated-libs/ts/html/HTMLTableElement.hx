...
**/
@:native("HTMLTableElement") extern class HTMLTableElement {
	function new();
	var align : String;
	var bgColor : String;
	var border : String;
	...
	**/
	var caption : Null<IHTMLTableCaptionElement>;
	...
	**/
	final rows : ts.lib.HTMLCollectionOf<IHTMLTableRowElement>;
	var rules : String;
	var summary : String;
	/**
		Retrieves a collection of all tBody objects in the table. Objects in this collection are in source order.
	**/
	final tBodies : ts.lib.HTMLCollectionOf<IHTMLTableSectionElement>;
	/**
		Retrieves the tFoot object of the table.
	**/
	var tFoot : Null<IHTMLTableSectionElement>;
	/**
		Retrieves the tHead object of the table.
	**/
	var tHead : Null<IHTMLTableSectionElement>;
	var width : String;
	/**
		Creates an empty caption element in the table.
	**/
	function createCaption():IHTMLTableCaptionElement;
	/**
		Creates an empty tBody element in the table.
	**/
	function createTBody():IHTMLTableSectionElement;
	/**
		Creates an empty tFoot element in the table.
	**/
	function createTFoot():IHTMLTableSectionElement;
	/**
		Returns the tHead element object if successful, or null otherwise.
	**/
	function createTHead():IHTMLTableSectionElement;
	/**
	...
	**/
	function deleteRow(index:Float):Void;
	/**
	...
	**/
	function insertRow(?index:Float):IHTMLTableRowElement;
	/**
	...
	**/
	...
	static var prototype : IHTMLTableElement;
}