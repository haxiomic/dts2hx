...
**/
@:native("SVGPolylineElement") extern class SVGPolylineElement {
	function new();
	/**
	...
	**/
	...
	final animatedPoints : SVGPointList;
	final points : SVGPointList;
	static var prototype : SVGPolylineElement;
}