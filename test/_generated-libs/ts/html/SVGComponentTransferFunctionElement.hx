...
@:native("SVGComponentTransferFunctionElement") extern class SVGComponentTransferFunctionElement {
	...
	final offset : ISVGAnimatedNumber;
	final slope : ISVGAnimatedNumber;
	final tableValues : ISVGAnimatedNumberList;
	...
	**/
	...
	static var prototype : ISVGComponentTransferFunctionElement;
