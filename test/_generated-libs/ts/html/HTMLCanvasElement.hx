...
@:native("HTMLCanvasElement") extern class HTMLCanvasElement {
	...
	**/
	...
	@:overload(function(contextId:String, ?options:Dynamic):Null<ts.AnyOf4<ICanvasRenderingContext2D, IImageBitmapRenderingContext, IWebGL2RenderingContext, IWebGLRenderingContext>> { })
	...
	**/
	...
	function transferControlToOffscreen():IOffscreenCanvas;
	/**
