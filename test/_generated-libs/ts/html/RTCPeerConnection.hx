...
@:native("RTCPeerConnection") extern class RTCPeerConnection {
	...
	**/
	...
	static function generateCertificate(keygenAlgorithm:AlgorithmIdentifier):ts.lib.Promise<RTCCertificate>;
	static function getDefaultIceServers():Array<RTCIceServer>;
}