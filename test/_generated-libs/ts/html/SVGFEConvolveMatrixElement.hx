...
@:native("SVGFEConvolveMatrixElement") extern class SVGFEConvolveMatrixElement {
	...
	final kernelMatrix : ISVGAnimatedNumberList;
	final kernelUnitLengthX : ISVGAnimatedNumber;
	final kernelUnitLengthY : ISVGAnimatedNumber;
	final orderX : ISVGAnimatedInteger;
	final orderY : ISVGAnimatedInteger;
	final preserveAlpha : ISVGAnimatedBoolean;
	final targetX : ISVGAnimatedInteger;
	final targetY : ISVGAnimatedInteger;
	...
	**/
	...
	static var prototype : ISVGFEConvolveMatrixElement;
