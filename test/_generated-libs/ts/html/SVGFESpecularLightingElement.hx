...
@:native("SVGFESpecularLightingElement") extern class SVGFESpecularLightingElement {
	...
	final specularConstant : ISVGAnimatedNumber;
	final specularExponent : ISVGAnimatedNumber;
	final surfaceScale : ISVGAnimatedNumber;
	/**
	...
	**/
	...
	static var prototype : ISVGFESpecularLightingElement;
}