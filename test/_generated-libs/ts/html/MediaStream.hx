...
@:native("MediaStream") extern class MediaStream {
	...
	**/
	...
	function addEventListener<K>(type:K, listener:(ev:IMediaStreamTrackEvent) -> Any, ?options:haxe.extern.EitherType<Bool, AddEventListenerOptions>):Void;
	/**
	...
	**/
	...
	function removeEventListener<K>(type:K, listener:(ev:IMediaStreamTrackEvent) -> Any, ?options:haxe.extern.EitherType<Bool, EventListenerOptions>):Void;
