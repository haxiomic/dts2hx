...
@:native("Worker") extern class Worker {
	...
	**/
	...
	function addEventListener<K>(type:K, listener:(ev:haxe.extern.EitherType<IErrorEvent, IMessageEvent>) -> Any, ?options:haxe.extern.EitherType<Bool, AddEventListenerOptions>):Void;
	/**
	...
	**/
	...
	function removeEventListener<K>(type:K, listener:(ev:haxe.extern.EitherType<IErrorEvent, IMessageEvent>) -> Any, ?options:haxe.extern.EitherType<Bool, EventListenerOptions>):Void;
