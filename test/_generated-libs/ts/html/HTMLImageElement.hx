...
**/
@:native("HTMLImageElement") extern class HTMLImageElement {
	function new();
	var align : String;
	/**
	...
	**/
	final naturalHeight : Float;
	/**
		The original width of the image resource before sizing.
	**/
	final naturalWidth : Float;
	...
	**/
	...
	final x : Float;
	final y : Float;
	function decode():ts.lib.IPromise<Void>;
	/**
	...
	**/
	...
	static var prototype : IHTMLImageElement;
}