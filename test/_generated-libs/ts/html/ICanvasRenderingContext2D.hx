...
extern typedef ICanvasRenderingContext2D = {
	...
	@:overload(function(image:haxe.extern.EitherType<IHTMLImageElement, haxe.extern.EitherType<IHTMLCanvasElement, haxe.extern.EitherType<IHTMLVideoElement, haxe.extern.EitherType<ISVGImageElement, haxe.extern.EitherType<IImageBitmap, IOffscreenCanvas>>>>>, dx:Float, dy:Float, dw:Float, dh:Float):Void { })
	@:overload(function(image:haxe.extern.EitherType<IHTMLImageElement, haxe.extern.EitherType<IHTMLCanvasElement, haxe.extern.EitherType<IHTMLVideoElement, haxe.extern.EitherType<ISVGImageElement, haxe.extern.EitherType<IImageBitmap, IOffscreenCanvas>>>>>, sx:Float, sy:Float, sw:Float, sh:Float, dx:Float, dy:Float, dw:Float, dh:Float):Void { })
	function drawImage(image:haxe.extern.EitherType<IHTMLImageElement, haxe.extern.EitherType<IHTMLCanvasElement, haxe.extern.EitherType<IHTMLVideoElement, haxe.extern.EitherType<ISVGImageElement, haxe.extern.EitherType<IImageBitmap, IOffscreenCanvas>>>>>, dx:Float, dy:Float):Void;
	...
	function createPattern(image:haxe.extern.EitherType<IHTMLImageElement, haxe.extern.EitherType<IHTMLCanvasElement, haxe.extern.EitherType<IHTMLVideoElement, haxe.extern.EitherType<ISVGImageElement, haxe.extern.EitherType<IImageBitmap, IOffscreenCanvas>>>>>, repetition:String):Null<ICanvasPattern>;
