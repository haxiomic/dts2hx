...
@:native("ApplicationCache") extern class ApplicationCache {
	...
	**/
	...
	function addEventListener<K>(type:K, listener:(ev:haxe.extern.EitherType<IEvent, IProgressEvent<IApplicationCache>>) -> Any, ?options:haxe.extern.EitherType<Bool, AddEventListenerOptions>):Void;
	/**
	...
	**/
	...
	function removeEventListener<K>(type:K, listener:(ev:haxe.extern.EitherType<IEvent, IProgressEvent<IApplicationCache>>) -> Any, ?options:haxe.extern.EitherType<Bool, EventListenerOptions>):Void;
	/**
