...
@:native("Animation") extern class Animation {
	...
	**/
	...
	function addEventListener<K>(type:K, listener:(ev:IAnimationPlaybackEvent) -> Any, ?options:haxe.extern.EitherType<Bool, AddEventListenerOptions>):Void;
	/**
	...
	**/
	...
	function removeEventListener<K>(type:K, listener:(ev:IAnimationPlaybackEvent) -> Any, ?options:haxe.extern.EitherType<Bool, EventListenerOptions>):Void;
