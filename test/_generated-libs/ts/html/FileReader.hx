...
@:native("FileReader") extern class FileReader {
	...
	final result : Null<haxe.extern.EitherType<String, ts.lib.IArrayBuffer>>;
	function abort():Void;
	...
	**/
	...
	function addEventListener<K>(type:K, listener:(ev:IProgressEvent<IFileReader, Any>) -> Any, ?options:haxe.extern.EitherType<Bool, AddEventListenerOptions>):Void;
	/**
	...
	**/
	...
	function removeEventListener<K>(type:K, listener:(ev:IProgressEvent<IFileReader, Any>) -> Any, ?options:haxe.extern.EitherType<Bool, EventListenerOptions>):Void;
	/**
