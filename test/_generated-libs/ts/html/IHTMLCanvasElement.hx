...
typedef IHTMLCanvasElement = {
	...
	**/
	...
	@:overload(function(contextId:String, ?options:Dynamic):Null<ts.AnyOf4<CanvasRenderingContext2D, ImageBitmapRenderingContext, WebGL2RenderingContext, WebGLRenderingContext>> { })
