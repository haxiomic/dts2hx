...
**/
@:native("AudioBufferSourceNode") extern class AudioBufferSourceNode {
	function new(context:ts.lib.IBaseAudioContext, ?options:AudioBufferSourceOptions);
	var buffer : Null<IAudioBuffer>;
	final detune : ts.lib.IAudioParam;
	var loop : Bool;
	var loopEnd : Float;
	var loopStart : Float;
	final playbackRate : ts.lib.IAudioParam;
	...
	**/
	...
	static var prototype : IAudioBufferSourceNode;
}