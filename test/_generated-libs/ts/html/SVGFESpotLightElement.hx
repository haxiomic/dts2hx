...
@:native("SVGFESpotLightElement") extern class SVGFESpotLightElement {
	...
	final pointsAtZ : ISVGAnimatedNumber;
	final specularExponent : ISVGAnimatedNumber;
	final x : ISVGAnimatedNumber;
	final y : ISVGAnimatedNumber;
	final z : ISVGAnimatedNumber;
	/**
	...
	**/
	...
	static var prototype : ISVGFESpotLightElement;
}