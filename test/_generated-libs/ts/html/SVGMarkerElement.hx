...
@:native("SVGMarkerElement") extern class SVGMarkerElement {
	...
	final orientAngle : ISVGAnimatedAngle;
	final orientType : ISVGAnimatedEnumeration;
	final refX : ISVGAnimatedLength;
	final refY : ISVGAnimatedLength;
	function setOrientToAngle(angle:ISVGAngle):Void;
	...
	**/
	...
	static var prototype : ISVGMarkerElement;
