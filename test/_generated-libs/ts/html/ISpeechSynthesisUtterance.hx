...
extern typedef ISpeechSynthesisUtterance = {
	...
	**/
	...
	function addEventListener<K>(type:K, listener:(ev:haxe.extern.EitherType<ISpeechSynthesisErrorEvent, ISpeechSynthesisEvent>) -> Any, ?options:haxe.extern.EitherType<Bool, AddEventListenerOptions>):Void;
	/**
	...
	**/
	...
	function removeEventListener<K>(type:K, listener:(ev:haxe.extern.EitherType<ISpeechSynthesisErrorEvent, ISpeechSynthesisEvent>) -> Any, ?options:haxe.extern.EitherType<Bool, EventListenerOptions>):Void;
	/**
