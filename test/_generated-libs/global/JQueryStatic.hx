...
extern typedef JQueryStatic = {
	@:overload(function<TElement>(html:String, ?ownerDocument_attributes:ts.AnyOf2<ts.html.IDocument, global.jquery.PlainObject<Dynamic>>):JQuery<TElement> { })
	...
	**/
	...
	function cleanData(elems:ts.lib.ArrayLike<ts.AnyOf4<ts.html.IDocument, ts.html.IElement, ts.html.IWindow, global.jquery.PlainObject<Dynamic>>>):Void;
	/**
		Check to see if a DOM element is a descendant of another DOM element.
	**/
	function contains(container:ts.html.IElement, contained:ts.html.IElement):Bool;
	function css(elem:ts.html.IElement, name:String):Dynamic;
	/**
	...
	**/
	function hasData(element:ts.AnyOf4<ts.html.IDocument, ts.html.IElement, ts.html.IWindow, global.jquery.PlainObject<Dynamic>>):Bool;
	/**
	...
	**/
	...
	/**
		...
		Takes a function and returns a new one that will always have a particular context.
	**/
	@:overload(function<TReturn, A, B, C, D, E, F>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F):() -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E>(fun_Tion:(a:A, b:B, c:C, d:D, e:E) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E):() -> TReturn { })
	@:overload(function<TReturn, A, B, C, D>(fun_Tion:(a:A, b:B, c:C, d:D) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D):() -> TReturn { })
	@:overload(function<TReturn, A, B, C>(fun_Tion:(a:A, b:B, c:C) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C):() -> TReturn { })
	@:overload(function<TReturn, A, B>(fun_Tion:(a:A, b:B) -> TReturn, context:Null<Dynamic>, a:A, b:B):() -> TReturn { })
	@:overload(function<TReturn, A>(fun_Tion:(a:A) -> TReturn, context:Null<Dynamic>, a:A):() -> TReturn { })
	@:overload(function<TReturn>(fun_Tion:() -> TReturn, context:Null<Dynamic>):() -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T>(fun_Tion:(a:A, b:B, c:C, d:D, t:T) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T>(fun_Tion:(a:A, b:B, c:C, t:T) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, B, T>(fun_Tion:(a:A, b:B, t:T) -> TReturn, context:Null<Dynamic>, a:A, b:B):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, T>(fun_Tion:(a:A, t:T) -> TReturn, context:Null<Dynamic>, a:A):(t:T) -> TReturn { })
	@:overload(function<TReturn, T>(fun_Tion:(t:T) -> TReturn, context:Null<Dynamic>):(t:T) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T, U>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T, u:U) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T, U>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T, u:U) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T, U>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T, u:U) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T, U>(fun_Tion:(a:A, b:B, c:C, d:D, t:T, u:U) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T, U>(fun_Tion:(a:A, b:B, c:C, t:T, u:U) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, B, T, U>(fun_Tion:(a:A, b:B, t:T, u:U) -> TReturn, context:Null<Dynamic>, a:A, b:B):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, T, U>(fun_Tion:(a:A, t:T, u:U) -> TReturn, context:Null<Dynamic>, a:A):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, T, U>(fun_Tion:(t:T, u:U) -> TReturn, context:Null<Dynamic>):(t:T, u:U) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T, U, V>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T, u:U, v:V) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T, U, V>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T, u:U, v:V) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T, U, V>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T, u:U, v:V) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T, U, V>(fun_Tion:(a:A, b:B, c:C, d:D, t:T, u:U, v:V) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T, U, V>(fun_Tion:(a:A, b:B, c:C, t:T, u:U, v:V) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, B, T, U, V>(fun_Tion:(a:A, b:B, t:T, u:U, v:V) -> TReturn, context:Null<Dynamic>, a:A, b:B):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, T, U, V>(fun_Tion:(a:A, t:T, u:U, v:V) -> TReturn, context:Null<Dynamic>, a:A):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, T, U, V>(fun_Tion:(t:T, u:U, v:V) -> TReturn, context:Null<Dynamic>):(t:T, u:U, v:V) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T, U, V, W>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T, u:U, v:V, w:W) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T, U, V, W>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T, u:U, v:V, w:W) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T, U, V, W>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T, u:U, v:V, w:W) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T, U, V, W>(fun_Tion:(a:A, b:B, c:C, d:D, t:T, u:U, v:V, w:W) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T, U, V, W>(fun_Tion:(a:A, b:B, c:C, t:T, u:U, v:V, w:W) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, B, T, U, V, W>(fun_Tion:(a:A, b:B, t:T, u:U, v:V, w:W) -> TReturn, context:Null<Dynamic>, a:A, b:B):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, T, U, V, W>(fun_Tion:(a:A, t:T, u:U, v:V, w:W) -> TReturn, context:Null<Dynamic>, a:A):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, T, U, V, W>(fun_Tion:(t:T, u:U, v:V, w:W) -> TReturn, context:Null<Dynamic>):(t:T, u:U, v:V, w:W) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T, U, V, W, X>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T, U, V, W, X>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T, U, V, W, X>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T, U, V, W, X>(fun_Tion:(a:A, b:B, c:C, d:D, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T, U, V, W, X>(fun_Tion:(a:A, b:B, c:C, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, B, T, U, V, W, X>(fun_Tion:(a:A, b:B, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<Dynamic>, a:A, b:B):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, T, U, V, W, X>(fun_Tion:(a:A, t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<Dynamic>, a:A):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, T, U, V, W, X>(fun_Tion:(t:T, u:U, v:V, w:W, x:X) -> TReturn, context:Null<Dynamic>):(t:T, u:U, v:V, w:W, x:X) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T, U, V, W, X, Y>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T, U, V, W, X, Y>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T, U, V, W, X, Y>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T, U, V, W, X, Y>(fun_Tion:(a:A, b:B, c:C, d:D, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T, U, V, W, X, Y>(fun_Tion:(a:A, b:B, c:C, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, B, T, U, V, W, X, Y>(fun_Tion:(a:A, b:B, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<Dynamic>, a:A, b:B):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, T, U, V, W, X, Y>(fun_Tion:(a:A, t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<Dynamic>, a:A):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, T, U, V, W, X, Y>(fun_Tion:(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn, context:Null<Dynamic>):(t:T, u:U, v:V, w:W, x:X, y:Y) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, G, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, F, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, E, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, A, B, C, D, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, b:B, c:C, d:D, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, A, B, C, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, b:B, c:C, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, A, B, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, b:B, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<Dynamic>, a:A, b:B):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, A, T, U, V, W, X, Y, Z>(fun_Tion:(a:A, t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<Dynamic>, a:A):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn, T, U, V, W, X, Y, Z>(fun_Tion:(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<Dynamic>):(t:T, u:U, v:V, w:W, x:X, y:Y, z:Z, args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	@:overload(function<TReturn>(fun_Tion:(args:haxe.extern.Rest<Dynamic>) -> TReturn, context:Null<Dynamic>, additionalArguments:haxe.extern.Rest<Dynamic>):(args:haxe.extern.Rest<Dynamic>) -> TReturn { })
	...
	function proxy<TReturn, A, B, C, D, E, F, G>(fun_Tion:(a:A, b:B, c:C, d:D, e:E, f:F, g:G) -> TReturn, context:Null<Dynamic>, a:A, b:B, c:C, d:D, e:E, f:F, g:G):() -> TReturn;
	/**
	...
	**/
	function readyException(error:ts.lib.IError):Dynamic;
	/**
		Remove a previously-stored piece of data.
	**/
	function removeData(element:ts.AnyOf4<ts.html.IDocument, ts.html.IElement, ts.html.IWindow, global.jquery.PlainObject<Dynamic>>, ?name:String):Void;
	/**
	...
	**/
	...
	/**
		...
		Provides a way to execute callback functions based on zero or more Thenable objects, usually Deferred objects that represent asynchronous events.
	**/
	@:overload(function<TR1, UR1, TJ1, UJ1>(deferredT:ts.AnyOf3<TR1, global.jquery.Promise<TR1, TJ1, Dynamic>, global.jquery.Thenable<TR1>>, deferredU:ts.AnyOf3<UR1, global.jquery.Promise<UR1, UJ1, Dynamic>, global.jquery.Thenable<UR1>>):global.jquery.Promise2<TR1, TJ1, Any, UR1, UJ1, Any> { })
	...
	@:overload(function<TR1, TJ1>(deferred:ts.AnyOf3<TR1, global.jquery.Promise<TR1, TJ1, Dynamic>, global.jquery.Thenable<TR1>>):global.jquery.Promise<TR1, TJ1, Any> { })
	@:overload(function<TR1, TJ1>(deferreds:haxe.extern.Rest<ts.AnyOf3<TR1, global.jquery.Promise<TR1, TJ1, Dynamic>, global.jquery.Thenable<TR1>>>):global.jquery.Promise<TR1, TJ1, Any> { })
	@:overload(function(deferreds:haxe.extern.Rest<Dynamic>):global.jquery.Promise<Dynamic, Dynamic, Any> { })
	function when<TR1, UR1, VR1, TJ1, UJ1, VJ1>(deferredT:ts.AnyOf3<TR1, global.jquery.Promise<TR1, TJ1, Dynamic>, global.jquery.Thenable<TR1>>, deferredU:ts.AnyOf3<UR1, global.jquery.Promise<UR1, UJ1, Dynamic>, global.jquery.Thenable<UR1>>, deferredV:ts.AnyOf3<VR1, global.jquery.Promise<VR1, VJ1, Dynamic>, global.jquery.Thenable<VR1>>):global.jquery.Promise3<TR1, TJ1, Any, UR1, UJ1, Any, VR1, VJ1, Any>;
};