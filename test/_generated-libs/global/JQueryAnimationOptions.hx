...
typedef JQueryAnimationOptions = {
	...
	**/
	@:optional
	function always(animation:global.jquery.Animation<ts.html.IElement>, jumpedToEnd:Bool):Void;
	/**
	...
	**/
	@:optional
	function done(animation:global.jquery.Animation<ts.html.IElement>, jumpedToEnd:Bool):Void;
	/**
	...
	**/
	@:optional
	function fail(animation:global.jquery.Animation<ts.html.IElement>, jumpedToEnd:Bool):Void;
	/**
	...
	**/
	@:optional
	function progress(animation:global.jquery.Animation<ts.html.IElement>, progress:Float, remainingMs:Float):Void;
	/**
	...
	**/
	@:optional
	function start(animation:global.jquery.Animation<ts.html.IElement>):Void;
	/**
		A function to be called for each animated property of each animated element. This function provides an opportunity to modify the Tween object to change the value of the property before it is set.
	**/
	@:optional
	function step(now:Float, tween:global.jquery.Tween<ts.html.IElement>):Void;
};