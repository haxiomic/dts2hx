...
typedef UrlAjaxSettings<TContext> = {
	...
	**/
	@:optional
	var complete : ts.AnyOf2<global.jquery.ajax.CompleteCallback<TContext>, std.Array<global.jquery.ajax.CompleteCallback<TContext>>>;
	/**
	...
	**/
	@:optional
	var error : ts.AnyOf2<global.jquery.ajax.ErrorCallback<TContext>, std.Array<global.jquery.ajax.ErrorCallback<TContext>>>;
	/**
	...
	**/
	@:optional
	var success : ts.AnyOf2<global.jquery.ajax.SuccessCallback<TContext>, std.Array<global.jquery.ajax.SuccessCallback<TContext>>>;
	/**
