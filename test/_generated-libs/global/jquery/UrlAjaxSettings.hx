...
typedef UrlAjaxSettings<TContext> = {
	...
	**/
	@:optional
	function beforeSend(jqXHR:JqXHR<Dynamic>, settings:UrlAjaxSettings<TContext>):ts.AnyOf2<Bool, Void>;
	/**
	...
	**/
	@:optional
	var complete : ts.AnyOf2<global.jquery.ajax.CompleteCallback<TContext>, Array<global.jquery.ajax.CompleteCallback<TContext>>>;
	/**
		An object of string/regular-expression pairs that determine how jQuery will parse the response, given its content type.
	**/
	@:optional
	var contents : PlainObject<ts.lib.RegExp>;
	/**
	...
	**/
	@:optional
	var error : ts.AnyOf2<global.jquery.ajax.ErrorCallback<TContext>, Array<global.jquery.ajax.ErrorCallback<TContext>>>;
	/**
	...
	**/
	@:optional
	var success : ts.AnyOf2<global.jquery.ajax.SuccessCallback<TContext>, Array<global.jquery.ajax.SuccessCallback<TContext>>>;
	/**
