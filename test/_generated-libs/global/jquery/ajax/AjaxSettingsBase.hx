...
typedef AjaxSettingsBase<TContext> = {
	...
	**/
	@:optional
	var complete : ts.AnyOf2<CompleteCallback<TContext>, std.Array<CompleteCallback<TContext>>>;
	/**
	...
	**/
	@:optional
	var error : ts.AnyOf2<ErrorCallback<TContext>, std.Array<ErrorCallback<TContext>>>;
	/**
	...
	**/
	@:optional
	var success : ts.AnyOf2<SuccessCallback<TContext>, std.Array<SuccessCallback<TContext>>>;
	/**
