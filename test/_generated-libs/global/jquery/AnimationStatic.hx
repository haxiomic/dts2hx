...
typedef AnimationStatic = {
	...
	**/
	function prefilter<TElement>(callback:(element:TElement, props:PlainObject<Dynamic>, opts:EffectsOptions<TElement>) -> Null<ts.AnyOf6<Bool, Void, String, Int, Animation<TElement>, ts.html.HTMLAllCollection>>, ?prepend:Bool):Void;
	/**
