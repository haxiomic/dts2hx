...
extern typedef JQuery<TElement> = {
	...
	**/
	...
	/**
		...
		Attach a handler to an event for the elements.
	**/
	@:overload(function<TType>(eventType:TType, handler_preventBubble:Null<haxe.extern.EitherType<Bool, (t:Any, args:haxe.extern.Rest<Any>) -> Any>>):JQuery<TElement> { })
	...
	**/
	...
	/**
		...
		Attach a handler to one or more events for all elements that match the selector, now or in the future, based on a specific set of root elements.
	**/
	@:overload(function<TType>(selector:String, eventType:TType, handler:haxe.extern.EitherType<Bool, (t:Any, args:haxe.extern.Rest<Any>) -> Any>):JQuery<TElement> { })
	...
	**/
	...
	/**
		...
		Remove an event handler.
	**/
	@:overload(function<TType>(events:TType, ?selector_handler:haxe.extern.EitherType<String, haxe.extern.EitherType<Bool, (t:Any, args:haxe.extern.Rest<Any>) -> Any>>):JQuery<TElement> { })
	...
	function off<TType>(events:TType, selector:String, handler:haxe.extern.EitherType<Bool, (t:Any, args:haxe.extern.Rest<Any>) -> Any>):JQuery<TElement>;
	/**
	...
	**/
	...
	@:overload(function<TType>(events:TType, selector:String, handler:haxe.extern.EitherType<Bool, (t:Any, args:haxe.extern.Rest<Any>) -> Any>):JQuery<TElement> { })
	...
	@:overload(function<TType>(events:TType, handler:haxe.extern.EitherType<Bool, (t:Any, args:haxe.extern.Rest<Any>) -> Any>):JQuery<TElement> { })
	...
	**/
	...
	function unbind<TType>(event:TType, handler:haxe.extern.EitherType<Bool, (t:Any, args:haxe.extern.Rest<Any>) -> Any>):JQuery<TElement>;
	/**
	...
	**/
	...
	function undelegate<TType>(selector:String, eventType:TType, handler:haxe.extern.EitherType<Bool, (t:Any, args:haxe.extern.Rest<Any>) -> Any>):JQuery<TElement>;
	/**
