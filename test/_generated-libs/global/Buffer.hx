...
@:native("Buffer") extern class Buffer {
	...
	**/
	...
	@:overload(function(array:Array<Dynamic>):IBuffer { })
	...
	**/
	@:native("byteLength")
	static function byteLength_(string:ts.AnyOf13<String, ts.lib.IUint8Array, ts.lib.IArrayBuffer, ts.lib.ISharedArrayBuffer, ts.lib.IUint8ClampedArray, ts.lib.IUint16Array, ts.lib.IUint32Array, ts.lib.IInt8Array, ts.lib.IInt16Array, ts.lib.IInt32Array, ts.lib.IFloat32Array, ts.lib.IFloat64Array, ts.lib.IDataView>, ?encoding:String):Float;
	/**
		Returns a buffer which is the result of concatenating all the buffers in the list together.
		...
		If the list has more than one item, then a new Buffer is created.
	**/
	static function concat(list:Array<ts.lib.IUint8Array>, ?totalLength:Float):IBuffer;
	/**
		The same as buf1.compare(buf2).
	**/
	@:native("compare")
