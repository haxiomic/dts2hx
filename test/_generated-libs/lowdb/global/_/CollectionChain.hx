...
typedef CollectionChain<T> = {
	...
	@:overload(function(values:haxe.extern.Rest<ts.AnyOf7<String, Float, js.lib.Symbol, ts.Tuple2<ts.AnyOf3<String, Float, js.lib.Symbol>, Dynamic>, List_<Any>, (value:T) -> Any, { }>>):CollectionChain<T> { })
