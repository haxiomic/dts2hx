...
typedef Partial = {
	...
	@:overload(function<TS:(Array<Dynamic>), R>(func:(ts:haxe.extern.Rest<Any>) -> R):(ts:haxe.extern.Rest<Any>) -> R { })
	@:overload(function<TS:(Array<Dynamic>), T1, R>(func:(t1:T1, ts:haxe.extern.Rest<Any>) -> R, arg1:T1):(ts:haxe.extern.Rest<Any>) -> R { })
	@:overload(function<TS:(Array<Dynamic>), T1, T2, R>(func:(t1:T1, t2:T2, ts:haxe.extern.Rest<Any>) -> R, t1:T1, t2:T2):(ts:haxe.extern.Rest<Any>) -> R { })
	@:overload(function<TS:(Array<Dynamic>), T1, T2, T3, R>(func:(t1:T1, t2:T2, t3:T3, ts:haxe.extern.Rest<Any>) -> R, t1:T1, t2:T2, t3:T3):(ts:haxe.extern.Rest<Any>) -> R { })
	@:overload(function<TS:(Array<Dynamic>), T1, T2, T3, T4, R>(func:(t1:T1, t2:T2, t3:T3, t4:T4, ts:haxe.extern.Rest<Any>) -> R, t1:T1, t2:T2, t3:T3, t4:T4):(ts:haxe.extern.Rest<Any>) -> R { })
	@:selfCall
