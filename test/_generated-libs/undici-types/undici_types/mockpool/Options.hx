...
typedef Options = {
	...
	**/
	var agent : undici_types.MockAgent<undici_types.mockagent.Options>;
	/**
		Default: `(origin, opts) => new Client(origin, opts)`.
	**/
	@:optional
	function factory(origin:node.url.URL, opts:Dynamic):undici_types.Dispatcher;
	/**
