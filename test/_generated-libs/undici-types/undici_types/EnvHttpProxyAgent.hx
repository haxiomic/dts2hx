...
@:jsRequire("undici-types", "EnvHttpProxyAgent") extern class EnvHttpProxyAgent extends Dispatcher {
	function new(?opts:undici_types.envhttpproxyagent.Options);
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(eventName:String, callback:(origin:node.url.URL, targets:haxe.ds.ReadOnlyArray<Dispatcher>, error:undici_types.errors.UndiciError) -> Void):EnvHttpProxyAgent { })
	@:overload(function(eventName:String, callback:(origin:node.url.URL, targets:haxe.ds.ReadOnlyArray<Dispatcher>, error:undici_types.errors.UndiciError) -> Void):EnvHttpProxyAgent { })
	...
	**/
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):EnvHttpProxyAgent;
	/**
