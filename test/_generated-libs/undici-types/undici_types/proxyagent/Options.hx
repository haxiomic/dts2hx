package undici_types.proxyagent;
...
typedef Options = {
	...
	@:optional
	var requestTls : undici_types.buildconnector.BuildOptions;
	@:optional
	var proxyTls : undici_types.buildconnector.BuildOptions;
	@:optional
	function clientFactory(origin:js.html.URL, opts:Dynamic):undici_types.Dispatcher;
	/**
