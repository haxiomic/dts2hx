...
@:jsRequire("undici-types", "MessageEvent") extern class MessageEvent<T> {
	...
	function initMessageEvent(type:String, ?bubbles:Bool, ?cancelable:Bool, ?data:Dynamic, ?origin:String, ?lastEventId:String, ?source:{ var prototype : node.worker_threads.MessagePort; }, ?ports:Array<{ var prototype : node.worker_threads.MessagePort; }>):Void;
	/**
