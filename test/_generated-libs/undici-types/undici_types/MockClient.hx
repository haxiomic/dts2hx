...
**/
@:jsRequire("undici-types", "MockClient") extern class MockClient extends Client {
	...
	**/
	function dispatch(options:undici_types.dispatcher.DispatchOptions, handlers:undici_types.dispatcher.DispatchHandlers):Bool;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(eventName:String, callback:(origin:node.url.URL, targets:haxe.ds.ReadOnlyArray<Dispatcher>, error:undici_types.errors.UndiciError) -> Void):MockClient { })
	@:overload(function(eventName:String, callback:(origin:node.url.URL, targets:haxe.ds.ReadOnlyArray<Dispatcher>, error:undici_types.errors.UndiciError) -> Void):MockClient { })
	...
	**/
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?eventName:ts.AnyOf2<String, js.lib.Symbol>):MockClient;
	/**
