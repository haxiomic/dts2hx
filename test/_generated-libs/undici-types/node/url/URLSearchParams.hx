...
@:jsRequire("url", "URLSearchParams") extern class URLSearchParams {
	function new(?init:ts.AnyOf5<String, URLSearchParams, haxe.ds.ReadOnlyArray<ts.Tuple2<String, String>>, Iterable<ts.Tuple2<String, String>>, haxe.DynamicAccess<ts.AnyOf2<String, haxe.ds.ReadOnlyArray<String>>>>);
	/**
