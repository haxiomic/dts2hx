...
typedef ConnectionOptions = {
	...
	@:optional
	var session : node.buffer.Buffer<js.lib.ArrayBufferLike>;
	@:optional
	var minDHSize : Float;
	@:optional
	...
	**/
	@:optional
	dynamic function pskCallback(hint:Null<String>):Null<PSKCallbackNegotation>;
	/**
	...
	**/
	@:optional
	var key : ts.AnyOf3<String, node.buffer.Buffer<js.lib.ArrayBufferLike>, Array<ts.AnyOf3<String, node.buffer.Buffer<js.lib.ArrayBufferLike>, KeyObject>>>;
	/**
	...
	**/
	@:optional
	var pfx : ts.AnyOf3<String, node.buffer.Buffer<js.lib.ArrayBufferLike>, Array<ts.AnyOf3<String, node.buffer.Buffer<js.lib.ArrayBufferLike>, PxfObject>>>;
	/**
