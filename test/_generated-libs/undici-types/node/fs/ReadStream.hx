...
/**
	...
	function.
**/
@:jsRequire("fs", "ReadStream") extern class ReadStream extends node.stream.stream.Readable {
	...
	**/
	...
	/**
		events.EventEmitter
		  ...
		  3. ready
	**/
	function addListener<K:(ts.AnyOf3<js.lib.Symbol, String, String & { }>)>(event:K, listener:Dynamic):ReadStream;
	/**
		...
		```
	**/
	function on<K:(ts.AnyOf3<js.lib.Symbol, String, String & { }>)>(event:K, listener:Dynamic):ReadStream;
	/**
		...
		```
	**/
	function once<K:(ts.AnyOf3<js.lib.Symbol, String, String & { }>)>(event:K, listener:Dynamic):ReadStream;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function prependListener<K:(ts.AnyOf3<js.lib.Symbol, String, String & { }>)>(event:K, listener:Dynamic):ReadStream;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function prependOnceListener<K:(ts.AnyOf3<js.lib.Symbol, String, String & { }>)>(event:K, listener:Dynamic):ReadStream;
	/**
