	...
	**/
	...
	/**
		events.EventEmitter
		  ...
		  3. ready
	**/
	function addListener<K:(ts.AnyOf3<js.lib.Symbol, String, Dynamic>)>(event:K, listener:Dynamic):WriteStream;
	/**
		...
		```
	**/
	function on<K:(ts.AnyOf3<js.lib.Symbol, String, Dynamic>)>(event:K, listener:Dynamic):WriteStream;
	/**
		...
		```
	**/
	function once<K:(ts.AnyOf3<js.lib.Symbol, String, Dynamic>)>(event:K, listener:Dynamic):WriteStream;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function prependListener<K:(ts.AnyOf3<js.lib.Symbol, String, Dynamic>)>(event:K, listener:Dynamic):WriteStream;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function prependOnceListener<K:(ts.AnyOf3<js.lib.Symbol, String, Dynamic>)>(event:K, listener:Dynamic):WriteStream;
	/**
