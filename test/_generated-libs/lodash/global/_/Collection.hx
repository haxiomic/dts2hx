...
typedef Collection<T> = {
	...
	@:overload(function(values:haxe.extern.Rest<ts.AnyOf7<String, Float, js.lib.Symbol, List_<Any>, ts.Tuple2<PropertyName, Dynamic>, (value:T) -> Any, { }>>):Collection<T> { })
	function differenceBy<T2>(values1:List_<T2>, ?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:ts.AnyOf2<T, T2>) -> Any, { }>):Collection<T>;
	...
	function dropRightWhile(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Any>, { }>):Collection<T>;
	function dropWhile(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Any>, { }>):Collection<T>;
	function fill<U>(value:U, ?start:Float, ?end:Float):Collection<ts.AnyOf2<T, U>>;
	function findIndex(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Bool>, { }>, ?fromIndex:Float):Float;
	function findLastIndex(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Bool>, { }>, ?fromIndex:Float):Float;
	...
	function pullAllBy<T2>(?values:List_<T2>, ?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:ts.AnyOf2<T, T2>) -> Any, { }>):Collection<T>;
	...
	function remove(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Any>, { }>):Collection<T>;
	function slice(?start:Float, ?end:Float):Collection<T>;
	@:overload(function(value:T):Float { })
	function sortedIndex(value:T):Float;
	function sortedIndexBy(value:T, ?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:T) -> Any, { }>):Float;
	...
	function takeRightWhile(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Any>, { }>):Collection<T>;
	function takeWhile(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Any>, { }>):Collection<T>;
	...
	function unionBy(arrays2:Null<List_<T>>, ?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:T) -> Any, { }>):Collection<T>;
	...
	@:overload(function(iteratee:haxe.extern.Rest<Null<ts.AnyOf7<String, Float, js.lib.Symbol, List_<T>, ts.Tuple2<PropertyName, Dynamic>, (value:T) -> Any, { }>>>):Collection<T> { })
	function xorBy(arrays2:Null<List_<T>>, ?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:T) -> Any, { }>):Collection<T>;
	@:overload(function(comparator:haxe.extern.Rest<Null<ts.AnyOf2<List_<T>, Comparator<T>>>>):Collection<T> { })
	...
	function countBy(?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:T) -> Any, { }>):Object<Dictionary<Float>>;
	...
	function every(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Bool>, { }>):Bool;
	@:overload(function(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Bool>, { }>):Collection<T> { })
	function filter<S:(T)>(predicate:ListIteratorTypeGuard<T, S>):Collection<S>;
	@:overload(function(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Bool>, { }>, ?fromIndex:Float):Null<T> { })
	...
	function groupBy(?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:T) -> Any, { }>):Object<Dictionary<Array<T>>>;
	function includes(target:T, ?fromIndex:Float):Bool;
	function keyBy(?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:T) -> PropertyName, { }>):Object<Dictionary<T>>;
	...
	function reject(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Bool>, { }>):Collection<T>;
	function sample():Null<T>;
	function sampleSize(?n:Float):Collection<T>;
	function shuffle():Collection<T>;
	function some(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Bool>, { }>):Bool;
	...
	function max():Null<T>;
	function maxBy(?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:T) -> Any, { }>):Null<T>;
	function meanBy(?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:T) -> Any, { }>):Float;
	function min():Null<T>;
	function minBy(?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:T) -> Any, { }>):Null<T>;
	...
	function invertBy(?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:T) -> Any, { }>):Object<Dictionary<Array<String>>>;
	function mapKeys(?iteratee:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ListIterator<T, Any>, { }>):Object<Dictionary<T>>;
	...
	function omitBy(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:T, key:String) -> Any, { }>):Object<Dictionary<T>>;
	@:overload(function(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, (value:T, key:String) -> Any, { }>):Object<Dictionary<T>> { })
	...
	function findKey(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ObjectIterator<Array<T>, Any>, { }>):Null<String>;
	function findLastKey(?predicate:ts.AnyOf6<String, Float, js.lib.Symbol, ts.Tuple2<PropertyName, Dynamic>, ObjectIterator<Array<T>, Any>, { }>):Null<String>;
