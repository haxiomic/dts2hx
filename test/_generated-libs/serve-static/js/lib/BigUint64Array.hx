...
**/
@:native("BigUint64Array") extern class BigUint64Array<TArrayBuffer:(ArrayBufferLike)> {
	@:overload(function(array:ts.AnyOf2<ArrayLike<ts.BigInt>, Iterable<ts.BigInt>>):BigUint64Array<js.lib.ArrayBuffer> { })
	@:overload(function<TArrayBuffer:(ArrayBufferLike)>(buffer:TArrayBuffer, ?byteOffset:Float, ?length:Float):BigUint64Array<TArrayBuffer> { })
	@:overload(function(buffer:js.lib.ArrayBuffer, ?byteOffset:Float, ?length:Float):BigUint64Array<js.lib.ArrayBuffer> { })
	@:overload(function(array:ts.AnyOf2<js.lib.ArrayBuffer, ArrayLike<ts.BigInt>>):BigUint64Array<js.lib.ArrayBuffer> { })
	...
	**/
	static function of(items:haxe.extern.Rest<ts.BigInt>):BigUint64Array<js.lib.ArrayBuffer>;
	/**
	...
	**/
	...
	static function from(arrayLike:ArrayLike<ts.BigInt>):BigUint64Array<js.lib.ArrayBuffer>;
}