...
typedef SizzleStatic = {
	...
	@:selfCall
	function call<TArrayLike:(js.lib.ArrayLike<js.html.DOMElement>)>(selector:String, context:ts.AnyOf3<js.html.Document, js.html.DOMElement, js.html.DocumentFragment>, results:TArrayLike):TArrayLike;
