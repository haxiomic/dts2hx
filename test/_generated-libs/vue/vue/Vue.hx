...
@:jsRequire("vue", "default") extern class Vue {
	...
	@:overload(function(?tag:ts.AnyOf7<String, VueConstructor<Vue>, FunctionalComponentOptions<Dynamic, vue.types.options.PropsDefinition<Dynamic>>, ComponentOptions<ts.Never, Dynamic, Dynamic, Dynamic, Dynamic, haxe.DynamicAccess<Dynamic>>, vue.types.options.AsyncComponentPromise<Dynamic, Dynamic, Dynamic, Dynamic>, vue.types.options.AsyncComponentFactory<Dynamic, Dynamic, Dynamic, Dynamic>, () -> Component<vue.types.options.DefaultData<ts.Never>, vue.types.options.DefaultMethods<ts.Never>, vue.types.options.DefaultComputed, haxe.DynamicAccess<Dynamic>>>, ?data:VNodeData, ?children:VNodeChildren):VNode { })
	dynamic function DollarCreateElement(?tag:ts.AnyOf7<String, VueConstructor<Vue>, FunctionalComponentOptions<Dynamic, vue.types.options.PropsDefinition<Dynamic>>, ComponentOptions<ts.Never, Dynamic, Dynamic, Dynamic, Dynamic, haxe.DynamicAccess<Dynamic>>, vue.types.options.AsyncComponentPromise<Dynamic, Dynamic, Dynamic, Dynamic>, vue.types.options.AsyncComponentFactory<Dynamic, Dynamic, Dynamic, Dynamic>, () -> Component<vue.types.options.DefaultData<ts.Never>, vue.types.options.DefaultMethods<ts.Never>, vue.types.options.DefaultComputed, haxe.DynamicAccess<Dynamic>>>, ?children:VNodeChildren):VNode;
	...
	@:overload(function<PropNames:(String)>(definition:FunctionalComponentOptions<{ }, Array<PropNames>>):vue.types.vue.ExtendedVue<Vue, { }, { }, { }, { }> { })
	...
	@:overload(function<PropNames:(String)>(id:String, definition:FunctionalComponentOptions<{ }, Array<PropNames>>):vue.types.vue.ExtendedVue<Vue, { }, { }, { }, { }> { })
