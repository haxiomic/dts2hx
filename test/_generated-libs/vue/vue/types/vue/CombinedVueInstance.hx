...
@:forward
abstract CombinedVueInstance<Instance:(Vue), Data, Methods, Computed, Props>(CombinedVueInstanceTypedef<Instance:(Vue), Data, Methods, Computed, Props>) from CombinedVueInstanceTypedef<Instance:(Vue), Data, Methods, Computed, Props> to CombinedVueInstanceTypedef<Instance:(Vue), Data, Methods, Computed, Props> {
	...
	public var DollarMount(get, set):(Null<ts.AnyOf2<String, js.html.DOMElement>>, Null<Bool>) -> Instance;
	inline function get_DollarMount():(Null<ts.AnyOf2<String, js.html.DOMElement>>, Null<Bool>) -> Instance return js.Syntax.field(cast this, '$mount');
	inline function set_DollarMount(v:(Null<ts.AnyOf2<String, js.html.DOMElement>>, Null<Bool>) -> Instance):(Null<ts.AnyOf2<String, js.html.DOMElement>>, Null<Bool>) -> Instance { js.Syntax.code("{0}[{1}] = {2}", this, '$mount', v); return v; }
	...
	**/
	...
	public var DollarOn(get, set):(ts.AnyOf2<String, Array<String>>, haxe.Constraints.Function) -> Instance;
	inline function get_DollarOn():(ts.AnyOf2<String, Array<String>>, haxe.Constraints.Function) -> Instance return js.Syntax.field(cast this, '$on');
	inline function set_DollarOn(v:(ts.AnyOf2<String, Array<String>>, haxe.Constraints.Function) -> Instance):(ts.AnyOf2<String, Array<String>>, haxe.Constraints.Function) -> Instance { js.Syntax.code("{0}[{1}] = {2}", this, '$on', v); return v; }
	public var DollarOnce(get, set):(ts.AnyOf2<String, Array<String>>, haxe.Constraints.Function) -> Instance;
	inline function get_DollarOnce():(ts.AnyOf2<String, Array<String>>, haxe.Constraints.Function) -> Instance return js.Syntax.field(cast this, '$once');
	inline function set_DollarOnce(v:(ts.AnyOf2<String, Array<String>>, haxe.Constraints.Function) -> Instance):(ts.AnyOf2<String, Array<String>>, haxe.Constraints.Function) -> Instance { js.Syntax.code("{0}[{1}] = {2}", this, '$once', v); return v; }
	public var DollarOff(get, set):(Null<ts.AnyOf2<String, Array<String>>>, Null<haxe.Constraints.Function>) -> Instance;
	inline function get_DollarOff():(Null<ts.AnyOf2<String, Array<String>>>, Null<haxe.Constraints.Function>) -> Instance return js.Syntax.field(cast this, '$off');
	inline function set_DollarOff(v:(Null<ts.AnyOf2<String, Array<String>>>, Null<haxe.Constraints.Function>) -> Instance):(Null<ts.AnyOf2<String, Array<String>>>, Null<haxe.Constraints.Function>) -> Instance { js.Syntax.code("{0}[{1}] = {2}", this, '$off', v); return v; }
	public var DollarEmit(get, set):(String, haxe.extern.Rest<Dynamic>) -> Instance;
	inline function get_DollarEmit():(String, haxe.extern.Rest<Dynamic>) -> Instance return js.Syntax.field(cast this, '$emit');
	inline function set_DollarEmit(v:(String, haxe.extern.Rest<Dynamic>) -> Instance):(String, haxe.extern.Rest<Dynamic>) -> Instance { js.Syntax.code("{0}[{1}] = {2}", this, '$emit', v); return v; }
