...
typedef ThisTypedComponentOptionsWithRecordPropsTypedef<V:(Vue), Data, Methods, Computed, Props> = {
	@:optional
	...
	var template : String;
	@:optional
	function render(createElement:vue.CreateElement, hack:vue.RenderContext<Props>):vue.VNode;
	@:optional
