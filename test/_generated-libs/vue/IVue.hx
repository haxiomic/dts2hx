...
abstract IVue(IVueTypedef) from IVueTypedef to IVueTypedef {
	...
	**/
	...
	public var DollarCreateElement(get, set):(Null<ts.AnyOf7<String, vue.VueConstructor<Vue>, vue.FunctionalComponentOptions<Dynamic, vue.types.options.PropsDefinition<Dynamic>>, vue.ComponentOptions<ts.Never, Dynamic, Dynamic, Dynamic, Dynamic, haxe.DynamicAccess<Dynamic>>, vue.types.options.AsyncComponentPromise<Dynamic, Dynamic, Dynamic, Dynamic>, vue.types.options.AsyncComponentFactory<Dynamic, Dynamic, Dynamic, Dynamic>, () -> vue.Component>>, Null<vue.VNodeChildren>) -> vue.VNode;
	inline function get_DollarCreateElement():(Null<ts.AnyOf7<String, vue.VueConstructor<Vue>, vue.FunctionalComponentOptions<Dynamic, vue.types.options.PropsDefinition<Dynamic>>, vue.ComponentOptions<ts.Never, Dynamic, Dynamic, Dynamic, Dynamic, haxe.DynamicAccess<Dynamic>>, vue.types.options.AsyncComponentPromise<Dynamic, Dynamic, Dynamic, Dynamic>, vue.types.options.AsyncComponentFactory<Dynamic, Dynamic, Dynamic, Dynamic>, () -> vue.Component>>, Null<vue.VNodeChildren>) -> vue.VNode return js.Syntax.field(cast this, '$createElement');
	inline function set_DollarCreateElement(v:(Null<ts.AnyOf7<String, vue.VueConstructor<Vue>, vue.FunctionalComponentOptions<Dynamic, vue.types.options.PropsDefinition<Dynamic>>, vue.ComponentOptions<ts.Never, Dynamic, Dynamic, Dynamic, Dynamic, haxe.DynamicAccess<Dynamic>>, vue.types.options.AsyncComponentPromise<Dynamic, Dynamic, Dynamic, Dynamic>, vue.types.options.AsyncComponentFactory<Dynamic, Dynamic, Dynamic, Dynamic>, () -> vue.Component>>, Null<vue.VNodeChildren>) -> vue.VNode):(Null<ts.AnyOf7<String, vue.VueConstructor<Vue>, vue.FunctionalComponentOptions<Dynamic, vue.types.options.PropsDefinition<Dynamic>>, vue.ComponentOptions<ts.Never, Dynamic, Dynamic, Dynamic, Dynamic, haxe.DynamicAccess<Dynamic>>, vue.types.options.AsyncComponentPromise<Dynamic, Dynamic, Dynamic, Dynamic>, vue.types.options.AsyncComponentFactory<Dynamic, Dynamic, Dynamic, Dynamic>, () -> vue.Component>>, Null<vue.VNodeChildren>) -> vue.VNode { js.Syntax.code("{0}[{1}] = {2}", this, '$createElement', v); return v; }
}
