...
typedef Response<ResBody> = {
	...
	**/
	...
	@:overload(function(path:String, filename:String, options:Dynamic, ?fn:Errback):Void { })
	...
	**/
	...
	function cookie(name:String, val:String, options:CookieOptions):Response<ResBody>;
	/**
	...
	**/
	@:optional
	var req : Request<ParamsDictionary, Dynamic, Dynamic, qs.ParsedQs>;
	var statusCode : Float;
	var statusMessage : String;
	function assignSocket(socket:express_serve_static_core.net.Socket):Void;
	function detachSocket(socket:express_serve_static_core.net.Socket):Void;
	function writeContinue(?callback:() -> Void):Void;
	@:overload(function(statusCode:Float, ?headers:express_serve_static_core.http.OutgoingHttpHeaders):Response<ResBody> { })
	function writeHead(statusCode:Float, ?reasonPhrase:String, ?headers:express_serve_static_core.http.OutgoingHttpHeaders):Response<ResBody>;
	var upgrading : Bool;
	...
	function getHeaders():express_serve_static_core.http.OutgoingHttpHeaders;
	function getHeaderNames():Array<String>;
	function hasHeader(name:String):Bool;
	function removeHeader(name:String):Void;
	function addTrailers(headers:ts.AnyOf2<express_serve_static_core.http.OutgoingHttpHeaders, Array<ts.Tuple2<String, String>>>):Void;
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):Response<ResBody> { })
	@:overload(function(event:String, listener:(src:express_serve_static_core.stream.Readable) -> Void):Response<ResBody> { })
	@:overload(function(event:String, listener:(src:express_serve_static_core.stream.Readable) -> Void):Response<ResBody> { })
	...
	@:overload(function(event:String):Bool { })
	@:overload(function(event:String, src:express_serve_static_core.stream.Readable):Bool { })
	@:overload(function(event:String, src:express_serve_static_core.stream.Readable):Bool { })
