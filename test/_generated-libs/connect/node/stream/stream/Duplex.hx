...
/**
	...
	* `crypto streams`
**/
@:jsRequire("stream", "Stream.Duplex") extern class Duplex extends node.Stream {
	function new(?opts:DuplexOptions<Duplex>);
	/**
	...
	**/
	static function from(src:ts.AnyOf9<String, Dynamic, js.lib.ArrayBuffer, js.lib.Promise<Dynamic>, js.lib.AsyncGeneratorFunction, node.Stream, node.buffer.Blob, Iterable<Dynamic>, js.lib.AsyncIterable<Dynamic, Dynamic, Dynamic>>):Duplex;
	/**
