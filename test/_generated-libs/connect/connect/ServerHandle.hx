...
typedef ServerHandle = ts.AnyOf4<SimpleHandleFunction, NextHandleFunction, ErrorHandleFunction, node.http.Server<{
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(emitter:js.html.EventTarget, eventName:String, ?options:ServerHandle):js.lib.Promise<Array<Dynamic>> { })
	function once(emitter:global.nodejs.EventEmitter<ServerHandle>, eventName:ts.AnyOf2<String, js.lib.Symbol>, ?options:ServerHandle):js.lib.Promise<Array<Dynamic>>;
	/**
		```js
		...
		```
	**/
	@:overload(function(emitter:js.html.EventTarget, eventName:String, ?options:ServerHandle):global.nodejs.AsyncIterator<Array<Dynamic>, Dynamic, Dynamic> { })
	function on(emitter:global.nodejs.EventEmitter<ServerHandle>, eventName:ts.AnyOf2<String, js.lib.Symbol>, ?options:ServerHandle):global.nodejs.AsyncIterator<Array<Dynamic>, Dynamic, Dynamic>;
	/**
		...
		```
	**/
	function listenerCount(emitter:global.nodejs.EventEmitter<ServerHandle>, eventName:ts.AnyOf2<String, js.lib.Symbol>):Float;
	/**
		...
		```
	**/
	function getEventListeners(emitter:ts.AnyOf2<js.html.EventTarget, global.nodejs.EventEmitter<ServerHandle>>, name:ts.AnyOf2<String, js.lib.Symbol>):Array<haxe.Constraints.Function>;
	/**
		...
		```
	**/
	function getMaxListeners(emitter:ts.AnyOf2<js.html.EventTarget, global.nodejs.EventEmitter<ServerHandle>>):Float;
	/**
		```js
		...
		```
	**/
	function setMaxListeners(?n:Float, eventTargets:haxe.extern.Rest<ts.AnyOf2<js.html.EventTarget, global.nodejs.EventEmitter<ServerHandle>>>):Void;
	/**
