...
typedef Server = {
	...
	@:overload(function(port:Float, ?hostname:String, ?callback:haxe.Constraints.Function):node.http.Server<{
		...
		**/
		...
		/**
			...
			```
		**/
		@:overload(function(emitter:js.html.EventTarget, eventName:String, ?options:Server):js.lib.Promise<Array<Dynamic>> { })
		function once(emitter:global.nodejs.EventEmitter<Server>, eventName:ts.AnyOf2<String, js.lib.Symbol>, ?options:Server):js.lib.Promise<Array<Dynamic>>;
		/**
			```js
			...
			```
		**/
		@:overload(function(emitter:js.html.EventTarget, eventName:String, ?options:Server):global.nodejs.AsyncIterator<Array<Dynamic>, Dynamic, Dynamic> { })
		function on(emitter:global.nodejs.EventEmitter<Server>, eventName:ts.AnyOf2<String, js.lib.Symbol>, ?options:Server):global.nodejs.AsyncIterator<Array<Dynamic>, Dynamic, Dynamic>;
		/**
			...
			```
		**/
		function listenerCount(emitter:global.nodejs.EventEmitter<Server>, eventName:ts.AnyOf2<String, js.lib.Symbol>):Float;
		/**
			...
			```
		**/
		function getEventListeners(emitter:ts.AnyOf2<js.html.EventTarget, global.nodejs.EventEmitter<Server>>, name:ts.AnyOf2<String, js.lib.Symbol>):Array<haxe.Constraints.Function>;
		/**
			...
			```
		**/
		function getMaxListeners(emitter:ts.AnyOf2<js.html.EventTarget, global.nodejs.EventEmitter<Server>>):Float;
		/**
			```js
			...
			```
		**/
		function setMaxListeners(?n:Float, eventTargets:haxe.extern.Rest<ts.AnyOf2<js.html.EventTarget, global.nodejs.EventEmitter<Server>>>):Void;
		/**
	...
	**/
	function addListener<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Server;
	/**
		...
		```
	**/
	function on<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Server;
	/**
		...
		```
	**/
	function once<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Server;
	/**
	...
	**/
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function prependListener<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Server;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function prependOnceListener<K>(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Server;
	/**
