...
typedef Request<P, ResBody, ReqBody, ReqQuery> = {
	...
	**/
	...
	var headers : express.http.IncomingHttpHeaders;
	...
	**/
	...
	@:overload(function(event:String, listener:() -> Void):Request<P, ResBody, ReqBody, ReqQuery> { })
	@:overload(function(event:String, listener:(err:ts.lib.Error) -> Void):Request<P, ResBody, ReqBody, ReqQuery> { })
