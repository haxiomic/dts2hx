...
typedef Response<ResBody> = {
	...
	**/
	var send : express_serve_static_core.Send<ResBody, Response<ResBody>>;
	/**
		Send JSON response.
	...
	**/
	var json : express_serve_static_core.Send<ResBody, Response<ResBody>>;
	/**
	...
	**/
	var jsonp : express_serve_static_core.Send<ResBody, Response<ResBody>>;
	/**
