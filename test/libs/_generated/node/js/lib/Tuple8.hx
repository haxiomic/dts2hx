...
**/
@:forward @:forwardStatics extern abstract Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>(std.Array<Any>) from std.Array<Any> to std.Array<Any> {
	...
	public inline function new(element0:T0, element1:T1, element2:T2, element3:T3, element4:T4, element5:T5, element6:T6, element7:T7) {
