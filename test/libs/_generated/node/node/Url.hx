...
@:jsRequire("url") extern class Url {
	...
	@:overload(function(urlObject:haxe.extern.EitherType<String, node.url.UrlObject>):String { })
	...
	**/
	static function fileURLToPath(url:haxe.extern.EitherType<String, node.url.URL>):String;
	/**
