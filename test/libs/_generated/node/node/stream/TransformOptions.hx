...
extern interface TransformOptions extends DuplexOptions {
	...
	@:optional
	function transform(chunk:Any, encoding:String, callback:(error:Null<js.lib.Error>, data:Any) -> Void):Void;
	@:optional
	function flush(callback:(error:Null<js.lib.Error>, data:Any) -> Void):Void;
}