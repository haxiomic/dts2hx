...
@:native("Buffer") @:interface extern class Buffer {
	...
	**/
	@:overload(function(data:std.Array<Float>):Buffer { })
	@:overload(function(data:js.lib.Uint8Array):Buffer { })
	@:overload(function(str:String, ?encoding:String):Buffer { })
	function from(arrayBuffer:haxe.extern.EitherType<js.lib.ArrayBuffer, js.lib.SharedArrayBuffer>, ?byteOffset:Float, ?length:Float):Buffer; /**
		Creates a new Buffer using the passed {data}
	**/
	function of(items:std.Array<Float>):Buffer; /**
	...
	**/
	function concat(list:std.Array<js.lib.Uint8Array>, ?totalLength:Float):Buffer; /**
		The same as buf1.compare(buf2).
	**/
	function compare(buf1:js.lib.Uint8Array, buf2:js.lib.Uint8Array):Float; /**
		Allocates a new buffer of {size} octets.
	**/
	function alloc(size:Float, ?fill:haxe.extern.EitherType<String, haxe.extern.EitherType<Float, Buffer>>, ?encoding:String):Buffer; /**
	...
	**/
	...
	function toJSON():{ var type : String; var data : std.Array<Float>; };
	...
	**/
	function fill(value:Any, ?offset:Float, ?end:Float):Buffer;
	/**
		Returns the index of the first occurrence of a value in an array.
	**/
	function indexOf(value:haxe.extern.EitherType<String, haxe.extern.EitherType<Float, js.lib.Uint8Array>>, ?byteOffset:Float, ?encoding:String):Float;
	/**
		Returns the index of the last occurrence of a value in an array.
	**/
	function lastIndexOf(value:haxe.extern.EitherType<String, haxe.extern.EitherType<Float, js.lib.Uint8Array>>, ?byteOffset:Float, ?encoding:String):Float;
	/**
	...
	**/
	function includes(value:haxe.extern.EitherType<String, haxe.extern.EitherType<Float, Buffer>>, ?byteOffset:Float, ?encoding:String):Bool;
	/**
	...
	**/
	final buffer : haxe.extern.EitherType<js.lib.ArrayBuffer, js.lib.SharedArrayBuffer>;
	/**
	...
	**/
	function every(callbackfn:(value:Float, index:Float, array:js.lib.Uint8Array) -> Any, ?thisArg:Any):Bool;
	/**
		Returns the elements of an array that meet the condition specified in a callback function.
	**/
	function filter(callbackfn:(value:Float, index:Float, array:js.lib.Uint8Array) -> Any, ?thisArg:Any):js.lib.Uint8Array;
	/**
		Returns the value of the first element in the array where predicate is true, and undefined
		otherwise.
	**/
	function find(predicate:(value:Float, index:Float, obj:js.lib.Uint8Array) -> Bool, ?thisArg:Any):Null<Float>;
	/**
		Returns the index of the first element in the array where predicate is true, and -1
		otherwise.
	**/
	function findIndex(predicate:(value:Float, index:Float, obj:js.lib.Uint8Array) -> Bool, ?thisArg:Any):Float;
	/**
		Performs the specified action for each element in an array.
	**/
	function forEach(callbackfn:(value:Float, index:Float, array:js.lib.Uint8Array) -> Void, ?thisArg:Any):Void;
	/**
	...
	**/
	function map(callbackfn:(value:Float, index:Float, array:js.lib.Uint8Array) -> Float, ?thisArg:Any):js.lib.Uint8Array;
	/**
	...
	**/
	function some(callbackfn:(value:Float, index:Float, array:js.lib.Uint8Array) -> Any, ?thisArg:Any):Bool;
	/**
		Sorts an array.
	**/
	...
	**/
	...
	@:overload(function(data:js.lib.Uint8Array):Buffer { })
	@:overload(function(str:String, ?encoding:String):Buffer { })
	static function from(arrayBuffer:haxe.extern.EitherType<js.lib.ArrayBuffer, js.lib.SharedArrayBuffer>, ?byteOffset:Float, ?length:Float):Buffer;
	/**
		Creates a new Buffer using the passed {data}
	**/
	static function of(items:std.Array<Float>):Buffer;
	/**
		Returns true if {obj} is a Buffer
	**/
	...
	**/
	...
	/**
		...
		If the list has more than one item, then a new Buffer is created.
	**/
	static function concat(list:std.Array<js.lib.Uint8Array>, ?totalLength:Float):Buffer;
	/**
		The same as buf1.compare(buf2).
	**/
	@:native("compare")
	...
	/**
		Allocates a new buffer of {size} octets.
	**/
	static function alloc(size:Float, ?fill:haxe.extern.EitherType<String, haxe.extern.EitherType<Float, Buffer>>, ?encoding:String):Buffer;
	/**
		Allocates a new buffer of {size} octets, leaving memory not initialized, so the contents
		of the newly created Buffer are unknown and may contain sensitive data.
	**/
