...
@:jsRequire("./unit/types", "Types") @valueModuleOnly extern class Types {
	...
	static var stringObject : js.lib.IString;
	static var numberObject : js.lib.INumber;
	static var booleanObject : js.lib.IBoolean;
	...
	static var typeReferenceAliasWithTypeParam : js.lib.IMap<String, Float>;
	static var object : {
		var fieldA : Float;
		var fieldB : Float;
		var fieldArrayAlias : std.Array<String>;
	...
	static var stringObj : js.lib.IString;
	static var arrayNumberStringUnion : std.Array<haxe.extern.EitherType<String, Float>>;
	static var tupleNumberString : js.lib.Tuple2<Float, String>;
	...
	static var intersectionWithSubIntersection : {
		var x : Any;
	};
	...
	static var intersectionRedefinitionDifferent : {
		var x : Any;
	};
	...
	static var intersectionWithCallSignatures : {
		@:overload(function(callParamB:Bool):std.Array<String> { })
		@:selfCall
	...
	static var intersectionBetweenClasses : {
		var fieldA : Float;
		var fieldB : Float;
	};
